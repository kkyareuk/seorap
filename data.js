...
window.SEORAP_DATA.tasks.push({"id": "dv-release407", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "407 · 장소와 생활로그 일치 / 마피아 이동·실내 행동 분리", "summary": "dev 1e37674 구현·검증 완료. 1.0.355(407) Android 서명 AAB 빌드 완료, Play 내부 업로드 중. TestFlight Mac 빌드 실행 중. 공개웹 광장 준비중 유지, 미색 안내 및 생활로그 수정 배포 중."});
