window.SEORAP_DATA={
  ...
  tasks:[
    {"id": "public421-internal422-needs-rooms", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "공개 421 · 내부 422 욕구 회복 및 방별 활동 설정", "summary": "main 5e42a32 / dev 05a2827. 직접 지시 행동의 욕구 갱신 누락 수정, 행동 중 회복과 빠른 용변 회복. 방 설정 > 세부 활동 설정 22분류, 기본 전부 허용, 메뉴·실행·자동 방 선택에 적용, 저장 후 유지. Android 내부420에 공개 채널이 들어갔던 패키징 오류 수정; 421 공개 잠금·422 내부 활성 실제 서명 AAB 확인. Chrome/WebKit 실제 명령·회복·중복 차감 없음·방 제한·새로고침, 멀티 서버 저장 스냅샷 검증. 공개 사이트 Pages 배포 성공. Android 프로덕션/내부 및 Apple 업로드 진행. Apple411 로그인4.8 심사 문제는 미해결. 신규 EN/JA100%, 전체 미측정."},
...
window.SEORAP_DATA.updates.unshift({"version": "1.0.369 / 1.0.370-dev", "code": 422, "date": "2026-09-16", "items": ["잠자기·식사·씻기 욕구가 행동 중에 차도록 수정, 용변은 빠르게 회복", "방 설정에 세부 활동 설정 추가: 기본 전부 체크, 방별로 활동 허용 선택", "공개 놀이 준비 중 유지, Android 내부 테스트의 잘못된 공개 설정 수정", "공개421·내부422 배포 진행. Apple411 로그인4.8 미해결."]});
