...
window.SEORAP_DATA.tasks.push({id:"dv-android-222-device-play",project:"서랍마을",section:"release",subsection:"testing",completed:false,title:"Android 222 찻잔·선택 요약 실기기 확인",summary:"drawer-village-v1.0.205-code222-dev-debug.apk 또는 drawer-village-v1.0.205-code222-dev-release.aab를 사용해 Galaxy에서 안테 관찰 화면의 찻잔 사진이 실제로 움직이는지, 옷 설정 등 다중 선택 메뉴를 닫자마자 ‘N개 선택됨’이 바뀌는지 확인하세요. Play 테스트 트랙에 올릴 때는 Console의 최고 versionCode가 222보다 낮은지도 먼저 확인해야 해요. 아직 Play 업로드나 실기기 확인은 하지 않았습니다."});
