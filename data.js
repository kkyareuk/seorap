...
window.SEORAP_DATA.updates.unshift({"version": "1.0.372-dev", "code": 424, "date": "2026-09-16", "items": ["423 회의 순서·근거별 제출·관전 지도·전 관전자 즉시 넘기기·아침 멈춤 수정 포함", "설정 화면: 나무바닥 위 밝은 글씨, 미색 요약 상자 안 진한 숫자", "Android424 내부 테스터 제공21:55(release315). Apple424 서명업로드 진행·수출규정 답변 대기. 멀티 서버 반영 완료. 공개 준비중 유지."]});
