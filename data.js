...
말씀해주신 현상을 확인해 원인을 수정했습니다. 수정본이 Google Play 테스트 트랙에 적용되면 최신 버전으로 업데이트한 뒤 다시 확인 부탁드립니다. 업데이트 후에도 같은 문제가 생긴다면 발생 직전 동작과 화면을 함께 보내주시면 이어서 확인하겠습니다.

불편을 드려 죄송하며, 테스트에 도움 주셔서 감사합니다.`},
  {id:"feature",emoji:"💡",title:"기능 제안 답변",content:`안녕하세요. 구체적인 사용 상황과 함께 기능을 제안해주셔서 감사합니다.

말씀해주신 흐름을 기준으로 실제 플레이에서 더 편하게 쓸 수 있는 형태를 검토하겠습니다. 반영되는 경우 업데이트 내역을 통해 안내드리겠습니다. 소중한 의견 감사합니다.`},
  {id:"scene",emoji:"🏠",title:"생활 장면 답변",content:`안녕하세요. 생활 장면의 어색한 부분을 자세히 알려주셔서 감사합니다.

캐릭터의 현재 위치·일정·관계 설정과 장면 문구가 서로 모순되지 않도록 확인하겠습니다. 수정본이 적용되면 최신 버전에서 다시 확인 부탁드립니다.`},
  {id:"relationship",emoji:"🤝",title:"관계 기능 답변",content:`안녕하세요. 캐릭터 관계 조합과 상호작용에 관한 의견 감사합니다.

특정 관계만 전제로 하지 않고 가족·친구·동료·서먹한 사이 등 다양한 관계와 성격 조합에서도 자연스럽게 이어지도록 확인하겠습니다.`},
  {id:"translation",emoji:"🌐",title:"번역 문구 답변",content:`안녕하세요. 번역이 어색하거나 빠진 문구를 알려주셔서 감사합니다.

한국어 원문의 뜻과 화면 맥락을 함께 확인해 영어·일본어 표현을 수정하겠습니다. 비슷한 화면의 남은 문구도 함께 점검하겠습니다.`},
  {id:"payment",emoji:"💳",title:"결제 답변",content:`안녕하세요. 결제 과정에서 불편을 드려 죄송합니다.

중복 결제를 피하기 위해 같은 상품을 다시 결제하지 마시고, 주문번호와 발생 시각을 보내주세요. 결제 상태와 지급 여부를 확인한 뒤 안내드리겠습니다.`},
  {id:"sync",emoji:"☁️",title:"계정·동기화 답변",content:`안녕하세요. 계정·동기화 문제를 알려주셔서 감사합니다.

추가 동기화나 불러오기를 반복하기 전에 현재 기기 데이터가 남아 있는지 먼저 확인해 주세요. 사용 버전, 로그인 계정, 마지막 정상 동기화 시각을 보내주시면 기기 원본과 클라우드 사본을 기준으로 확인하겠습니다.`},
  {id:"design",emoji:"🎨",title:"디자인·사용성 답변",content:`안녕하세요. 화면에서 불편했던 위치와 동작을 구체적으로 알려주셔서 감사합니다.

단순히 스타일을 덧씌우지 않고 화면 구조와 터치·스크롤 동작을 함께 확인해 수정하겠습니다. 반영된 버전이 준비되면 업데이트 후 다시 확인 부탁드립니다.`}
];
