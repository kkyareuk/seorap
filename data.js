...
window.SEORAP_DATA.tasks.push({id:'dv-ios30',project:'서랍마을',section:'release',subsection:'testing',completed:false,title:'iOS 1.0.269 (30) · 구매 복구·멀티 전환',summary:'dev a82e61a / iOS18b2ebc. 미처리 구매 복구 후 새 결제 시작 금지, 결제 상태 확인은 비대화형 구매 복구·진행중 중복구매 잠금 유지. 방장/관리자 우편 허용(전체공지 권한 유지), 그룹 초기 데이터 수신 전 화면 유지, 탈퇴 단일요청·완료 후 갱신 실패 분리. 회귀검사 및 휴대폰/태블릿 전환 검사 통과. Actions34346487611 진행 중·실제iPad 반복결제 재검증 필요. Android 최신 배포코드 사용자 확인 대기·EN/JA75.8%·게임main 유지.'});
window.SEORAP_DATA.updates.unshift({version:'iOS 1.0.269 (30) 준비',date:'2026-09-09',items:['미처리 구매 복구 시 추가 결제창 방지·확인 버튼에서 구매 복구','방장/관리자에게 일반 멤버 우편 발송 서버 적용','캐릭터 그룹 전환 로딩 유지·탈퇴 중복 처리 보완','TestFlight 서명 빌드 진행·Android 버전 확인 대기·실기기 검증 미완료']});
