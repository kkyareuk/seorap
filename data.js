window.SEORAP_DATA={
  ...
  tasks:[
    {"id": "internal420-exterior-icon", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "내부 420 · 집 외형 그림만 표시", "summary": "1.0.368 (420), dev 3f0209b. 대표 내부사진 위 집 외형 아이콘의 흰 배경과 이름표 제거. 그림 클릭 외형 선택 유지. 테마의 일반 버튼 배경 적용에서 제외해 수정. Chrome/WebKit 배경 투명·텍스트 없음 및 침대·재질 선택 회귀검증.419 수정 모두 포함. Android/Apple 내부 배포 중. 신규 번역 없음,419신규 EN/JA100% 유지."},
    {"id": "internal419-home-beds", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "내부 419 · 침대·집 사진·재질 선택·놀이 오류", "summary": "1.0.367 (419), dev a99643e. 놀이 모집 기록 누락 오류 수정. 침대 잠자기·쉬기 등 확대, 자기 방 침대 지정·1인 침대 실제 레이어 연결. 책장·화분20% 확대, 바닥5종·벽지7종 실물 미리보기, 대표 내부사진+작은 외형 아이콘, 사용자 광장 스프라이트. Chrome/WebKit 실제 집·침대·재질 선택, 60판 마피아 회귀·욕구검사 및 서명 AAB 내용 검증. 서버 배포 완료. Play 및 TestFlight419 배포 중. 신규 EN/JA100%, 전체 미측정."},
...
window.SEORAP_DATA.updates.unshift({"version": "1.0.368-dev", "code": 420, "date": "2026-09-16", "items": ["집 외형 아이콘 뒤 흰 네모와 이름표 제거, 집 그림을 눌러 외형 선택", "419 놀이 불러오기·침대·가구·재질 선택 개선 포함", "Chrome/WebKit 투명 배경·이름표 제거 확인. Android/Apple 내부 배포 중."]});
