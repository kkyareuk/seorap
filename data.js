...
window.SEORAP_DATA.tasks.push(
  ...
  {id:"dv-release-internal",project:"서랍마을",section:"release",subsection:"play-store",title:"Google Play 내부 테스트 v1.0.55(57) 올리기",summary:"Android 패키지의 백업 병합 모듈 누락을 고쳐 시작 화면 무한 로딩을 해소하고, 기존 사진 저장 공간 50MB 상품을 앱 상점에 복원한 AAB를 내부 테스트 트랙에 올린 뒤 출시 시작까지 확인."},
  ...
  {id:"dv-release-device",project:"서랍마을",section:"release",subsection:"testing",title:"실기기 앱 핵심 기능 점검하기",summary:"Galaxy Android 15·16에서 앱 버전 1.0.55·빌드 57이 로딩 화면을 벗어나 정상 시작하는지 확인. JSON 백업을 불러온 뒤 완전히 종료하고 다시 실행해도 캐릭터와 집이 유지되는지, 사이트·앱 상점에 사진 저장 공간 50MB 상품이 보이는지도 함께 점검."},
