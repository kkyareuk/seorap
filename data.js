window.SEORAP_DATA={
  ...
  tasks:[
    {"id": "internal418-opinions-night", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "내부 418 · 주 의견·반응과 밤 마피아", "summary": "1.0.366 (418), dev b449a54. 주 의견 대기열·복수 반응·반응 압박, 침묵 지적·입장 변경, 300초 회의와 생존 유저 전원 넘기기 2초. 새 게임 낮 2회 활동→회의/투표→밤 표적→아침 발견. 문장 증거·상황에 맞는 모순, 놀이 능력 6종 저장, 말풍선 자동 높이. 1인 침대 절반 크기·수면 위치, 행동 중 회복·용변 1분, 가구 전용 행동. 새 회의/밤/기존 각30판, Chrome/WebKit KO/EN/JA·저장/재접속 검증. Android/Apple 내부 배포 진행 중. 신규 EN/JA100%, 전체 미측정."},
...
window.SEORAP_DATA.updates.unshift({"version": "1.0.366", "code": 418, "date": "2026-09-16", "items": ["마피아 주 의견과 여러 반응·침묵 지적·입장 변경", "새 게임 낮 활동→회의·투표→밤 표적 선택→다음 날 아침 발견", "전체 회의 시간·전원 넘기기, 문장 증거와 놀이 능력 설정", "침대 크기·수면 위치, 실시간 욕구 회복·빠른 용변, 가구별 행동", "Android 및 Apple 내부 배포 중. EN/JA 신규문구100%"]});
