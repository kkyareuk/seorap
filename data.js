...
if(android225Followup){android225Followup.title="Android 230 깨우기·관계·태블릿 UI 실기기 확인";android225Followup.summary="최신 파일은 drawer-village-v1.0.213-code230-dev-debug.apk와 drawer-village-v1.0.213-code230-dev-release.aab입니다. code 224~229 대신 230을 사용하세요. Galaxy 휴대폰에서 잠든 캐릭터를 깨우고 활동을 지시한 뒤 방과 행동이 즉시 바뀌는지, 여러 번 함께 활동한 캐릭터의 관계가 자동 생성·발전하는지 확인하세요. SM-X700(Android 16)에서는 가로 전체설정의 큰 양면 책, 세로 전체설정의 큰 단면 책과 잘리지 않는 버튼, 가로 사전·공식 관계 목록의 너비, 마을 캐릭터 아이콘의 흰 네모·장식 외곽선 제거, 시스템 내비게이션 바와 UI 비겹침을 확인하세요. 229까지의 시작 동기화·첫 캐릭터 보존·백업·침대·로그·제목·찻잔·선택 수 수정도 함께 확인해야 해요. Play 테스트 트랙에 올릴 때는 Console의 최고 versionCode가 230보다 낮은지 먼저 확인하세요. 아직 Play 업로드나 Galaxy 실기기 확인은 하지 않았습니다.";}
