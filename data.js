...
window.SEORAP_DATA.updates.unshift({version:'Android303 / iOS30 이후 수정 중',date:'2026-09-09',items:['우편함 버튼 잠금 범위 및 Apple 앱 내 우편 갱신 수정','결제 지연 안내 문구 정리·진행 중 중복구매 차단 유지','서버 변경 배포 완료·새 앱 빌드 미배포','멀티 캐릭터 빈 화면 추가 확인 중·게임 main 유지']});