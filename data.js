...
if(android219Followup){android219Followup.title="Android 220 프로덕션 핫픽스 실기기·Play 업로드 확인";android219Followup.summary="최신 파일 drawer-village-v1.0.204.1-code220-hotfix-release.aab. 프로덕션 219 위 긴급 안정화로 캐릭터 전체설정 직접 진입·뒤로가기·빠른설정 폰트와 심각한 렉 원인을 수정했어요. Play 최고 코드가 220 미만인지 확인한 뒤 기존 219 앱 위에 업데이트하고 캐릭터가 많은 계정의 메뉴 전환, 전체설정 뒤로가기, 빠른설정 열기/저장, 마을 산책과 발소리를 Galaxy 실기기에서 확인한 다음 프로덕션에 배포하세요.";}
