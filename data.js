...
window.SEORAP_DATA.tasks.push({"id":"dv-ios360-slots","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"iOS360 · Android359 · 1.0.326 슬롯 반영·삭제 대기·태블릿 메뉴","summary":"앱 dev 662b8e3. 검증된 TestFlight 구매 슬롯 복원 연결, 정식 구매와 분리. 기본5+구매5 사용2 남은8·다른UID격리 테스트 통과. 캐릭터 화면 상시 슬롯표시/생성 확인팝업 제거. 태블릿 홈 일정·관계 겹침 수정. 삭제대기와 초기로딩 분리·응답기한·확인전 기기기록 보존. KO/EN/JA 신규문구100%, 전체번역률 미산정. Android359 서명빌드 중, iOS360 Actions34639607554 진행 중. 서버 구매내역조회 배포 중. 실제 기기 구매/삭제결과 미검증·공개심사/공지발송 없음."});
window.SEORAP_DATA.updates.unshift({"version":"iOS360 / Android359 · 1.0.326","code":359,"date":"2026-09-12","items":["슬롯 사용·남은 수 상시표시 및 구매내역 반영 수정","태블릿 홈 메뉴 겹침 수정","계정 삭제 응답 대기 개선","검증 후 테스트 빌드 준비 중 / 정식 출시 아님"]});
