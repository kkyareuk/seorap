...
window.SEORAP_DATA.tasks.push({"id":"dv-ios359-native-auth","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"iOS359 · Android358 · 1.0.325 앱 로그인 초기화 수정","summary":"358 실기기에서 계정 불러오기 오류 지속 제보. dev b2880c7: 앱에서 getAuth 기본 웹 팝업 초기화 대신 initializeAuth 사용, 기존 IndexedDB/localStorage 세션 검색 유지. Firebase12.2.1 실제 SDK·모바일 UA에서 로그인 보조 요청 무응답 조건 재현: 기존 초기화 pending, 수정 경로 ready/보조 요청0건. 계정격리·무응답·기록보존·오류화면 검사 통과. 오류 코드와 실패 단계를 표시. iOS359 빌드 요청, 실제 기기 진입 확인 전/공개 심사 미제출. 새 오류 코드 라벨 EN/JA100%, 전체 번역률 미산정."});
