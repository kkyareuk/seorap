...
window.SEORAP_DATA.tasks.push({id:"dv-android-223-device-play",project:"서랍마을",section:"release",subsection:"testing",completed:false,title:"Android 223 찻잔·선택 요약·첫 로그인 실기기 확인",summary:"최신 파일은 drawer-village-v1.0.206-code223-dev-debug.apk와 drawer-village-v1.0.206-code223-dev-release.aab이며 222 대신 223을 사용하세요. Galaxy에서 안테 관찰 화면의 찻잔 사진이 움직이는지, 옷 설정 등 다중 선택 메뉴를 닫자마자 ‘N개 선택됨’이 바뀌는지, 새 설치 상태에서 첫 캐릭터를 만든 뒤 Google 로그인해도 그대로 유지되는지 확인하세요. Play 테스트 트랙에 올릴 때는 Console의 최고 versionCode가 223보다 낮은지도 먼저 확인해야 해요. 아직 Play 업로드나 실기기 확인은 하지 않았습니다."});
