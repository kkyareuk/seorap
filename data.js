...
window.SEORAP_DATA.updates.unshift({"version": "1.0.374-dev", "code": 426, "date": "2026-09-16", "items": ["도구 확보·잠자리 조사·집 단속과 밤 침입 연결, 다음 날 실제 사건 흔적 조사", "정체 비공개 동맹·애도·동거인 야간 목격", "즉시 NPC 주 의견·반응5초·지목된 사람 먼저 반박·감사·투표자 내역", "지도 카메라 유지 및 투표 화면 대비 수정", "Android 내부426 제공22:57(release316), 멀티 서버 반영. Apple426 서명 업로드 진행, 설치 가능 미확인. 공개 준비중 유지."]});
