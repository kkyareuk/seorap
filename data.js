...
window.SEORAP_DATA.tasks.push({"id": "dv-ios-public391", "project": "서랍마을", "section": "release", "subsection": "production", "completed": false, "title": "iOS 1.0.339 (391) 공개 배포 준비", "summary": "사용자 요청으로 iOS 391 공개 심사 준비. 현재 공개1.0.328, 심사대기1.0.335(387) 확인. 391 저장점검 소스 bd7ca3f에서 iOS 전용 a34ff8e를 고정해 macOS 서명·업로드 실행34839278867 시작. dev392 보존. 빌드 처리 후 기존 심사대기본을391로 교체하고 승인후 자동공개 예정. 실제 공개·심사제출 완료 아님."});
