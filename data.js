...
window.SEORAP_DATA.tasks.push({id:'dv-ios29',project:'서랍마을',section:'release',subsection:'testing',completed:false,title:'iOS 1.0.269 (29) · Apple 계정 삭제·활동 메뉴',summary:'dev8de744d/iOS8a349dd. 삭제시 native signIn과 web reauthenticate가 같은 Apple 자격을 두번 소비하던 원인 수정. skipNativeAuth true·현재 웹 계정 토큰으로 Apple 코드 해제. 새 인증 1회·잘못된 계정·최종취소·연결해제실패 삭제차단 테스트 및 서버삭제 범위 검사 통과. 취미목록/자동실행·분류별 그림과 위계·선택중 배경갱신 지연 포함. iOS29 빌드 준비, 실제 계정 삭제 미검증. Android302 유지·게임main 미변경·EN/JA75.8%.'});
