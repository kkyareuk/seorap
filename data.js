...
const android216Followup=window.SEORAP_DATA.tasks.find(t=>t.id==="dv-android-214-device-play");
if(android216Followup){android216Followup.title="Android 216 실기기·Play 업로드 확인";android216Followup.summary="최신 개발 파일 drawer-village-v1.0.201-code216-dev-release.aab. 214의 태블릿/가구, 215의 수면, 216의 소지품 이름·부부 등록 상태·우편 삭제를 포함해요. Play에 code 216을 올리기 전 기존 설치 위 업데이트, 소지품 첫 표시, 편지 삭제/재생성 방지, 법적 미등록 부부 저장과 수면·태블릿·저장/성능을 확인하세요. 아직 Play 업로드나 프로덕션 심사 제출은 하지 않았어요.";}
