...
{const task=window.SEORAP_DATA.tasks.find(t=>t.id==='dv-ios-readiness-20260908');if(task){task.completed=false;task.title='iOS 출시 준비 · 빌드15 업로드, 시작 화면 재검증';task.summary='운영274 기반 iOS 전용 브랜치 990b16e/dc6ac4c/469ac98: Apple 로그인, 앱 내 계정 삭제, 서명 프로파일 갱신. 빌드15 VALID·App Store 선택 완료. Firebase Apple 제공자 활성, 계정삭제·결제 서버/규칙 배포(dev17877be). 개인정보 공개·한영 정책 URL·무료 가격·콘텐츠 권한·구매 서버 알림 등록. main1601193은 개인정보 문서만 반영, Android 운영274와 개발280 유지. iPad 캡처가 계정 로딩에 남아 네이티브 웹 리디렉션 대기 및 비로그인 구매정보 오류를 수정해 재검증 중. 심사 이미지/IAP 연결과 최종 심사 제출 아직 미완료. 실제 Apple 로그인·구매·탈퇴 실기기 미검증. EN75.6%, JA75.5%.';}}
window.SEORAP_DATA.updates.unshift({version:'iOS 1.0.215 출시 준비',code:15,date:'2026-09-08',items:['운영274 개선을 iOS 출시 후보에 반영','Apple 로그인·앱 안의 계정 삭제와 결제 검증 서버 연결','새 서명 빌드15 업로드 및 Apple 처리 완료','개인정보·콘텐츠 권한·무료 다운로드 가격 설정','iPad 시작 화면 로딩 수정 후 재검증 중, 심사 제출 및 출시 전']});
