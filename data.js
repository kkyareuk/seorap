...
window.SEORAP_DATA.tasks.push({"id": "dv-ios18", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "iOS 1.0.261 (18) · Android294 반영·TestFlight 빌드", "summary": "f8a25a0에 Android294 병합. Apple어댑터유지, 공통기능/버전/hash검증과 우편/스와이프/사교/질문/업무 브라우저QA통과. Actions34316029777 빌드진행. 실제기기영상 및 UGC신고차단 보완 미완료: 재심사제출하지않음."});
...
window.SEORAP_DATA.tasks.push({"id": "dv-release295", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "개발판295 / 1.0.262 · 신고·계정 차단", "summary": "Android8600fcc, dev4082ee5. 구성원/우편 신고, 계정UID양방향 차단·다른그룹/새캐릭터숨김·설정해제. 서버우편/제안/직접명령 검사·푸시발송차단 확인, 비공개신고접수와중복/권한검증. APK/AAB서명·266자산일치·오프라인실행/저장복원·모바일신고차단QA통과. 서버배포완료, 차단표시이름 보정 후속배포중. 운영자신고처리문서포함. EN75.8%,JA75.8%. Play사용자업로드, 운영main유지."});

window.SEORAP_DATA.tasks.push({"id": "dv-ios19", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "iOS 1.0.262 (19) · 신고·계정 차단", "summary": "78b7cee에Android295반영. 플랫폼/hash검증·동일신고차단화면QA통과. Actions34319538014 서명업로드진행. 실제기기촬영과AppReview자료확인후재심사; 아직제출안함."});
