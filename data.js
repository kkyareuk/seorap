...
window.SEORAP_DATA.tasks.unshift({"id":"internal453-title-group-sleep","project":"서랍마을","section":"release","subsection":"testing","completed":true,"title":"내부453 제공 · 새 타이틀·다인 활동·수면 시간·집/마을 확대","summary":"1.0.401/453, dev ecad177. Play release335 내부 테스터 제공9/19 18:31. 원본 타이틀 SVG·로그인/저장별 진입, 집/마을1~3배 두 손가락 확대, 최대8명 공통 활동·도착/재접속 유지, 시간표 수면·오프라인 회복·실제 침대선택, 긴 설정 스크롤. Chrome/WebKit 및 시간표2880분·8종4인활동·침대·소유권·중복선물 방지 검증. 서명AAB480자산일치, sharedTownApi 반영. iOS453 서명/업로드 진행중, 공개심사 미제출. S25FE 실행실패·실기기Apple로그인·실기기성능 원인 미확인. EN75.5%/JA75.5%, 신규3언어완료. 앱main은 별도웹 보호로 유지."});
window.SEORAP_DATA.updates.unshift({"version":"1.0.401 내부 테스트","code":453,"date":"2026-09-19","items":["새 타이틀과 로그인/저장별 시작 화면","여러 명이 같은 대화·식사·놀이 등 함께 진행","설정 수면 시간·오프라인 수면 회복·자동 취침 침대 선택","집·마을 두 손가락 확대/축소와 설정 스크롤","Play 내부453 제공·멀티서버 반영·iOS 내부 빌드 진행중"]});
