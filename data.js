...
{version:"1.0.187-dev",code:200,date:"2026-09-02",items:["2인 침대를 30% 확대하고 두 사용자의 좌우 자리·베개 위치·회전·캐릭터 크기를 침대 배율에 맞춰 조정","빈 침대·이동은 바탕·이불·발판 3장이 한 묶음이고, 위에 눕기와 이불 안에서 상태별 앞뒤 레이어 순서 유지","카페·병원·피아노 공연장·오피스·공원·빨간 지붕 집의 제공받은 투명 PNG 원본과 조명 12장을 추가 가공 없이 그대로 교체","건물 조명 코어와 번짐을 가산 발광(plus-lighter, screen fallback)으로 합성","통계 본문 안의 중복 뒤로가기 버튼을 제거하고 공통 나무 상단바를 고정해 상단바 아래 보고서만 스크롤","통계 범위 선택과 보고서 다운로드를 원본 좌·중앙·우 그림 조각으로 늘어나는 3분할 버튼으로 적용하고 그래프·카드 비율 유지","전용 검사·조명 회귀검사, 412×917 시작·스크롤 모바일 시각 검수와 Android debug APK·release AAB 빌드 완료","새 문구 없음. 기존 통계 영어·일본어 번역 유지; 정적 UI 영어 74.3%, 일본어 74.2%. 1.0.187 / 코드 200 개발판이며 운영 main·Google Play 배포 아님"]},
