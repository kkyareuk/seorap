...
window.SEORAP_DATA.tasks.push({"id": "dv-own-home-344-dev", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": false, "title": "343 이후 dev0088216 · 본인 집 편집권한·방 편집 보완", "summary": "본인 집 외형/위치/서사상 소유자 설정 서버 허용, ownerUid 변조/타인 집 수정 차단. 방 삭제·벽지/바닥·출입·주인·가구 방이동 dev연결. 서버 단위검사·재가입권한 회귀·웹빌드 통과. 서버배포 확인중; Android343유지, 새앱미전달. 신규EN100% JA100%. 멀티 완전동등/코드덮어쓰기/공용시설소유/실기기검증/피해계정복구는 미완료."});
