window.SEORAP_DATA={
  ...
  tasks:[
    {"id": "public433-internal434-audio-talk", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "공개437 심사 제출 · 내부438 제공 · 사진·카운터·자동 감정·클릭 개선", "summary": "1.0.385(437) 광장잠금, Play release30 검토 제출 완료·승인 대기. 1.0.386(438) 광장열림, release324 내부 테스터 제공9/17 16:47. 사진 URL 토큰 중복·타계정 합산·과거 누적 계산 수정,122회 반복 검증·원본 삭제 없음. 고정 양끝/가운데 확장 카운터·넓은 상판·인덕션 앞바닥 위치. 함께 있는 상대 시선에 따른 자동 칭찬/허용포옹/거리요청, 방·접촉 제한 준수. 새 캐릭터/행동 선택음·홈 책장음·음식점 주문/동행. 클릭 전체복사0회·CPU4x 합성6.9MB 중앙값124.2→2.1ms(실기기 아님). Chrome/WebKit·동기화·멀티·AAB서명/자산검증, sharedTownApi 배포 완료. iOS 준비만. 누적407→437 인게임공지 발송: notice-639d1546-4310-489f-9a84-e0173aab1643, 마피아 제외·서랍마을→서랍마을 주민·푸시/이메일 없음. 신규EN/JA100%, 전체미측정. dev e6bec28 반영, 게임main유지."},
    {"id": "internal432-material-audio", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "내부432 · 벽지/바닥 선택창·분수대·UI숨김·효과음", "summary": "1.0.380(432), dev bc3314a. Play release322 내부 테스터 제공9/17 15:34 확인. 서명 AAB444자산 일치, iOS준비/WebKit검사만. 개인/멀티 벽지·바닥 별도선택창, 원본분수아이콘, 뒤로가기 숨김과 방이름 앞레이어. 일반클릭/책페이지/책닫기/서랍열기닫기5효과음·중첩방지. Chrome/WebKit3언어·멀티재질·기존편집검증. 신규EN/JA100%,전체미측정."},
    {"id": "internal431-compact-context", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "내부 431 · 개인/멀티 작은 편집 도구·장소별 행동·모듈화", "summary": "1.0.379(431), dev3eff30c. Play release321 내부 테스터 제공9/17 14:39 확인, sharedTownApi 배포 완료. 한 줄/접기/드래그 도구, 개인/멀티 공통 가구 편집·저장 재시도. 냉장고 확대, 오디오/카페/공연장 및 동행 방문, 자기캐릭터 전체행동 제거. 마피아 주요 행동·발견·판단 회고. 외모/로그정리 모듈분리·중복문장 계산 감소. Chrome/WebKit·멀티실행·마피아150판·438자산 AAB 일치. 함수400항목117.8→5.8ms, 실기기 발열미측정. 신규EN/JA100%, 전체미측정. iOS준비만. 게임main유지."},
    {"id":"internal430-modular-home-surfaces","project":"서랍마을","section":"release","subsection":"testing","completed":true,"title":"내부 430 · 늘어나는 카운터·상판 가구·편집 도구·코드 정리","summary":"1.0.378(430), dev6ac54fa. 카운터 3슬라이스 길이1~6·회전 그림/기존배치 변환, 실제 가구 상판 미세격자/협탁1칸 흡착·앞 레이어·함께 이동. 이름숨김 옆 도구 위/아래 이동, 멀티 저장 실패 재시도. 소파 이미지 기준 좌석 정렬·대화주제1줄. 원본 해시 사진 재사용·부분저장 목록분리, 원문키 메모리캐시/잘못된 소품·도구 위치 코드 제거·기능 모듈화. 실제104→122 파일별 원인은 미확인, 누적사진 삭제 없음. Chrome/WebKit 드래그·좌석·대화·멀티재시도·마피아150판·AAB432자산 일치 검증. Play release320 내부 테스터 제공9/17 11:25, 서버완료. iOS 준비/WebKit만. 게임main 유지, 신규EN/JA100%,전체미측정. 대규모수정확인·모듈화·불명확요청이해확인 규칙 기록."},
    {"id":"internal429-furniture-life-mafia","project":"서랍마을","section":"release","subsection":"testing","completed":true,"title":"내부 429 · 새 가구·상판 소품·방별 행동·마피아 반응","summary":"1.0.377(429), dev159ff8a. 원화 크롭 화분2·협탁·카운터/연결형/상판·냉장고·인덕션, 카운터 가장자리 스냅·상판 한정 소품. 방별 기본 제한과 낮잠 금지, 침대 잔상·본가 침실 연결·아이콘 확대. 버튼/걸음/구두/부츠 소리·선택 팝업. 마피아 관련 근거·증거 없는 반박·조사, 3일차 NPC 투표, 발자국/실루엣·신뢰/원한 표적·감정 반응/큰 버튼. Chrome/WebKit UI·3언어·마피아150판·생활70·욕구검사·최종AAB427자산 검증. Play release319 내부 테스터 제공9/17 10:32, 서버완료. iOS 프로젝트/WebKit 준비만. 본가 제보 실기기 재현과 전체 승률 균형 미확인. 게임main 유지. 신규EN/JA100%,전체미측정."},
    {"id":"internal428-sync-home-replay","project":"서랍마을","section":"release","subsection":"testing","completed":true,"title":"내부 428 · 사진 동기화·집 편집·색 지정·마피아 설정과 회고","summary":"1.0.376(428), dev c142179. 교체 전 사진 포함 누적 파일수 안내·현재 참조 기준 이미지 한도·개별 기록 압축 동기화(실제 사용자 계정 성공 미확인, 여러 기기428이상 필요). 행동/가구·방 위치 일치, 편집 UI/가구/이름 숨김·취소·같은 집 방 프리셋20개. 자아 질문 캐릭터별 대기·머리/눈색 및 직접 이름/색 지정·광장 분수/대비 개선. 마피아 자동 무대·방장 인원/시간 설정·종료 후 날짜별 확정 목격/행동/회의/투표 회고. Chrome/WebKit3언어·생활70·마피아150판·깊은/큰 기록 왕복·최종AAB413자산 검증. Play release318 내부 테스터 제공9/17 03:46, 서버완료. iOS 프로젝트/WebKit 준비만, 서명업로드 미실행. 게임main유지. 신규EN/JA100%,전체미측정."},
    {"id":"internal427-mafia-votes-home","project":"서랍마을","section":"release","subsection":"testing","completed":true,"title":"내부 427 · 집 편집과 선택·감정·분산 투표","summary":"1.0.375(427), dev a734126·QA정리 a04e996. 집 편집 층수1~5·TV확대·가구 위→아래 반복 선택. 마피아 집1층·준비 안내 겹침 수정, 아침/점심/저녁 뒤 회의/밤, 사람·시신·도구 문맥 행동과 질문별 답변·변호4근거. 마피아 동료 협력·밤 표적/방법/현장조작·발견 장소/흔적, 탈락자 반투명. 성향·교육·판 전용 원한/고마움 분산 투표, 추방 없음/기권·동표 무탈락·이전 투표/낮 행동 증거. 깊은 기록 압축 동기화 및 실제 오류 표시(사용자 Android 계정 성공 미확인). 150판·Chrome/WebKit3언어·집 조작·압축 왕복·서명AAB412자산 검증. 자동120판 마피아97/시민23승으로 승률 균형은 추가 플레이 확인 필요. Play release317 내부 테스터 제공 9/17 03:04, 멀티 서버 완료. iOS 프로젝트/WebKit 준비만,427서명업로드 미실행. 기존 로그 정적검사1건 실패 기록. 게임 main 유지. 신규 EN/JA100%,전체미측정."},
    {"id": "internal425-preparation", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "내부 426 · 낮 준비·밤 침입과 회의 개선", "summary": "1.0.374(426), dev93a28dc. 낮 도구·잠자리 조사·잠금 보강·침대 정원 내 함께 자기 → 준비 기반 밤 침입 → 실제 집 현장 조사. 정체 비공개 동맹 판당1회·애도·야간 목격, 즉시 NPC 주 의견·반응5초·대기 단축·지목된 사람 반박/넘기기·감사·투표 내역. 낮 이동 증거 제거·카메라 유지. 새30판/기존40판·Chrome/WebKit3언어·최종 번들 검증. Android426 내부 제공22:57 release316. 멀티 서버 반영. Apple426 서명 업로드 성공(35104844648,93a28dc), Apple 처리 중 build:null·설치 가능 미확인·기존 수출규정 답변 대기. 공개 준비 중 유지. 신규 EN/JA100%, 전체 미측정."},
    {"id": "internal423-mafia-meeting", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "내부 424 · 회의 순서·증거·관전 및 아침 멈춤 수정", "summary": "1.0.372(424) dev d74d596. 주 의견 순서제, 지목된 인물 먼저 답변·부수 의견 2초씩 한 개, NPC 반응 절제. 근거 분류·소형 증거 버튼·화면 스크롤 정돈, 나무바닥 설정·놀이 목록 복귀. 관전 지도·죽은 인물 표시, NPC만 생존 시 전 관전자 넘기면 즉시 투표. 5일차 아침 결과 덮임 수정. 40판 및 Chrome/WebKit 3언어 검증, 423 Android 제공21:47(release314)·Apple서명업로드 성공. 설정 요약 숫자 대비 추가 수정한424 Android 내부 제공21:55(release315), Apple424 서명업로드 성공(35098202685)·Apple 처리 중·설치 가능 미확인, 기존 수출규정 답변 대기. 멀티서버 배포 완료. 신규 EN/JA100%, 전체 미측정."},
    {"id": "public421-internal422-needs-rooms", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "공개 421 · 내부 422 욕구 회복 및 방별 활동 설정", "summary": "main 5ac4797 / dev 06bec1a. 직접 지시 행동 욕구 갱신 누락 수정, 행동 중 회복·빠른 용변 회복. 방 설정 세부 활동22분류 기본 모두 허용·저장 유지·메뉴와 실행 제한. Chrome/WebKit 및 멀티 서버 검증. Android421(1.0.369) 프로덕션 Google 검토 제출·승인 후100%출시, 내부422(1.0.370) 테스터 제공 완료. Cloudflare 공개 a8123a2d 배포 및 실사이트22개 기본체크 확인. 멀티 서버 배포 완료. 공개 놀이 준비중 유지·내부422 활성 AAB 검증. Apple421/422 업로드 완료이나 수출규정 문서 답변 대기, 기존411 로그인4.8심사 문제 미해결. 배포 전체 완료로 표시하지 않음. 신규EN/JA100%,전체미측정. 기존 공유식사 회귀검사 실패는420에서도 재현."},
    {"id": "internal420-exterior-icon", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "내부 420 · 집 외형 그림만 표시", "summary": "1.0.368 (420), dev 3f0209b. 대표 내부사진 위 집 외형 아이콘의 흰 배경과 이름표 제거. 그림 클릭 외형 선택 유지. 테마의 일반 버튼 배경 적용에서 제외해 수정. Chrome/WebKit 배경 투명·텍스트 없음 및 침대·재질 선택 회귀검증.419 수정 모두 포함. Play release312 내부 제공(19:53), Apple Actions35087097095 성공 및 TestFlight420 테스트 준비 완료·기존 내부 초대1명 확인. 신규 번역 없음,419신규 EN/JA100% 유지."},
    {"id": "internal419-home-beds", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "내부 419 · 침대·집 사진·재질 선택·놀이 오류", "summary": "1.0.367 (419), dev a99643e. 놀이 모집 기록 누락 오류 수정. 침대 잠자기·쉬기 등 확대, 자기 방 침대 지정·1인 침대 실제 레이어 연결. 책장·화분20% 확대, 바닥5종·벽지7종 실물 미리보기, 대표 내부사진+작은 외형 아이콘, 사용자 광장 스프라이트. Chrome/WebKit 실제 집·침대·재질 선택, 60판 마피아 회귀·욕구검사 및 서명 AAB 내용 검증. 서버 배포 완료. Play419 제공·Apple419 업로드 완료. 최종 외형 후속420으로 두 플랫폼 내부 제공 검증 완료. 신규 EN/JA100%, 전체 미측정."},
    {"id": "internal418-opinions-night", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "내부 418 · 주 의견·반응과 밤 마피아", "summary": "1.0.366 (418), dev b449a54. 주 의견 대기열·복수 반응·반응 압박, 침묵 지적·입장 변경, 300초 회의와 생존 유저 전원 넘기기 2초. 새 게임 낮 2회 활동→회의/투표→밤 표적→아침 발견. 문장 증거·상황에 맞는 모순, 놀이 능력 6종 저장, 말풍선 자동 높이. 1인 침대 절반 크기·수면 위치, 행동 중 회복·용변 1분, 가구 전용 행동. 새 회의/밤/기존 각30판, Chrome/WebKit KO/EN/JA·저장/재접속 검증. Android Play release310 내부 제공 및 Apple TestFlight418 테스트 준비 완료·기존 내부 테스터1명 확인. 서버 반영 완료. 신규 EN/JA100%, 전체 미측정."},
    {"id": "internal417-context-meeting", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "내부 417 · 문맥 행동·1인 침대·참여형 회의", "summary": "1.0.365(417), dev 61d38d9. 현재 다른 행동 메뉴 안 전체 활동·상대/주제 선택, 1인 침대 레이어/크기·빠른 욕구 회복, 방별 가구 분류와 자유 배치. 새 마피아 회의 5종 발언·3종 반응·선착순·비공개 위증, NPC만 생존 시 2초, 자연스러운 배치/행동 움직임. 새/기존 규칙 각30판, Chrome/WebKit 3언어·활동 실행·침대·360x648 회의 검증. 서명 AAB 완료, Android/Apple 내부 배포 중. 신규 EN/JA100%, 전체 번역률 미측정. 공개 main 유지."},
    {"id": "apple411-guideline48", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "Apple 411 회신 완료 · 다음 업데이트 로그인 4.8 대응", "summary": "사용자가 승인한 원문으로 Apple 심사팀에 1.0.359(411) 버그 수정본 우선 승인 요청을 전송하고 확인. 승인 여부는 대기 중. 다음 업데이트의 동등한 개인정보 보호 로그인 옵션 구현은 미완료이며 417에 포함되지 않음."},

    {id:"internal416-activities-needs",project:"서랍마을",section:"release",subsection:"testing",completed:true,title:"내부 416 · 전체 할 일 복구·욕구·가구·추리 화면",summary:"1.0.364(416) · 앱 dev 2f5822b. 415 Play 제공 확인 후 기존 교류 버튼 전수 대조에서 빠진 거리두기 등의 항목까지 보완. 건물/가구의 다른 행동과 캐릭터 창에서 전체 할 일 복구, 교류 상대·주제·비용 선택. 새 1인 침대·TV·화분·책장, 변기와 욕구 행동·금지 욕구100, 관계 변화를 게임플레이로 이동, 침대·북쪽 의자 배치 및 추리 SVG 비율 조정. Chrome/WebKit 3언어·전체 활동·포옹 실행·욕구/로그·30판 검증, AAB 서명 통과. 416 Android 내부 테스터 제공 확인(9/16 14:11). 서버 배포 완료. Apple Actions35058302469 서명·검증·업로드 성공, TestFlight416 준비 완료 및 기존 나만 테스트 그룹의 416 설치됨 확인. 신규 테스트 수신자 추가·공개 승격 없음. 신규 EN/JA100%, 전체 번역률 미측정. 공개 main 유지."},
...
window.SEORAP_DATA.tasks.push({"id": "dv-performance338", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "반응속도·알림 진입 개선 · dev9473f2c / 실기기 검증 전", "summary": "화면교체 후 강제배치 계산 제거, 집/복귀 캐릭터 계산 묶음처리, 중복복귀 신호 병합. 알림은 계정복원/화면준비 후 열기. BGM 중복재생·복귀 경합 수정. 80명 CPU4배저속 최초클릭: 캐릭터246→54ms, 집709→291ms. 집화면1181→805ms이나 다른메뉴 paint편차/일부퇴행 남음. 9명 테스트도 기록. 30회전환 DOM398/리스너77 유지. 새알림·오디오 mock테스트/3언어웹/빌드107 통과. 과거알림검사 스키마31/상태바/버전186 고정검사3개 실패(기존항목). Galaxy S21 소리/실알림/Android·iOS 실기기 미검증. Android334 그대로, 배포안함. 새문구0 EN/JA 추가대상0. 렉완전해결로 표시하지 않음."});

window.SEORAP_DATA.tasks.push({"summary":"집·마을 대상 가까이 행동 메뉴: 방/가구/건물/사람, 조작 캐릭터 선택. 서버 목적지·출입·침대 확인. 실제 다툼/요리/최근 집 생활 사건 질문 3종·15선택, 기존 10분 간격/질문 유지, 성향과 후속 대화 반영, 사건·선택 기록. 334→339 사전337·누수336·전환/알림/BGM338 포함. APK 316개 자산 일치·APK/AAB 서명/339버전 확인. 3언어 모바일 메뉴 및 로컬·공유 실제 엔진 검사 통과. sharedTownApi 배포 완료. 기존 멀티 테스트 2개 실패(식사 대기 문구는 수정 전에도 동일, 이사 fixture는 personal-character-missing). 실기기 사운드/80명 사진멀티 검증 남음. 전체 로그 영구보관·R2 이전·예산 설정·iOS/Play 제출 제외. 신규문구 EN100% JA100%. 앱 dev 유지, 작업판 main.","subsection":"testing","section":"release","project":"서랍마을","completed":true,"id":"dv-context339","title":"Android 339 · 1.0.306 앱 전달 / dev b0b3676","type":"검수"});

window.SEORAP_DATA.tasks.push({"id":"dv-feedback340","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":true,"title":"Android 340 · 1.0.307 앱 전달 / dev 42bba85","summary":"개입하기 제거·전체설정10 금지행동. 생활질문24 추가·성격질문 반복, 고정 신체 제외. 나답게 즉시 행동, 공식관계·시선 돌봄 우선순위. 사전 그룹 즉시 반영·사진 JSON·전체80개(30+50), 기존 물품 덮어쓰기/삭제 보호. 스토리관리 준비중, 멤버 규칙읽기와 사전추가/관계제의/그룹제의 독립 권한. 모바일3언어, 설정저장, 즉시directive, local사진JSON, 권한/충돌/80개 테스트 통과. APK/AAB 서명 빌드, 자산319 확인. sharedTownApi 배포 완료. 실기기/실계정 사진멀티 및 모든 복합설정 질문 확대 미완료. 새문구 EN100% JA100%. 직전 전달339 기준 Discord/3언어노트 작성, 공지발송·스토어제출 없음. 앱dev·작업판main."});

window.SEORAP_DATA.tasks.push({"id":"dv-question-coverage-next","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"질문 확장 잔여 · 복합 프로필 설정","summary":"340 생활항목24 확장 완료. 모든 페이지의 복합 입력(여러 항목·날짜·소속 등)까지 상황 질문으로 연결되는지 전수 대조와 추가 필요. 전체 완성으로 표시하지 않음."});

window.SEORAP_DATA.tasks.push({"id":"dv-web341","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":true,"title":"웹341 배포 · 공지334→340 / dev21960bc","summary":"마을 헤더 아이콘 정상 크기·나무배경과 미색 메뉴. 관계 화면 PC전체고정 원인 수정·사이드바 유지·그룹선택과 캐릭터 겹침 해소. 웹 장바구니/결제/서버 5만원미만 제한 제거(양수 안전정수·서버가격 유지). PC전역 음소거와 웹설정 소리값은 브라우저 로컬 전용, 앱 동기화 안함. 3언어 PC/모바일·60,000원카트·오디오 native격리 테스트 통과. 실제청구 안함. Cloudflare c34758af 및 functions api 배포완료, live캐시/모듈 확인. 공지334→340 update-334-340-20260911-v1:585계정 KO578/EN3/JA4 발송·우편함검증, 푸시0. Android340유지·앱 dev, 작업판main. 신규번역 EN100% JA100%."});

window.SEORAP_DATA.tasks.push({"id": "dv-room342", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "방 사진 초기화·선물 안내·미설정 번역 / dev b5e1ce5", "summary": "방 사진/바닥 그림 개별 삭제와 기본 벽지·바닥 복원. 방사진 관찰화면 유지 안내, 바닥그림 우선 적용과 실제 전체그림 있을 때만 벽 숨김. 우편 캐릭터 선물 선택·저장 안내. 영어 캐릭터 선택 요약 갱신 시 한국어 미설정 노출 수정. 모바일 실제 편집기 초기화·영어 미설정 테스트/웹빌드 통과. 기존 광범위 검사 10실패는 수정전 동일. 신규문구 EN100% JA100%. Android340(1.0.307) 유지, 새 앱/웹 배포 없음. 앱dev·작업판main."});

window.SEORAP_DATA.tasks.push({"id": "dv-release343", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "Android343 · 1.0.310 앱 전달 / dev1166dd6", "summary": "340 이후 누적: 방사진/바닥그림 삭제·기본복원·영어 미설정·선물안내. 질문 부적합 의견 Firestore feedback(category discovery-answer-fit), 일요일09시 기존 후원자 일정에 검토 추가. 캐릭터 우편 이번에는 하지 않기(일정 생성 없음), 첫 질문 선택지 재열람 유지. 일반 동기화 시 질문아이콘 소실 수정. 사진변경없는 공유캐릭터 저장 manifest 왕복 제거, 캐릭터4/사진3 동시작업 제한, 멀티목록 카운트 대기 분리·시계변경 재렌더 억제·일시 오류 목록보존. 재입장 기존관리자 유지/ownerUid 기반 방장복구. 모바일3언어·우편재열람/거절·역할/슬롯·합성동시성 검사 통과. APK/AAB 서명·343버전·321개자산 검증. sharedTownApi 배포완료. 실기기 미연결/84초 원인 전체 확정 아님. 앱dev, 작업판main; 신규EN100% JA100%. 스토어제출/인게임공지 없음. 출시노트와 Discord343 파일 제공."});

window.SEORAP_DATA.tasks.push({"id": "dv-webp-after343", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "343 이후 개발 · 게임 그림 WebP 변환", "summary": "원본100개 RGBA 픽셀·투명도 동일 검증,98개 용량감소. 선택파일42.49MB→24.07MB(43%감소). 웹214/Android224 로컬참조 연결. 기존 저장경로용 원본 유지로 APK크기 감소는 아님. 원본 동적참조 전환·실기기 속도 측정은 후속. 웹빌드/네이티브117모듈/경로·캐시쿼리·외부URL격리 검사통과. 버전343(1.0.310)유지, 새앱배포없음. 추가UI문구없어 EN/JA 번역대상없음. 앱dev·작업판main."});

window.SEORAP_DATA.tasks.push({"id": "dv-own-home-344-dev", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": false, "title": "343 이후 dev0088216 · 본인 집 편집권한·방 편집 보완", "summary": "본인 집 외형/위치/서사상 소유자 설정 서버 허용, ownerUid 변조/타인 집 수정 차단. 방 삭제·벽지/바닥·출입·주인·가구 방이동 dev연결. 서버 단위검사·재가입권한 회귀·웹빌드 통과. sharedTownApi 서버배포 성공(격리된0088216 기준); Android343유지, 새앱미전달. 신규EN100% JA100%. 멀티 완전동등/코드덮어쓰기/공용시설소유/실기기검증/피해계정복구는 미완료."});
window.SEORAP_DATA.tasks.push({"id": "dv-network-audit-after343", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": false, "title": "네트워크 대기 진단 · 순차 로그 복원 후보 확인", "summary": "dev0088216 정적목록73 반복await후보/22 직접Firestore호출. auth301 v2복원 캐릭터별days조회 순차(2+N쿼리),1278프로필회원정보갱신 순차. 멀티목록이미병렬/사진동시성제한. 수정전목록요청에 따라 네트워크로직 추가변경 없음. 84초원인확정/3~8초개선 주장하지않음; 실제기기단계별시간·저장형식확인 및 최적화후비교 미완료."});

window.SEORAP_DATA.tasks.push({"id": "dv-support-uid-after343", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "343 이후 dev7e4bb55 · 문의 메일 계정 UID 첨부", "summary": "개발자 문의 메일 자동 진단에 현재 로그인 계정 UID 표시. 비로그인은 KO/EN/JA 별도 표기. 토큰/비밀번호 미포함. 구문검사 및 단일 변경 diff 확인. 새 앱·웹 배포 전: Android343유지. 이번 추가문구 EN100% JA100%. 개별 계정 진단 정보는 작업판에 공개하지 않음."});

window.SEORAP_DATA.tasks.push({"id": "dv-release344-performance", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "Android344 · 1.0.311 성능 개선 앱 전달 / dev769e248", "summary": "v2캐릭터 로그복원4동시·8ms디코딩양보,회원프로필갱신4동시,멀티화면 프레임당1갱신,집편집 최신대기스냅샷만저장.80명 CPU4배 12갱신622→104ms/12→1렌더,12ms모의조회1220→302ms,21편집2쓰기·마지막값/실패재시도검증.80명왕복 리스너84/DOM400유지·질문우편3언어QA통과.343이후누적 본인집권한/방편집/문의UID포함. WebP는이번앱보류(변환중복미포함).APK71.3MB/AAB70.5MB 버전서명·www일치검증,개별파일및3언어출시노트/Discord패치노트전달. 실기기84초원인전체해결아님·멀티생성슬롯동기화/질문서버확인은유지. 완전기능동등·코드덮어쓰기·피해계정역할복구·미커밋상호작용별도.스토어제출/웹배포/공지발송없음.앱dev·작업판main.추가문구EN100%JA100%."});
{const t=window.SEORAP_DATA.tasks.find(t=>t.id==='dv-network-audit-after343');if(t)t.summary+=' 344에서 순차 로그복원4동시와 렌더/저장적체 개선·비교검증 완료. 실기기 추가검증은 남음.';}

window.SEORAP_DATA.tasks.push({"id": "dv-group-reconnect-after344", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "344 이후 dev2d6c7b1 · 네트워크 복구 시 멀티 목록 유지", "summary": "빈 오프라인 캐시를 서버 삭제로 취급하지 않도록 수정. 재연결 시 가입 목록 재조회·같은 그룹 데이터 유지·오래된 조회 결과 무시·최대4 동시조회. 네트워크 실패/복구/선택없음/서버 빈 결과 및 재입장 권한 유지 테스트 통과. Android344(1.0.311) 유지: 새 빌드·웹·스토어 배포 전. 서버 개인정보/권한 변경 없음. 새 사용자 문구 없음(EN/JA 번역 대상 없음). 앱dev 반영, 작업판main 반영."});

window.SEORAP_DATA.tasks.push({"id": "dv-release345-context", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "Android345 · 1.0.312 상호작용/질문 저장/멀티 복구 · dev7bae1b2", "summary": "추천 행동→같은 메뉴내6분류/자기행동/스크롤·기록제거. 방향별 포옹키스로그·시선자각성격관계반영·거절무드·집포옹animation실행검증. 질문답변기기델타선저장/재시작복원,80명 전체저장8.7ms→답0.4ms(데스크톱). 집장면캐시공유·멀티재연결수정누적. KO/EN/JA UI 및 실제포옹로그차이/애니메이션/거절·우편회귀·델타복구/삭제/리셋/실패 테스트통과. APK/AAB345서명·www확인개별전달,3언어노트와직전비공개344대비Discord노트작성. sharedTownApi서버5a74748배포완료. 앱dev/작업판main,PlayConsole제출·웹배포없음. 새문구EN100%JA100%;실기기전체렉해결아님·멀티답변서버대기유지."});

window.SEORAP_DATA.tasks.push({"id": "dv-morality-after345", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "345 이후 dev9dbd271 · 도덕성·마을 성향 통계", "summary": "동전 질문7종으로 확대, 도덕성0–100 독립성향 및 성격8페이지 설정/점수/잠금 연동. 마을 범위 성향평균·유형빈도를 생활과사회지표 아래표시, 개인선택제거·미설정성격순위제외. KO/EN/JA 신규문구100%. 브라우저 평균52.1/순위/위치/설정저장 검증. Android345(1.0.312)유지·새앱/웹배포전. 앱dev반영(main유지), 작업판main. 성능/연출/일정추가작업 진행중."});

window.SEORAP_DATA.tasks.push({"id": "dv-release346", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "Android346 · 1.0.313 도덕성/포옹연출/일정/방장권한 · dev6c5ff7f", "summary": "345대비 도덕성·동전7선택/마을성향평균·미설정순위제외. 포옹키스방향별서술/수락로맨틱효과·빗자루오분류수정. 대화중복감소,선택즉시전체저장감소·동일홈저장생략·렌더배치/시선캐시/해시할당개선. 다음날등록일정수면보다우선. 서버ownerUid가낡은멤버표시보다우선(관리/집편집포함),재가입owner/manager·슬롯유지회귀통과. 실제포옹CSS/효과·KOENJA통계·우편/답변복구·일정·멀티맥락검증. APK/AAB버전서명및324개번들파일일치확인,개별파일/3언어출시노트/345대비Discord노트전달. sharedTownApi 3ddd3f1 서버배포성공. 앱dev만반영(main배포분리),작업판main. PlayConsole업로드/웹배포없음. 추가문구EN100%JA100%;전체실기기렉완전해결아님·새리뷰제안기능별도."});

window.SEORAP_DATA.tasks.push({"id": "dv-release347", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "Android347 · 1.0.314 멀티방별 프로필·공지 편지함 · dev65a5a0c", "summary": "멀티 가입/가입후 방별 이름·사진/삭제 설정, 재가입 기존프로필 유지, 계정프로필 일괄덮어쓰기 제거. 집 들어가기 사용자화면 이동, 일부장면캐시재사용. 정서성향 도덕성/3페이지제목/전체나무배경3열검색크레딧 개선. 공지편지함 https://drawer-village-notices.web.app 배포: 지정관리자검증·초안/확인/명시전송·중복방지, 인게임30일공지·푸시메일없음. 실제공지 미발송. 앱KOENJA 신규문구100%, 관리자전용사이트한국어. 저장취소/권한재가입/평균통계/레이아웃/공지서버와UI모의테스트 통과, 미로그인실서버401. 80명CPU4x집렌더568ms로 실기기렉완전해결은 아님. APK/AAB347서명버전및326파일번들일치 검증개별전달. 346대비Discord노트완료. sharedTownApi3a03ffa배포, 앱dev만/main유지·Play업로드없음. 작업판main반영."});

window.SEORAP_DATA.tasks.push({"id": "dv-release348-mail", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "Android348 · 1.0.315 우편 보관·선택 삭제·공지 차단 방지", "summary": "공지와 유저 우편 자동 만료 제거. 일반 편지 선택 삭제는 본인 우편함에만 적용, 공지는 삭제/차단 대상 제외. 서버·클라이언트·발송 차단 예외, 일반 편지 차단 유지. 50건 커서 페이지/동일 시각/권한/원자적 삭제/반복삭제/KOENJA 화면 검증. sharedTownApi와 expireVillageMail fc6fd30 배포, 공지 관리 사이트 반영. APK/AAB348 서명·버전·번들 검증 및 파일 전달, Play 업로드 없음. 전체 기능·튜토리얼 순서·Claude 요청문 11쪽 DOCX/MD 작성·페이지 확인. 앱 dev e9391b4 반영, main 라이브 유지. 신규 유저 문구 EN100%/JA100%, 문서는 한국어. 실제 공지 발송 없음. 과거 물리 삭제 우편 복구 아님."});

window.SEORAP_DATA.tasks.push({"id": "dv-release349-performance-questions", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "Android349 · 1.0.316 화면 중복 계산 감소·질문 6종/답변 30개", "summary": "dev6dbc3be. 집 준비와 표시 장면캐시 공유·역방향 참여자 인덱스, 첫 프레임 뒤 부가작업/음악/갱신예약·화면이탈 취소, 0위치 스크롤복원·이미지중복순회 제거. 새질문6종/답변30개: 기여도·케이크·거스름돈·빌린물건·비밀·새치기, 이기적/계산적/악의적/폭력적 답변과 도덕성 독립 반영. 대상점수형 질문 후보누락·잠금판정 수정. 새문구 EN100%/JA100%. 80명 CPU4x 집5회 계산805→405/마지막 실행 중앙254→226ms, 아직 수백ms 경우 남음. 반복화면402노드84리스너 유지. 개인질문처리4.6ms/저장36ms(멀티지연 아님). 질문·잠금·기기복구·우편·상호작용·집진입·모바일태블릿 회귀통과. APK/AAB 서명버전번들 검증·348대비Discord노트 전달. 앱dev/main유지, Play업로드·게임사이트배포 없음. 전체실기기렉해결 주장 안함."});

window.SEORAP_DATA.tasks.push({"id": "dv-release350", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "Android350 · 1.0.317 우편 선택모드·말투 예문·성향 통계 / dev220efdf", "summary": "우편 선택삭제 진입 후 체크표시·취소, 공지 보호. 50만 균형형/49.9·50.1 방향 표시. 말투30종 예문창·유사2종 통합·기존값호환, 신규EN100%JA100%. 이동기록을 DOM교체 앞으로/0스크롤복원 생략/마을중앙정렬 지연/행동기한 작업6ms분할. 80명CPU4x 349대비 관찰543→397ms 캐릭터296→155ms 집312→309ms 마을285→371ms(개선 미확정). 9명스와이프36/16/11/12/14ms 모두전환, 질문저장42ms. 실기기전체렉해결아님. 우편/통계/예문3언어/답변복구 테스트, APK/AAB350서명·326자산 일치. 340→350 누적공지 파일작성·미발송. 앱dev, 라이브main유지, Play·웹배포없음."});

window.SEORAP_DATA.tasks.push({"id": "dv-performance350-followup", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": false, "title": "350 이후 남은 마을 진입·실기기 지연 검증", "summary": "합성80명 테스트에서 마을285→371ms 편차/퇴행, 집약309ms와 첫관찰397ms 남음. 실사용 사진·관계 데이터와 실제 Android Performance trace 기반으로 추가 원인 확인 필요. 모든 버벅임 해결로 표시하지 않음."});

window.SEORAP_DATA.tasks.push({"id": "dv-release351", "project": "서랍마을", "type": "검수", "section": "release", "subsection": "testing", "completed": true, "title": "Android351 · 1.0.318 책 말투 겹침·방 판정·불필요 재계산 수정", "summary": "dev d77b261. 실제 전체설정 hidden select를 !important스타일이 다시표시하던 문제 수정·예문전용팝업 확인. 통계0/100방향·중앙차이·정확히50균형. 주인없는 owners방 공용/모두허용/개인실·직접대상제한 보존. 접촉실패 원인문구 분리. updateRoom 실제차이만 반영으로 뒤로가기시 재계산 감소, 책0스크롤 강제배치 제거. 9명CPU4x 전체설정425→225ms 반복109→68ms, 집67→66ms 상점40→39ms로 큰멈춤 미재현. 실기기 사진·상점·왕복지연 해결확인 아님. 실제책/통계3언어/권한/변경없음/상호작용 QA, 서명·326자산·351버전 확인. 앱개별파일·340→351공지 제공, 공지미발송·Play업로드없음. 신규EN100%JA100%. main라이브유지, 작업판main."});
window.SEORAP_DATA.tasks.push({"id":"dv-web-payment-20260912","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":true,"title":"웹 결제 긴급 수정 · 승인 서버 환경 일치","summary":"웹 실결제창과 승인 서버 테스트 환경 불일치 확인. 기존 일반결제 상점 라이브 키로 서버 바인딩만 수정, ACTIVE 반영 확인. 실패하던 주문 조회 HTTP200 확인(결제 승인·청구하지 않음). 실제 카드 결제 완료는 새 주문으로 사용자 확인 필요. Android351/1.0.318 유지, 가격·권한·게임코드 변경 없음. 추가 번역 대상 없음. 공지·제보자 이메일 미발송."});
window.SEORAP_DATA.tasks.push({"id":"dv-photo-nav-diagnostic351","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"351 사진 포함 화면 전환 지연 재현 · 원인 추가 검증","summary":"9명/512px 합성사진/CPU4x에서 전체설정423ms·화면기회757ms, 집228/311ms. 전체DOM교체·동기저장 CPU확인. 실제유저데이터 아님/정상사진저장후비교·실기기필요. 후처리는별도스레드가아님. 전체멈춤해결/351퇴행확정 아님. dev진단추가, 새앱배포없음. 번역대상없음."});
window.SEORAP_DATA.tasks.push({"id":"dv-release352","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":true,"title":"Android352 · 1.0.319 사진 표시 주소 재사용","summary":"dev 수정. 사진 원본/저장/내보내기는 그대로, 화면 src만 한도있는 재사용 주소로 표시. 9명 사진 CPU4x 집228→126ms 반복219→104ms. 첫전체설정 화면기회757→828ms 개선미확정·상점변화없음. 전체렉해결 아님. 디코딩/원본저장/사진복원/말투/방권한/실제상점클릭 검증. APK/AAB서명·번들검증 및 개별파일전달. 번역대상없음. Play·웹·공지배포없음. 작업판main/앱dev."});

window.SEORAP_DATA.tasks.push({"id":"dv-release353","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":true,"title":"Android353 · 1.0.320 선택창 유지·조사 보정 분할·하오체·공지 주소","summary":"dev468139b. 화면 resize 때 행동창 닫힘 제거; 취소 후 전체 재렌더 대신 정상 집 타이머 재개. 조사 보정 표시 후4ms분할/오래된 순회취소, 이름동일시 정규식재사용. 선비하오체복구. 공지발신자/전체이용자·그룹구성원 표기 KO EN JA 검증. 새표시번역 EN100% JA100%(전체번역률 아님). 327자산서명번들일치 APK/AAB. 274는simulation버전주소만 변경, 원인단정불가. 실기기6초먹통 미해결,24개시간측정자동첨부. 앱dev만/라이브main변경없음/공지미발송."});

window.SEORAP_DATA.tasks.push({"id":"dv-six-second-stall","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"351 실기기 모든 버튼2~6초 지연 원인 추적","summary":"캐릭터수 증가없이 악화. 합성9명 CPU4x에서 미재현. 353 자동진단 input/render/save/signature/build로 실제 느린구간 확인 필요. 해결/출시완료 처리하지 않음."});

window.SEORAP_DATA.tasks.push({"id":"dv-release354","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":true,"title":"Android354 · 1.0.321 사진 재시도·알림 이미지 제한·말투 변경","summary":"dev789c9c7. 장면아바타 eager, blob실패시 원본재시도(기존fallback과충돌방지). 알림아이콘2초제한·시험알림준비후5초. 초성반말추가/귀여니제거기존반말호환/거친말투순화명삭제/다나까질문·애교·번역기예문. 사진원본유지/재시도·말투·아이콘정지테스트통과. 서명APK/AAB354. 3~6초전환지연 및 실제기기알림도착은 미확인/미해결; ADB기기없음. 새초성표시ENJA번역완료, 기존전체번역률미산정. 라이브main미변경/공지미발송."});

window.SEORAP_DATA.tasks.push({"id":"dv-release355","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":true,"title":"Android355 · 1.0.322 지연 중 쌓인 터치의 뒤 화면 실행 방지","summary":"dev3ce044f. 화면/클릭완료 전 발생한 오래된 trusted입력 차단·새입력 즉시허용; 시간제화면잠금없음. CDP오래된pointer/click이 새버튼 실행하지않고 다음새클릭실행 검증. 모바일384x854 합성9명 마을집홈30회: DOM450~451/리스너109유지, heap6.53→6.90MB; 누수확정불가/실기기6초지연미해결. APK/AAB서명번들검증. 출시노트KOENJA완료100%(신규노트범위). 첨부말투v2미적용·귀여니제외유지. 앱dev/작업판main, 라이브와공지미배포."});

window.SEORAP_DATA.tasks.push({"id":"dv-release356","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"356 · 1.0.323 Android 파일 완료 · Apple 내부테스트 업로드 접수","summary":"dev0040b8b(앱변경3875973). 캐릭터·집·설정페이지 선택정보 별도 계정저장, 편집초안 저장지연. 방 사진 안내/삭제 선택창이동, 해제시 바닥설정 보존. 일정384x500 스크롤실제검증. 9월14일 슬롯1개1000원 KOENJA안내·색상대비, iOS단일슬롯 허용. 브라우저/영수증모의검증/Android356서명APK·AAB완료. 실제기기3~6초멈춤 완전해결미확인, 실제IAP판매상태미확인. TestFlight356 internal-only빌드34631910977서명/업로드성공·Apple접수확인. build:null로 처리/테스터설치가능여부미확인, 공개앱/공지발송없음. 신규문구 EN/JA100%, 전체번역률미산정."});

window.SEORAP_DATA.tasks.push({"id":"dv-ios358-auth","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"iOS358 · Android357 · 1.0.324 계정 확인 무한 대기 수정","summary":"앱 dev fd9413c / 회귀검사817cb11. 로그인 기록·도움말 확인 저장을 진입 대기에서 분리. 네이티브 웹 리다이렉트 복원 생략, 계정 읽기 기한과 기록 보존 재시도 안내, iOS Firestore long polling 적용. 응답 없는 메타데이터 저장에도 진입/계정 읽기 실패시 기록 보존/다른 계정 격리/늦은 응답 차단 검사 통과. Android357 APK/AAB 생성 및 329개 자산 일치. iOS358 Actions34635142382 서명·업로드 성공, Apple uploadAccepted=true 확인. ASC에서358 처리 완료·수출 규정 문서 확인 필요 상태 확인, 실기기 로그인·실결제 미검증/공개 심사 미제출. 기존356은 ASC 테스트 준비 완료 확인. 단일 슬롯 IAP6811144000 1000원 KOENJA 등록, 심사 전. 신규 재시도 안내 EN/JA100%, 전체 번역률 미산정."});

window.SEORAP_DATA.tasks.push({"id":"dv-ios359-native-auth","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"iOS359 · Android358 · 1.0.325 앱 로그인 초기화 수정","summary":"358 실기기에서 계정 불러오기 오류 지속 제보. dev b2880c7: 앱에서 getAuth 기본 웹 팝업 초기화 대신 initializeAuth 사용, 기존 IndexedDB/localStorage 세션 검색 유지. Firebase12.2.1 실제 SDK·모바일 UA에서 로그인 보조 요청 무응답 조건 재현: 기존 초기화 pending, 수정 경로 ready/보조 요청0건. 계정격리·무응답·기록보존·오류화면 검사 통과. 오류 코드와 실패 단계를 표시. iOS359 Actions34636792699 성공, 서명·Apple uploadAccepted=true 확인. Android358 APK/AAB 서명 및330개 자산 일치. 실제 기기 진입 확인 전/공개 심사 미제출. 추가 d44d1de에서 실제SDK 기존 로그인 복원 검사 통과. 새 오류 코드 라벨 EN/JA100%, 전체 번역률 미산정."});

window.SEORAP_DATA.tasks.push({"id":"dv-ios360-slots","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"iOS360 · Android359 · 1.0.326 슬롯 반영·삭제 대기·태블릿 메뉴","summary":"앱 dev 662b8e3. 검증된 TestFlight 구매 슬롯 복원 연결, 정식 구매와 분리. 기본5+구매5 사용2 남은8·다른UID격리 테스트 통과. 캐릭터 화면 상시 슬롯표시/생성 확인팝업 제거. 태블릿 홈 일정·관계 겹침 수정. 삭제대기와 초기로딩 분리·응답기한·확인전 기기기록 보존. KO/EN/JA 신규문구100%, 전체번역률 미산정. Android359 APK/AAB 서명검증·330개자산일치·개별파일전달 완료. iOS360 Actions34639607554 성공, Apple uploadAccepted=true 확인(source662b8e3), ASC360 처리완료·수출규정답변 필요 확인. 서버 구매내역조회 배포 완료·미인증401 확인. 실제 기기 구매/삭제결과 미검증·공개심사/공지발송 없음."});
window.SEORAP_DATA.updates.unshift({"version":"iOS360 / Android359 · 1.0.326","code":359,"date":"2026-09-12","items":["슬롯 사용·남은 수 상시표시 및 구매내역 반영 수정","태블릿 홈 메뉴 겹침 수정","계정 삭제 응답 대기 개선","iOS360 Apple 업로드 접수 완료 / Android359 APK·AAB 전달 / 정식 출시 아님"]});

window.SEORAP_DATA.tasks.push({"id":"dv-ios361-restore-input","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"iOS361 · Android360 · 1.0.327 복원 재시도·입력 중 저장 지연","summary":"앱 dev 9c5c84b. 복원 실패가 후속 구매를 영구 차단하던 경로 수정. 미검증 미처리 거래의 새 결제 차단 유지. 연결 로그인 표시·삭제 단계/취소/오류 표시. Apple 네이티브 제공자 등록 추가(실기기 인증/서명 기능 검증 전). 질문 답변 저널 유지·입력 중 전체 자동저장 지연. 4상품·계정격리·취소/지연·답변복구 검사 통과. Android360 서명 APK/AAB 전달·331개 자산일치. CPU4x9캐릭터 질문43ms/전환85~435ms, 제보된356 수초멈춤 미재현·해결확정 아님. 구매서버 오류구분 배포 완료. iOS361 Actions34642416421 성공·Apple uploadAccepted=true·source9c5c84b 확인. TestFlight 처리/실기기 확인 전. 새 EN/JA100%, 전체번역률 미산정. 공개심사·공지발송 없음."});
window.SEORAP_DATA.updates.unshift({"version":"iOS361 / Android360 · 1.0.327","code":360,"date":"2026-09-12","items":["구매 복원 재시도 및 연결 로그인 표시 개선","계정 삭제 진행·취소·오류 안내 개선","질문 답변 보존·조작 중 전체 저장 지연","Android 검증본 전달 / iOS361 Apple 업로드 접수 완료 / 실제 기기 검수 필요"]});

window.SEORAP_DATA.tasks.push({"id":"dv-ios362-restore-sync","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"iOS362 · 1.0.327 Apple 구매 동기화 실패 시 확인된 구매 복원","summary":"dev7276afb. 사용자 오류 restoring: RESTORE_FAILED로 네이티브 Apple 동기화 단계 확인. 서버검증 Sandbox 구매 먼저 반영·동기화 실패해도 미처리거래 조회/서버검증. 확인된 구매 반영과 Apple추가확인 실패 구분·빈구매를 성공으로 표시하지 않음·UID불일치 거부. 4상품/실패복구/중복지급·환불 검증 통과. EN/JA새문구100%,전체미산정. iOS362 Actions34643843816 성공·Apple uploadAccepted=true·source7276afb 확인. Android360 유지. 실제기기 동기화 원인/복원결과 미검증·정식심사 없음."});
window.SEORAP_DATA.updates.unshift({"version":"iOS362 · 1.0.327 (Android360 유지)","code":360,"date":"2026-09-12","items":["Apple 동기화 실패 시 이미 확인된 구매 복원 개선","미처리 구매 추가 확인과 복원 결과 안내 개선","iOS362 Apple 업로드 접수 완료 / 실제 기기 검수 필요"]});

window.SEORAP_DATA.tasks.push({"id":"dv-ios363-apple-reauth","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"iOS363 · 출시 보류: Apple 재인증 서명 권한 수정","summary":"사용자362 구매복원 성공 확인, 계정삭제 AuthorizationError1000 확인으로 출시/심사 보류. 감사34645431386에서 Apple개발자 capability/배포프로필(Default) 정상 확인, 앱프로젝트 entitlements 연결 누락 수정(dev726d467). 최종서명앱 권한 검증 추가. 멀티는 Firebase토큰+멤버십 별도검증; 연결실패목록보존/방장우선/자기집편집 검사 통과. 실제기기 재인증/멀티는 미검증. iOS363 Actions34645610856 업로드 승인 완료, 최종 앱/프로필 Apple 로그인 권한 검증 통과. 실제 기기 본인확인 대기, Android360 유지. 신규번역문구 없음(직전 EN/JA100%,전체미산정)."});
window.SEORAP_DATA.updates.unshift({"version":"iOS363 · 1.0.327 (출시 보류)","code":360,"date":"2026-09-12","items":["362 구매복원 사용자 확인 완료","Apple 본인확인에 필요한 앱 서명 권한 수정","멀티 인증·권한 경로 및 연결 복구 검사","363 업로드 완료 / 본인확인 및 새 멀티 제보 검수 전 출시 보류"]});

window.SEORAP_DATA.tasks.push({"id":"dv-multi-roster-return363","project":"서랍마을","type":"버그","section":"release","subsection":"testing","completed":false,"title":"멀티 멤버 상호 누락 / Android360 개인 마을 복귀 먹통 조사","summary":"세 계정 중 꺄륵과 아이패드가 서로 목록에 표시되지 않음. 동일 그룹 확인을 위한 양쪽 초대 코드 대기. 두 명 제한 없음; 신고·차단 숨김 후보 확인. Android360(1.0.327) 멀티 방문 후 개인 마을 스와이프/버튼 먹통 제보. 실제 변경 버튼→내 마을→뒤로가기→스와이프 3회 로컬 브라우저 검사 통과(첫 방문 안내 닫은 후), 실제 기기/네트워크 미재현. dev17834a9에 회귀 검사 기록. 해결 완료/출시 아님."});
...
window.SEORAP_DATA.tasks.push({"id": "dv-reports-next-0912", "project": "서랍마을", "type": "버그", "section": "release", "subsection": "testing", "completed": false, "title": "다음 업데이트 · 멀티 옷장·일정 ID·선택 저장 개선", "summary": "dev f0facae. 개인옷 소유목록/멀티옷장복원 반환값/옷선물 정의저장 및30개제한 수정. 실제서버문서ID 우선, 일정그룹선택의 월드 고정. 선택답변·예약행동 소형저널 후 전체저장 지연. 사진 마을복제 시험24~41ms→1ms미만(PC9MB); 실제Android3~4초 지연 미해결검증. 단계별저장계측 추가. 불면·식사안함/드묾 선택과 건강 직접입력 노출. 출퇴근수단 기존기능, 종족/사망 미구현. 회귀7종 통과. 신규문구EN/JA100%,전체미산정. APK/IPA·서버반영 대기, 현재Android360/iOS363유지."});
window.SEORAP_DATA.tasks.push({id:"dv-furniture-mobile-0912",project:"서랍마을",type:"개선",section:"release",subsection:"testing",completed:false,title:"다음 업데이트 · 가구 원화·회전·앞뒤 순서 / 휴대폰 지연 검증",summary:"dev74feca0. 투명 원본에서 가구만 추출, 의자·소파 방향별 그림과 의자 프레임 분리. 아래쪽 그림이 앞에 표시되도록 집/마을 레이어 변경. 침대 원화 기준 상대 크기. 가구 편집 저장 지연·사진 복원 중복 제거·마을 사진 JSON복제 제거. 384px CPU4x 합성 검사: 이미지/회전/겹침/재실행 보존/화면 이동 통과(50~234ms, 한 캐릭터). 실제 Android 누적 지연 해결은 미확인. LD사진을 소지품으로 전환하지 않음. 앱 빌드 번호 유지(Android360/iOS363), 새 배포 없음. 웹패키지 기존 account-identity.js 캐시키 누락 검사 실패 남음. 신규문구 없음, EN/JA 기존 문구 재사용; 전체 번역률 미산정."});
window.SEORAP_DATA.updates.unshift({version:"dev · 가구 원화와 배치 개선 (앱 번호 유지)",code:360,date:"2026-09-12",items:["새 가구 그림과 방향별 회전, 의자 앞뒤 레이어","집·마을에서 그림 아래쪽 기준 앞뒤 순서","마을 이동 사진 복제와 중복 복원 작업 감소","개발 검증 완료 / 실제 휴대폰 지연 및 새 앱 배포 대기"]});
window.SEORAP_DATA.tasks.push({id:"dv-build364-icon",project:"서랍마을",type:"검수",section:"release",subsection:"testing",completed:false,title:"1.0.328 (364) · Android 파일 완료 / iOS 업로드·검수 중",summary:"dev4fed3b2 소스. 서랍마을1024아이콘·가구원화/회전/깊이순서·사진복원중복/마을복제/선택저장 개선 포함. APK/AAB 서명·버전 검증 완료, 설치파일 전달. iOS 업로드34684697876 및 iPhone/iPad 실행검사34684697915 진행. ASC1.0.328 초안과 구매경로·수동출시 저장; 아직 심사 미제출. 실제휴대폰 누적렉 해결 미확정. 옷장/일정 서버수정은 배포대기. 새앱문구 EN/JA 해당범위100%, 전체미산정. 앱dev만,라이브main유지."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (364) 테스트 준비",code:364,date:"2026-09-12",items:["서랍마을 앱 아이콘 적용","새 가구 그림·회전과 집/마을 앞뒤 순서 개선","마을 이동·사진 복원 및 답변 저장 반복 처리 감소","Android APK/AAB 완료 / iOS 업로드·검수 진행 / 심사 전"]});
window.SEORAP_DATA.tasks.push({id:"dv-ios-profile365",project:"서랍마을",type:"버그",section:"release",subsection:"testing",completed:false,title:"1.0.328 (365) · 프로필 스크롤·사진 배치 수정 / 검수 중",summary:"363 iPhone402×820 제보 재현. theme.css 전체화면 셸 규칙이 작은 프로필팝업까지820px로 확대해 잘림·스크롤없음 발생: 적용범위 분리. 사진배치 grid행이 미리보기보다작아 안내겹침: 콘텐츠높이보존. Chrome 실제터치스크롤/WebKit 배치검사 통과. Android365 APK/AAB 빌드·서명·버전확인 전달. iOS365 업로드34685294625/실행검사34685294623 진행. 364심사미제출,365로대체. 아이콘·가구개선유지. 새앱문구없음 EN/JA재사용,출시노트3언어완료. 앱dev7089ab0/검사5bf735e/노트40eb2bb;라이브main유지."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (365) · iPhone UI 제보 반영",code:365,date:"2026-09-12",items:["프로필 편집에서 아래 항목까지 스크롤 복구","사진 배치 미리보기와 안내문 겹침 수정","서랍마을 아이콘·가구 개선 포함","Android 설치 파일 완료 / iOS 업로드 검수 중 / 심사 미제출"]});

window.SEORAP_DATA.tasks.push({id:"dv-ui366-performance",project:"서랍마을",type:"버그",section:"release",subsection:"testing",completed:false,title:"1.0.328 (366) · 가구·건강 설정·통계 수정 / 실기기 지연 추적",summary:"건물 재실 캐릭터표시를 건물보다 위로 분리. 새 식탁그림 범위를 식탁만으로 제한, 소파35%·식탁40% 확대. 건강설정을 내용 흐름과 스크롤로 전환, KO/EN/JA Chromium/WebKit 검증. 마지막 사진페이지 명칭 추가 LD 사진. 통계 평균에 해당 단계 설명 사용. 모바일 CPU4배감속 질문 아이콘 80~154ms, 터치닫기 정상; 실제폰 3초먹통 미재현/미해결로 유지. 질문열기·창표시 진단 추가. Android366 서명 APK/AAB 완료·버전확인, 코드 dev d06876a. iOS365 업로드·시뮬레이터 성공했으나 최신제보로 심사 보류. 새문구 EN/JA 해당범위100%, 전체미산정. dev만 반영."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (366) 검증용",code:366,date:"2026-09-12",items:["건물 위 캐릭터 위치 표시를 항상 앞에 표시","식탁 외 책상 그림 복구, 소파·식탁 크기 조정","건강 설정 겹침 수정과 스크롤","추가 LD 사진 명칭 및 통계 단계 설명 정리","질문 지연 진단 추가 / 실제폰 먹통 해결 미확정 / 심사 보류"]});

window.SEORAP_DATA.tasks.push({id:"dv-inspect366",project:"서랍마을",type:"검수",section:"release",subsection:"testing",completed:false,title:"366 검사 APK 완료 · 기존 설치본 서명 불일치로 실기기 측정 대기",summary:"Capacitor WebView 디버깅 기본false 확인. inspect 변형만 true, release BuildConfig false 검증. 366 1.0.328-inspect APK 서명검증·빌드완료; 진단AAB 차단. 연결 SM-S918N 기존365 실행확인. adb install -r 서명불일치 UPDATE_INCOMPATIBLE로 실패, 기존앱 삭제/데이터초기화하지 않음. 실제마을 내보내기 파일이 있어야 별도진단 설치본에서 재현가능. 프로파일 기록 스크립트 준비, 아직실기기녹화없음. USB Download에서 2026-09-12 백업 JSON 발견했으나 0바이트 확인. 앱 내부 데이터 삭제 의미 아님. 저장완료 안내 여부 확인 대기, 파일첨부 없이 USB로 정상백업 수집 가능. dev ba5bd25. 새UI문구없음 EN/JA변경없음."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (366) 진단 준비",code:366,date:"2026-09-12",items:["일반앱 디버깅은 끈 채 검사용 APK만 검사 허용","기존 앱과 서명이 달라 설치 차단됨 · 원본 데이터 유지","실제 데이터 재현 및 성능 측정 대기 · 스토어 제출 없음"]});

window.SEORAP_DATA.tasks.push({id:"dv-backup367",project:"서랍마을",type:"버그",section:"release",subsection:"testing",completed:false,title:"Android367 · 백업 내보내기 종료 원인 확인·수정 / 실기기 재검증 대기",summary:"SM-S918N 실로그 TransactionTooLargeException 28,312,468 bytes. Capacitor가 백업 본문을 Activity 상태에 2회 저장. 본문은 전용 캐시 파일, call options는 작은 token만 남기도록 수정. 8KB 복사·빈내용검사·취소/실패정리. APK/AAB 빌드·서명·367버전확인 완료. 기존서명 불일치로 스토어 업데이트 후 실기기 저장검증 필요. 원본앱/데이터삭제없음, 전체렉 미해결. dev b6c90ef, iOS변경없음. 새문구없음 기존KO/EN/JA사용."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (367) Android 백업 수정",code:367,date:"2026-09-12",items:["백업 저장 화면 이동 시 앱 종료 원인 확인 및 수정","빈 백업 방지·파일 복사 처리 개선","Android APK/AAB 완료 · 스토어 배포 및 실기기 재검증 대기"]});

window.SEORAP_DATA.tasks.push({id:"dv-export368",project:"서랍마을",type:"버그",section:"release",subsection:"testing",completed:false,title:"Android368 · 백업/설정 파일 브릿지 분할 전송",summary:"확인된 ProfileExport.saveJson 입력본문의 대용량 전달 축소. 367 Bundle token화에 이어 전체백업·캐릭터/사전 내보내기를 32768 UTF16단위 분할. 이모지경계·byte offset검증·취소/실패정리. iOS기존방식유지. 큰Unicode 원문동일성·길이상한·마지막호출token·실패정리·iOS분기검사, APK/AAB 빌드/서명/버전 통과. 사용자폰 실제저장완료는 스토어업데이트후 대기. 전체버튼렉으로확대해석안함. dev01db87c, 새UI문구없음 KO/EN/JA재사용."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (368) Android 내보내기",code:368,date:"2026-09-12",items:["큰 백업·설정 파일을 작은 단위로 나눠 전달","백업 저장 화면 이동 중 종료 수정 포함","Android 빌드완료 / 실제폰 저장 검증 및 스토어배포 대기"]});
window.SEORAP_DATA.tasks.push({id:"dv-health-furniture369",project:"서랍마을",type:"개선",section:"release",subsection:"testing",completed:false,title:"Android369 · 가구 크기·침대 레이어·건강 기록 / 최신 크래시 검증 대기",summary:"dev0cbbbb7. 의자80%확대, 소파/식탁확대, 침대 본체→캐릭터→이불 순서. 건강 기록 이름/유형/통증0~10 CRUD·기존값 보존·내보내기. 건강하단 여백과 복용약 메뉴 상속스타일 수정. 방이동/약변경 저장예약. KO/EN/JA Chromium/WebKit CRUD/레이아웃, 방이동드래그/침대순서 및 청크내보내기검사 통과. APK/AAB 빌드·APK서명·369버전확인. 사용자 최신앱 크래시 제보 후 USB목록 비어 설치버전/새로그 미확인. 전체렉 해결 아님. 스토어배포/iOS심사보류. 신규EN/JA각100%,전체미산정. 생사/사별 및 흡연/주량 이동 보류."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (369) Android 확인용",code:369,date:"2026-09-12",items:["의자·소파·식탁 크기와 침대 앞뒤 표시 개선","병명·유형·통증 기록 추가와 건강/복용약 화면 정리","가구 이동·복용약 변경 후 화면 먼저 반영","APK/AAB 완료 · 최신 크래시 실기기 확인 및 스토어 배포 대기"]});
window.SEORAP_DATA.tasks.push({id:"dv-snapshot370",project:"서랍마을",type:"개선",section:"release",subsection:"testing",completed:false,title:"Android370 · 저장 압축을 별도 작업자로 분리 / 실기기 반복 검사 대기",summary:"dev265ded0. 실제폰368/업데이트19:48 확인,20:15 백업8MB 저장·USB수집·JSON파싱 성공. 남은 Java크래시는19:17/19:20 업데이트전. 저장 gzip/검증/용량부족 재압축 Worker분리, 최신저장큐·키revision·계정epoch로 오래된결과폐기. 복구사본 압축결과재사용. 종료/계정전환 동기flush유지. 실제백업 PC Chromium CPU4x 최대타이머간격1522~1592→84~129ms, WebKit211~212→17~28ms(실기기측정아님). 원문동일·quota·계정왕복·삭제·작업자실패·최신편집·종료·초기화 검사통과. 370 APK/AAB 서명·버전·소스모듈일치확인. 369가구/건강포함. 실제370폰 반복조작검증 및 스토어배포 대기. 신규문구없음, EN/JA369범위100%,전체미산정."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (370) Android 저장 구조 개선",code:370,date:"2026-09-12",items:["저장 압축이 화면 반응을 막지 않도록 처리 분리","연속 저장·계정 전환 시 최신 데이터 보호","368 실기기 백업 저장 완료 확인","369 가구·건강 화면 개선 포함 / 370 실기기 검증 대기"]});
window.SEORAP_DATA.tasks.push({id:"dv-feedback-furniture371",project:"서랍마을",type:"개선",section:"release",subsection:"testing",completed:false,title:"Android371 · 가구 터치 이동 / 질문 의견·익명 문의",summary:"앱 dev6738dff. 소파·식탁 축소(의자 유지), 좌석 기준 정렬·반려동물 앞뒤 표시, 식탁 식사 행동. 내마을/멀티 방간 CDP 터치 드래그 통과. 멀티 복귀 버튼 및 기존집 방·가구 코드 적용(방 사진·주인 연결, revision검증). 익명 문의 API/메일 서버와 일요일09시KST 질문 의견 묶음메일 배포완료. 이유 복수선택·가까운답·추가설명과 당시 질문/답변 원문 저장. Chrome/WebKit 문의3언어·집코드 검사 및 저장Worker 회귀 통과. APK/AAB371 완료. 실제폰 좌석/반복성능, 실제메일 도착·첫 주간실행, iPhone실기기·iOS제출 대기. 신규문구 EN/JA100%,전체미산정."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (371) 가구·문의 개선",code:371,date:"2026-09-12",items:["소파·식탁 크기와 좌석 위치 조정, 반려동물 앞뒤 표시 개선","편집 중 손가락 드래그 취소 방지 / 방 사이 가구 이동","멀티에서 내 마을 복귀 버튼과 기존 집 인테리어 코드 적용","게임 안에서 이름·이메일 없이 문의 전송","질문 의견에 이유와 가까운 답변 선택 / 일요일 질문별 묶음메일","Android371 파일 완료 · 실제기기 확인과 스토어 배포 대기"]});

window.SEORAP_DATA.tasks.push({id:"dv-drag-size372",project:"서랍마을",type:"오류 수정",section:"release",subsection:"testing",completed:true,title:"372 준비 · 가구 이동 중 순간 축소 수정",summary:"dev816ead9. 개인 집 드래그 갱신에서 그림 확대 배율이 누락되던 원인 수정(의자1.8배→1배 재현). 개인/멀티 모두 드래그 미리보기 크기를 시작 크기로 유지. Chrome 모바일 터치로 방간 이동 중 각20지점 너비·높이 유지 검증. 실기기·APK/AAB372·스토어 배포 미완료. 신규 문구 없음, EN/JA 추가번역 불필요. 다른372 작업은 진행 중."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (372 준비)",code:372,date:"2026-09-12",items:["가구를 움직일 때 그림이 순간적으로 작아지는 문제 수정","다른 방 위로 드래그하는 동안 가구 미리보기 크기 유지","dev816ead9 코드 반영 · 새 앱 파일과 실제기기 검증 대기"]});

window.SEORAP_DATA.tasks.push({id:"dv-bundle372",project:"서랍마을",type:"개선",section:"release",subsection:"testing",completed:true,title:"Android372 · 가구 편집 통합 / 멀티 집 코드 보완",summary:"dev edb0c06. APK/AAB1.0.328(372) 빌드·서명·버전·포함JS 확인. 크기 유지/방간 드래그/겹친 가구 순환선택/의자 자석 켜기끄기 터치검사 통과. 편집 중13명×5렌더 장면조회65→0. 소파1.75배·착석위치 조정, 빈 의자 필요. 집사진·accessCharacterIds 코드적용 Chrome/WebKit 확인. 저장Worker 회귀·서버권한/충돌검사 통과. iOS372 프로젝트·정적검사만 완료, Mac서명/실기기/심사 미완료. EN/JA 신규문구100%,전체미산정. 실제폰 첫진입 지연과 새 튜토리얼 대본 적용은 남음. Play배포 없음."});
window.SEORAP_DATA.tasks.push({id:"dv-tutorial372-pending",project:"서랍마을",type:"개선",section:"release",subsection:"testing",completed:false,title:"새 튜토리얼 대본 구현·첫 집 진입 실기기 검증",summary:"환영/간편생성/첫장면/행동/질문/마무리 안내의 새 대본은 372에 적용하지 않음. 실제폰 첫 집 진입 지연과 반복 사용시 성능도 추가 확인 필요."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (372)",code:372,date:"2026-09-12",items:["가구 순간 축소 수정·방간 이동·겹친 가구 선택 개선","의자 자동 붙이기 켜기끄기 / 빈 의자가 있는 식탁만 이용","소파 크기·착석 위치 조정 / 편집 중 불필요한 행동 조회 제거","멀티 집 공유 코드의 집 사진·출입 대상 적용 보완","Android APK/AAB 완료 · iOS는 프로젝트 준비 · 스토어 배포 전"]});

window.SEORAP_DATA.tasks.push({id:"dv-empty-home373",project:"서랍마을",type:"개선",section:"release",subsection:"testing",completed:true,title:"Android373 · 빈집 공유 코드 바로 적용",summary:"캐릭터 연결은 접힌 선택사항, 0명 멀티 빈집에도 사진·방·가구 적용. 미연결 인물 지정은 비우고 출입 대상이 모두 비면 모두 허용으로 복사. Chrome/WebKit 빈집 복사 검사. 관리자 일정 제안/승인/바로 적용, 의류 선물 소지품+정의 저장/중복방지 서버 검사 통과(기존 수정 검증). 제보자 그룹 실데이터는 미확인. APK/AAB373 빌드·서명·버전 확인. iOS373 프로젝트만 준비. EN/JA 신규문구100%. 스토어배포 없음."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (373)",code:373,date:"2026-09-12",items:["빈 멀티 집에도 캐릭터 연결 없이 공유 코드 적용","인물 연결은 선택 항목으로 접기 / 미연결 인물 지정 정리","기존 옷 선물·관리자 일정 수정 회귀 검사","Android APK/AAB373 완료 · iOS 프로젝트 준비 · 스토어 미배포"]});

window.SEORAP_DATA.tasks.push({id:"dv-seat374",project:"서랍마을",type:"개선",section:"release",subsection:"testing",completed:true,title:"Android374 · 착석 크기·식탁 의자 묶음 이동",summary:"dev07b9a70. 의자/소파 착석 때만 약12% 축소·중앙정렬, 가구 사용중 이름/말풍선 숨김·식사 동작. 의자 프레임/방석 동시 드래그, 식탁 연결 의자 묶음 방간 이동·자동 방향. 편집버튼 간소화·식당 표기·마을/그룹 펼침표시. Chrome 터치·좌표·저장 검사 통과. APK/AAB374 서명·버전·포함파일 확인. iOS374 프로젝트만 준비, 실기기/업로드 미완료. EN/JA 이번문구100%,전체미측정. 휴대폰 전체 지연 해결 미확정."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (374)",code:374,date:"2026-09-12",items:["의자·소파에 앉을 때만 아이콘 축소·좌석 정렬","가구 사용 중 이름·말풍선 숨기기 / 식사 동작","식탁과 연결 의자 함께 이동·자동 방향 / 의자 분리 수정","편집버튼 간소화·식당 표기·마을/그룹 펼침표시","Android APK/AAB374 완료 · iOS 프로젝트 준비 · 스토어 미배포"]});

window.SEORAP_DATA.tasks.push({id:"dv-seats375",project:"서랍마을",type:"개선",section:"release",subsection:"testing",completed:true,title:"Android375 · 2인 소파 / 식탁 옆자리 확보",summary:"dev e2baa9d. 소파 2인 정원·독립 행동/함께 활동 좌석 유지, 착석 크기·높이 조정. 식탁 옆 방향 의자 사용중 바깥으로 빼기·퇴석 원복, 음식 이모지 표시. 시뮬레이션 정원/자리검사 및 Chrome 터치·소파2자리·식탁 가림/음식/원복 검사 통과. APK/AAB375 빌드·서명·버전·포함파일 확인. iOS375 프로젝트 준비만 완료. 사용자 원화 실기기 시각검증·아이폰 업로드 미완료. 새 UI문구 없음, EN/JA 출시노트100%,전체미측정."});
window.SEORAP_DATA.updates.unshift({version:"1.0.328 (375)",code:375,date:"2026-09-12",items:["소파 두 자리·함께 활동해도 좌석 유지","의자·소파 착석 크기와 위치 조정","식탁 옆 의자 사용중 자리 확보·퇴석 원위치","식탁의 각 식사 자리 음식 이모지","Android APK/AAB375 완료 · iOS 프로젝트 준비 · 스토어 미배포"]});
...
Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==="dv-release377"),{completed:true,title:"377 누적 수정·양대 스토어 심사 제출 완료",summary:"런타임 dev9074dcd, 기록3d3795a. Android377 프로덕션 검토 중(사전검사 완료). Apple1.0.328(377) 9월13일01:25 심사 대기 접수08905947-b915-46d1-b781-29e976c2a6bd. 양쪽 승인 후 자동 공개, 아직 공개 전. iPhone/iPad 시뮬레이터 실제 게임 DOM·이미지 확인, Chrome/WebKit 화면·스크롤·가구 및 저장/멀티 일정 회귀검사 통과. 물리 기기 전체 검사 아님. EN/JA 이번문구100%, 전체 미측정. 앱main 미승격."});

window.SEORAP_DATA.tasks.push({id:"dv-ios-startup377",project:"서랍마을",type:"오류",section:"release",subsection:"testing",completed:true,title:"377 iPhone·iPad 시작 화면 실제 렌더 확인 완료",summary:"프로세스만 확인하던 검사에서 흰 이미지를 발견해 실제 DOM 완료 검사로 강화. iPhone34704089929 및 iPad 단독34704830246에서 게임 UI·버튼6개·bootError없음·PID·정상 시작 이미지 확인. 중간 iPad 실행명령 시간초과는 성공으로 처리하지 않음. 진단은 CI 전용이며 배포 바이너리 변경 없음. 최종 Apple377 심사 제출 완료. 실기기 성능 보장은 아님."});
Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==="dv-release376"),{completed:true,title:"376 누적 수정 · 최종377에 통합",summary:"376 기능은377에 포함해 배포 파일 완성·양대 스토어 심사 제출. 376 별도 배포 없음. 최종 상태는377 항목 참조."});
Object.assign(window.SEORAP_DATA.updates.find(u=>u.code===377),{version:"1.0.328 (377 심사 접수)",items:["침대·소파 상호작용과 이름·행동표 숨김 개선","이전 멀티 일정·저장·스크롤·가구 이동 등 누적 수정","iPhone·iPad 시작 화면 및 브라우저 회귀검사 확인","Android 프로덕션 검토 중 / Apple 심사 대기 중","양대 스토어 승인 후 자동 공개 · 현재 공개 전"]});
window.SEORAP_DATA.tasks.push({id:"dv-release378",project:"서랍마을",type:"오류",section:"release",subsection:"testing",completed:false,title:"378 오류 수정 · Google Play 내부 테스트 전용",summary:"마을 건물 위 주민 표시, 미래 생활 로그, 제목 화살표와 버튼, 신체 선택창 스크롤, 편지 발신자 수정. 이전 멀티 일정 ID 복구는 서버 로컬 검사 통과·운영 반영 보류. Android378 빌드 완료·내부 테스트 업로드 중. iOS 파일 내보내기 네이티브 구현·Mac 컴파일 검사 중. 프로덕션 승격 금지. EN/JA 변경 범위100%, 전체 미측정."});
window.SEORAP_DATA.updates.unshift({version:"1.0.329 (378 내부 테스트 준비)",code:378,date:"2026-09-13",items:["Google Play는 내부 테스트까지만 배포: 프로덕션은 해당 버전의 별도 명시 요청 필수","건물 주민 표시·미래 로그·드롭다운·신체 선택창·편지 발신자 수정","추가 설정은 수면 빈도·교육 기술·라이벌/가문 배경으로 제한","이전 일정 복구 서버 반영은 보류, iOS 컴파일 검사 진행"]});
Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==='dv-release378'),{completed:true,title:'378 내부 테스트 배포 완료 · 서버·iOS 실기기 검증 별도',summary:'Google Play 내부 테스트378(1.0.329) 9월13일09:39 제공됨 확인. 직전 내부375 대비376~378 누적 안내 작성. 앱 dev5e163e9, main 미반영·프로덕션 미승격. Chrome/WebKit 스크롤·미래 로그·건물 표시·편지 발신자, 서버 일정 ID/모호성 검사 통과. iOS Mac 컴파일 통과 및 시작 화면 DOM/이미지 확인; 실행 명령 시간초과로 CI전체 실패, 실제 파일 저장은 미검증. 서버 운영 적용·iOS378 제출 없음. EN/JA 변경범위100%, 전체 미측정.'});
window.SEORAP_DATA.tasks.push({id:'dv-server378-pending',project:'서랍마을',type:'오류',section:'release',subsection:'testing',completed:false,title:'378 이전 멀티 일정 복구 서버 반영 대기',summary:'기존 개인 캐릭터 ID를 현재 멀티 주민 ID로 연결하는 복구·관리자 권한 검사는 통과. 중복 ID는 임의 연결 금지. 운영 서버 적용 여부 사용자 답변 대기. 새 공유 수면 빈도·관계 배경도 해당 서버 반영 필요.'});
Object.assign(window.SEORAP_DATA.updates.find(u=>u.code===378),{version:'1.0.329 (378 내부 테스트 제공)',items:['Google Play 내부 테스터에게만378 제공 완료: 프로덕션 승격 없음','건물 주민 표시·미래 로그·전환 버튼·신체 스크롤·발신자 수정','수면 빈도·교육 기술·일부 관계 배경 추가','이전 멀티 일정 추가 복구는 서버 적용 대기','iOS 컴파일·시작 화면 확인, 실제 내보내기 검증 및 배포 별도']});
window.SEORAP_DATA.tasks.push({id:'dv-private-dev-workflow',project:'서랍마을',type:'개선',section:'release',subsection:'testing',completed:false,title:'소유자 전용 개발 사이트 · 공개판 핫픽스 분리',summary:'앱378 유지. dev에서 개발 전용 웹 빌드 준비, 운영 Firebase/결제 설정 제거 및 외부 API/폼 전송 차단 검사 통과. 별도 Sites 소유자 전용 배포 진행. Android 공개377 기준 태그 고정, main의 오래된 코드와 GitHub Pages 연결을 확인해 강제 변경 금지. 개발 멀티 서버는 아직 별도 구축 전.'});
window.SEORAP_DATA.updates.unshift({version:'개발 환경 분리 (앱378 유지)',code:378,date:'2026-09-13',items:['공개판과 별도 주소·저장소를 쓰는 소유자 전용 개발 사이트 준비','공개 앱377 기준에서 긴급 수정만 시작하는 작업 절차 기록','개발 사이트의 실제 결제·운영 멀티 서버 연결 차단','앱 신규 배포·프로덕션 승격 없음']});
Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==='dv-private-dev-workflow'),{completed:true,title:'소유자 전용 개발 사이트 배포 완료 · 핫픽스 기준 고정',summary:'https://drawer-village-private-dev.riwoo-03.chatgpt.site 소유자 전용 배포 성공. 앱378 유지·프로덕션 변경 없음. 게임 dev de7708c. 개발 웹은 별도 기기 저장만 사용, 운영 API/결제/폼 전송 차단 검사 통과. 실제 멀티 시험을 위한 별도 Firebase 개발 서버는 아직 미구축. main 강제 변경 없이 공개377 기준 태그에서 핫픽스 분리 가능. 개발 안내 문구 EN/JA 포함, 전체 번역률 미측정.'});

window.SEORAP_DATA.tasks.push({id:'dv-home-polish378',project:'서랍마을',type:'개선',section:'release',subsection:'testing',completed:true,title:'dev 집 착석·캐릭터 정보·소파 행동·반려생물 이동 수정',summary:'앱1.0.329/378 유지, dev a8049e2 반영. 직접 시킨 소파/의자 행동 도착 후 착석 표시 복귀, 소파 아이콘 축소·중앙 배치 및 의자 확대. 현재 행동 카드→할일 창 연결, 소파 낮잠·독서·영상·음악 추가. 음료 준비 장소/연출 구분, 고양이 재렌더 이동 초기화 방지, 하단 가구 편집 도구 상단 배치. Chrome/WebKit 모바일 흐름 및 생활 시뮬레이션70 검사 통과. 앱/웹 배포 없음, 실기기·멀티 미검증. EN/JA 신규 문구100%, 전체 미측정.'});
window.SEORAP_DATA.updates.unshift({version:'집 착석·행동 개선 (dev / 앱378 유지·미배포)',code:378,date:'2026-09-13',items:['직접 시킨 소파·의자 행동에도 착석 위치와 크기 적용','캐릭터 현재 행동을 먼저 확인한 뒤 할 일 창 열기','소파 낮잠·독서·영상·음악 선택 추가','음료 준비/마시기 구분 및 소품 연출','고양이 재렌더 이동 초기화 방지·하단 가구 편집 도구 위치 개선','개발 코드 검증 완료, 앱·사이트 배포 별도']});
window.SEORAP_DATA.tasks.push({id:'dv-lifestyle-feedback-review',project:'서랍마을',type:'개선',section:'roadmap',subsection:'ideas',completed:false,title:'생활 성향·튜토리얼·반복 행동·음식점 방문 제보 검토',summary:'청결/정리 미루기/불성실한 생활 성향이 현재 행동 선택에 실제 반영되는지 먼저 점검. 튜토리얼 확장 및 상호작용 발견성, 같은 행동 반복, 메뉴를 넣은 음식점의 방문 조건 재현 필요. 이번 집 UX 커밋에서는 시스템 전반 변경하지 않음.'});

window.SEORAP_DATA.tasks.push({id:'dv-save-inquiry-dev378',project:'서랍마을',type:'개선',section:'release',subsection:'testing',completed:true,title:'dev 저장 오류 구분·익명 문의·로그 정렬·따라하기 안내',summary:'게임 dev e96e45b, 앱1.0.329/378 유지·미배포. 중첩 저장은 최신 내용까지 완료, 계정 전환 재시도 차단, 첫 저장부터 비동기 압축. 저장 오류 원인/단계 진단. 특정 질문5개 선택 저장·재실행 Chrome/WebKit 통과. 설정 첫 화면 익명 문의, 생활 로그 최신순/오래된순, 도움말 따라하며 배우기 추가. 의자 착석 2인 침대 기준, 라이벌 배경 추가. 신규 KO/EN/JA100%, 전체 번역률 미측정. 제보자377 실기기 실패 원인 확정 아님.'});
window.SEORAP_DATA.tasks.push({id:'dv-slot-catalog-next',project:'서랍마을',type:'개선',section:'release',subsection:'testing',completed:false,title:'슬롯 새 가격·5개 묶음 코드 준비 / 스토어 적용 대기',summary:'캐릭터1개1000원·5개4800원, 마을1개1900원·5개9300원 코드 준비. 기존 구매 권리 유지, 지급·모의 Apple 환불/중복 처리 검사 통과. 양 스토어 실제 상품 등록·가격 변경·결제 테스트와 서버 반영은 아직 안 함. 사용자 요청 전 프로덕션 배포 금지.'});
window.SEORAP_DATA.tasks.push({id:'dv-shared-auto-contact',project:'서랍마을',type:'개선',section:'roadmap',subsection:'ideas',completed:false,title:'멀티 캐릭터 자동 우편·알림 대상 지원',summary:'현재 개인 마을 캐릭터 기준 대상 선택 확인. 멀티 본인 캐릭터 및 다른 소유자 캐릭터 지원은 별도 설계/검증 필요. 동의·권한·탈퇴/차단 시 예약 취소 확인 전 완료 안내 금지. 사용자 답변 초안 작성, 발송하지 않음.'});
window.SEORAP_DATA.updates.unshift({version:'저장·문의·튜토리얼·슬롯 구성 (dev / 378 유지·미배포)',code:378,date:'2026-09-13',items:['저장 요청 중첩 처리·압축 저장·용량과 일반 실패 안내 구분','설정 첫 화면 익명 문의 / 최신순·오래된순 생활 로그','도움말 따라하며 배우기 / 의자 착석 크기 / 라이벌 배경 추가','캐릭터1개1000원·5개4800원 및 마을5개9300원 코드 준비','웹 빌드·Android 자산 포함·Chrome/WebKit 검사 통과','실제 앱·사이트·서버·스토어 가격 변경 없음 / 멀티 자동 연락 지원 별도']});

window.SEORAP_DATA.tasks.push({id:'dv-internal379',project:'서랍마을',type:'개선',section:'release',subsection:'testing',completed:false,title:'1.0.330 (379) · Android 내부 제공 / TestFlight 진행',summary:'dev c910b6a. Google Play 내부 release281: 9월13일20:07 내부 테스터에게 제공됨 확인. 응원자 공개 승인3명 갱신·미색/검은 테두리, 생활 로그 인물 가로 배치·스크롤·정렬, 간결한 따라하기 안내. 직전 내부378 이후 저장·문의·가구·소파 행동·반려동물 이동 변경 포함. Chrome/WebKit 및 Android 빌드/서명 검증 통과. TestFlight34753311646 업로드 진행. 프로덕션·App Store 심사·서버·상품 가격 변경 없음. 신규 EN/JA100%, 전체 미측정.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.330 (379 내부 테스트)',code:379,date:'2026-09-13',items:['Android379 내부 테스터 제공 완료 / TestFlight 진행','응원자 공개 명단 갱신·미색 글자와 검은 테두리','생활 로그 인물 가로 배치·최신순/오래된순·스크롤 개선','소파 행동·착석 위치·반려동물 이동·음료 연출 개선 포함','저장 처리·익명 문의·간결한 따라하기 안내 포함','프로덕션과 App Store 심사 제출 없음 / 멀티 일정 서버 적용 별도']});
Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==='dv-internal379'),{completed:true,title:'1.0.330 (379) · Android 내부 테스트·TestFlight 배포 완료',summary:'게임 dev c910b6a 소스. Android 내부 release281 20:07 제공 확인. TestFlight34753311646 성공, Apple 처리 완료·테스트 준비 완료 및 기존 나만 테스트 내부1명 그룹 연결 확인. 테스트 안내 저장. 공개 응원자3명/미색·검은 테두리, 생활 로그 인물 가로/스크롤/정렬, 간결한 따라하기와 직전 내부378 이후 미배포 수정 포함. Chrome/WebKit·Android 서명/버전 검증 통과. 실물 iPhone 미검증. 프로덕션·App Store 심사·서버·가격 변경 없음. 신규 EN/JA100%, 전체 미측정.'});
window.SEORAP_DATA.updates.find(u=>u.code===379).items[0]='Android379 내부 테스터 제공 및 TestFlight379 테스트 준비 완료·기존 내부 그룹 연결 확인';
window.SEORAP_DATA.tasks.push({id:'dv-home-room-after379',project:'서랍마을',type:'버그',section:'release',subsection:'testing',completed:true,title:'dev · 가구 배치 화면 밀림·샤워 장소 수정',summary:'dev2fa3994, 앱1.0.330/379 번호 유지·이후 수정 미배포. 가구 이동 후 자동 중앙 스크롤 때문에 숨김 방 캔버스195px 밀림 재현/제거. 실제 샤워부스·욕조와 출입 권한을 기준으로 샤워 방 선택, 세탁/설거지 분리. Chrome/WebKit 실제 추가·방간 드래그·좌표 유지·권한 검사 및 기존 생활70개 검사 통과. 기존 배포379에는 아직 미포함. 신규 문구 없음·KO/EN/JA 공통 동작 반영, 전체 번역률 미측정.'});
window.SEORAP_DATA.updates.unshift({version:'가구 배치·샤워 장소 수정 (dev / 379 이후·미배포)',code:379,date:'2026-09-13',items:['가구를 놓거나 옮긴 뒤 집 전체가 위로 밀리는 자동 스크롤 수정','방 이름·종류와 별개로 실제 샤워 시설이 있는 출입 가능한 방 우선','세탁기·건조기만 있는 방은 샤워 시설로 취급하지 않음','Chrome/WebKit·생활 시뮬레이션 검증 완료 / 앱 신규 배포 별도']});
...
window.SEORAP_DATA.tasks.push({"id":"dv-mail385","project":"서랍마을","type":"버그","section":"release","subsection":"testing","completed":true,"title":"1.0.333(385) 우편 저장·선물 내부 테스트 완료","summary":"Android385 release284 9월14일00:32 내부 테스터 제공됨. 선택형 우편 저장 실패 롤백·중복 방지, 큰 저장본 비동기 보관·복구/계정 분리. 아이돌·취미 선물 복구, 새 앱 외부계정 하루1개/KST·수락시 개인사전1칸·선물 출처 이름표. 승인된 선물 서버만 별도 반영, 구버전 호환 유지. 소유권은 공유코드 독립복사 안내, 보낸기록 삭제 기존기능 검증. 실기기 제보 데이터 재현은 미확인. Chrome/WebKit 우편 UI·저장 검사, 모의 서버 검증 통과. 앱dev a588b69, 공개앱/웹main·iOS 신규배포 없음. 이번EN/JA100%, 전체미측정."});
window.SEORAP_DATA.updates.unshift({"version":"1.0.333 (Android 내부 테스트)","code":385,"date":"2026-09-14","items":["우편 선택·읽기 저장 오류 개선 / 기존 저장본 보호","아이돌·밴드/취미 선물 복구, 새 앱 수락·출처 이름표","다른 이용자 선물 KST하루1개, 수락 후 개인 사전1칸","385 단일AAB 내부 테스터 제공, 정식/새iOS 배포 없음"]});
window.SEORAP_DATA.copyTemplates.unshift({"id":"mail385-ownership","emoji":"✉️","title":"캐릭터 소유권","question":"캐릭터 소유권","replies":[{"label":"한국어","code":"ko","content":"안녕하세요. 현재 멀티 마을에서 기존 캐릭터의 소유권을 다른 계정으로 직접 넘기는 기능은 지원하지 않습니다.\n\n대신 ‘프로필 내보내기 → 공유 코드 만들기’로 코드를 전달하면, 상대방이 ‘공유 코드로 불러오기’에서 사진과 설정을 자신의 캐릭터로 복사할 수 있습니다. 받는 계정에는 빈 캐릭터 슬롯 1개가 필요합니다.\n\n이 방식은 별도의 캐릭터를 만드는 기능이므로 기존 멀티 캐릭터의 소유권이나 관계·생활 기록을 그대로 이전하지는 않습니다. 참고 부탁드립니다!"}]});
window.SEORAP_DATA.copyTemplates.unshift({"id":"mail385-delete","emoji":"✉️","title":"실수로 보낸 우편 기록 삭제","question":"실수로 보낸 우편 기록 삭제","replies":[{"label":"한국어","code":"ko","content":"안녕하세요. 우편함의 ‘보낸우편 → 선택 삭제’에서 삭제할 편지를 체크한 뒤 ‘선택 삭제’를 누르면 본인의 보낸 기록에서 지울 수 있습니다.\n\n다만 이는 내 기록을 지우는 기능으로, 상대방에게 이미 도착한 편지를 회수하거나 전달된 선물을 취소하는 기능은 아닙니다. 이용에 참고 부탁드립니다!"}]});
window.SEORAP_DATA.copyTemplates.unshift({"id":"mail385-gift","emoji":"✉️","title":"선물 카테고리 누락","question":"선물 카테고리 누락","replies":[{"label":"한국어","code":"ko","content":"안녕하세요. 의도적으로 제외한 것이 아니라, 우편으로 선물을 보내는 화면에서 ‘아이돌·밴드’와 ‘취미’ 물품이 누락된 오류를 확인했습니다. 불편을 드려 죄송합니다.\n\n해당 물품도 다시 선택하고 전달할 수 있도록 수정하여 내부 테스트에 반영했으며, 확인 후 다음 업데이트에 반영하겠습니다. 자세히 알려주셔서 감사합니다!"}]});
window.SEORAP_DATA.copyTemplates.unshift({"id":"mail385-quota","emoji":"✉️","title":"우편 선택·저장 오류 답변","question":"우편 선택·저장 오류 답변","replies":[{"label":"한국어","code":"ko","content":"안녕하세요. 보내주신 진단에는 앱의 저장 영역 한도 오류가 반복되어 기록돼 있습니다. 휴대폰 전체 용량이 부족하다는 뜻으로 단정할 수는 없습니다. 저장 실패 때 우편 선택과 화면 표시도 지연될 수 있는 부분을 수정하고, 큰 게임 저장본을 별도의 기기 저장소에 보관하도록 개선했습니다. 내부 테스트 후 다음 업데이트에 반영하겠습니다. 기존 데이터를 보호하기 위해 앱 데이터 삭제나 재설치는 하지 말아 주세요."}]});
window.SEORAP_DATA.copyTemplates.unshift({"id":"mail385-discord","emoji":"📣","title":"1.0.333(385) 내부 테스트 패치노트","question":"381 이후 누적 385 내부 테스트 안내","replies":[{"label":"한국어","code":"ko","content":"서랍마을 1.0.333 (385) 내부 테스트 업데이트\n\n이번 업데이트에서 변경된 주요 내용을 안내드립니다.\n\n✨ 새로운 기능\n- 다른 이용자에게 받은 선물을 수락하거나 거절할 수 있습니다. 수락하면 내 사전 슬롯1개를 사용해 추가됩니다.\n- 받은 물품에 ‘○○에게서 받은 선물’ 이름표가 표시됩니다.\n\n🔧 개선 사항\n- 다른 이용자에게 보내는 선물은 계정당 하루1개로 안내합니다. 한국 시간 자정에 갱신되며, 내 캐릭터끼리는 자유롭게 주고받을 수 있습니다.\n- 저장 한도 오류가 반복될 때 큰 게임 저장본을 보관하는 방식을 개선했습니다.\n\n🎨 UI/UX\n- 받은 선물에 미색 카드와 수락·거절 버튼을 추가했습니다.\n\n🐛 오류 수정\n- 우편 선물 선택에서 아이돌·밴드와 취미 물품이 빠지던 문제를 수정했습니다.\n- 저장 오류 때문에 선택형 편지의 답변이 반응하지 않거나 편지 열기가 막힐 수 있던 부분을 수정했습니다.\n- 답변 저장 재시도 때 같은 행동이 중복 등록되지 않도록 했습니다.\n\n※ 새 선물 수락 기능은 보내는 분과 받는 분 모두385번 내부 테스트 앱으로 확인해 주세요. 정식 버전에는 아직 반영되지 않았습니다."}]});

window.SEORAP_DATA.tasks.push({"id": "dv-internal386", "project": "서랍마을", "type": "개선", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.334 (386) · 금지행동 분류·침대 이름표 내부 배포", "summary": "dev c49f514. 10페이지 금지행동: 욕구(잠·식사·용변), 취미·여가, 생활·관리, 대인관계. 자동 행동에 적용, 직접 지시·등록 일정 유지. 함께 침대를 사용하는 인물의 중복 이름표 제거·공유 카드 가구 아래 배치, 개인 생활 로그 유지. Chrome/WebKit 3언어 선택·스크롤·저장·수면/행동·이름표 검사, 기존 집 시뮬레이션70개·AAB 서명 통과. 9월14일01:09 Play 내부 release285/386 제공 확인. 새 iOS 앱 빌드 없음. EN/JA 신규문구100%, 전체 미측정."});
window.SEORAP_DATA.tasks.push({"id": "dv-public-slots-20260914", "project": "서랍마을", "type": "개선", "section": "release", "subsection": "production", "completed": true, "title": "캐릭터 슬롯 공개 업데이트 · 1개 1,000원 / 5개 4,800원", "summary": "사용자가 명시한 슬롯 공개 범위만 main5ceb0cf에서 반영. Pages built 확인. 결제 API api-00019-ful: 5개 가격4800, 단일/5개 배타 날짜 제한 제거, 기존 슬롯 보존. Google Play 두 활성 상품 가격 확인. Apple 단일 상품 심사 대기 c5de3578-1fd2-45fe-b5a2-c8a37a4d4dd4; 5개 상품 4800원 글로벌 즉시 가격 변경 저장. dev385/386 프로덕션 승격 없음. 실제 결제 미실행."});
window.SEORAP_DATA.updates.unshift({"version": "1.0.334 (386 내부 테스트)", "code": 386, "date": "2026-09-14", "items": ["금지행동 설정을 욕구·취미와 여가·생활과 관리·대인관계로 분류", "잠·식사·용변 자동 행동 각각 끄기 / 직접 지시와 일정 유지", "침대 상호작용 이름표 통합·가구 아래 배치 / 개인 로그 유지", "Android 내부 테스트386 제공 완료 / 공개 앱 승격 없음"]});
window.SEORAP_DATA.copyTemplates.unshift({"id": "internal386-discord", "emoji": "📣", "title": "1.0.334(386) 내부 테스트 패치노트", "question": "385 이후 내부 업데이트 안내", "replies": [{"label": "한국어", "code": "ko", "content": "서랍마을 1.0.334 (386) 내부 테스트 업데이트\n\n이번 업데이트에서 변경된 주요 내용을 안내드립니다.\n\n✨ 새로운 기능\n- 금지행동 설정에 ‘잠을 자지 않음’, ‘밥을 먹지 않음’, ‘용변을 보지 않음’을 추가했습니다. 자동 행동에 적용되며 직접 지시와 등록한 일정은 유지됩니다.\n\n🎨 UI/UX\n- 10페이지 금지행동을 욕구, 취미·여가, 생활·관리, 대인관계로 나눴습니다.\n- 침대에서 함께 상호작용하는 두 캐릭터의 이름과 행동을 한 카드로 표시합니다. 생활 로그는 각각 유지됩니다.\n\n🐛 오류 수정\n- 침대 아래의 중복 이름표와 가구에 가려지는 문구를 수정했습니다.\n- 함께 자는 두 캐릭터에게 대화 연출이 일괄 적용되던 부분을 수정했습니다."}]});

window.SEORAP_DATA.tasks.push({"id": "dv-release387-photo-save", "project": "서랍마을", "type": "오류 수정", "section": "release", "subsection": "testing", "completed": false, "title": "387 준비 · 사진 덮어쓰기 방지·저장/멀티 제보 확인", "summary": "dev c53d2ae: 늦은 사진 복원이 새 편집을 덮지 않도록 수정, 계정·마을 전환 후 사진 적용 차단. 회귀 검사 통과. 저장 한도 이동·복구/계정 분리 Chrome/WebKit 검사 통과. 멀티 참여 오류는 원인별 안내 연결, 제보 원인 확정은 진행 중. 캐릭터·마을5개 묶음 신규 판매 취소, 기존 구매 유지. Play 캐릭터5개 standard 비활성 확인, 마을5개 미생성. Apple/웹 판매 중지와387 빌드·공개배포·Apple 심사 미완료.252 사진 제보 원인/복구 미확정. EN/JA 변경 안내100%, 전체미측정."});
Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==='dv-release387-photo-save'),{title:'1.0.335 (387) · Android 정식 검토 제출 / Apple 로그인 대기',summary:'상점 가격 인상 안내문 제거. 가격 인상은 공지 첫 항목으로 발송(release-387, 마지막 공지351 이후 누적). 저장 한도 조건 실제 잠금 클릭·재실행 Chrome/WebKit 통과, 사진 덮어쓰기 방지 회귀 통과. Android387 서명 검증 후 전체 출시 검토 접수, 아직 공개 완료 아님. iOS387 서명/업로드 성공(run34787923433), 심사 제출·Apple5개 판매중지는 로그인 대기. Google5개 비활성, 웹 신규5개 주문 차단 배포. 기존 구매 보존. dev a3da373 / main10043f9. EN/JA 변경분100%, 전체미측정.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.335 (387 정식 검토 제출)',code:387,date:'2026-09-14',items:['캐릭터 슬롯1개1000원 / 5개 묶음 신규 판매 종료·기존 구매 유지','상점 가격 인상 안내문 제거 / 가격 변경은 인게임 공지 첫 항목으로 안내','저장 한도 시 실제 잠금 저장·재실행 검증 통과, 늦은 사진 복원의 덮어쓰기 방지','Android 정식 출시 검토 접수 / iOS 업로드 완료·로그인 후 심사 제출 필요','공지 release-387 발송·재조회 확인 / 마지막 공지351부터 누적']});
window.SEORAP_DATA.copyTemplates.unshift({"question":"공지 release-387 / 마지막 발송351 이후 누적","emoji":"📣","id":"public387-notice","replies":[{"content":"# 서랍마을 1.0.335 (387) 업데이트\n\n## 공개 공지 (마지막 공지의 351 이후 누적)\n\n**캐릭터 슬롯 가격 및 판매 구성 변경**\n캐릭터 슬롯은 1개 1,000원으로 판매합니다. 캐릭터·마을 5개 묶음 판매는 종료하며, 마을 슬롯은 기존대로 1개 1,900원입니다. 이미 구매한 슬롯은 그대로 유지됩니다. 최종 결제 금액은 각 스토어 결제창에서 확인해 주세요.\n\n- 저장 영역 한도로 캐릭터 설정·잠금 및 우편 답변을 저장하지 못하던 상황의 저장 처리를 개선했습니다. 큰 저장본을 별도 기기 저장소에 보관하고 저장 내용 검증과 복구 사본을 유지합니다.\n- 늦게 완료된 사진 복원이 새로 바꾼 사진을 덮지 않도록 수정했습니다. 사진 선택 도중 계정·마을이 바뀌면 잘못된 대상에 적용되지 않습니다. 이미 잘못 저장된 사진을 자동 복원하는 기능은 아닙니다.\n- 우편의 아이돌·밴드, 취미 선물을 다시 선택할 수 있습니다. 다른 이용자에게 보내는 선물은 계정당 하루 1개이며, 내 캐릭터끼리는 제한하지 않습니다. 받은 선물을 수락하면 개인 사전 한 칸을 사용하고 보낸 사람의 이름표가 붙습니다.\n- 10페이지 금지행동을 욕구·취미와 여가·생활과 관리·대인관계로 분류했습니다. 자동 수면·식사·용변을 각각 제한할 수 있으며 직접 지시와 등록 일정은 유지됩니다.\n- 침대에서 함께 상호작용하는 인물의 중복 이름표를 정리했습니다. 개인 생활 로그는 각각 유지됩니다.\n- 멀티 참여·프로필 저장 실패 시 원인에 맞는 안내를 표시합니다.\n\n### 앞선 업데이트의 누적 개선\n\n• 저장·백업과 화면 이동의 안정성을 개선했습니다. 저장 실패 안내를 구분하고, 질문 답변과 사진이 많은 캐릭터의 저장 처리를 다듬었습니다.\r\n• 프로필, 사진 배치, 일정과 선택창의 스크롤·겹침을 수정했습니다. iOS의 프로필 PNG·PDF 내보내기는 공유 시트로 연결했습니다.\r\n• 집 공유 코드를 빈집에도 적용할 수 있도록 개선했습니다. 가구를 방 사이로 옮기는 조작, 이동 중 크기, 겹친 가구 선택, 식탁에 붙인 의자의 이동·방향을 다듬었습니다.\r\n• 두 사람이 소파를 이용하고 낮잠·독서·영상·음악 감상 등을 선택할 수 있습니다. 의자·소파 착석과 식사·음료 연출을 개선하고, 가구 사용 중 이름과 행동을 가구 아래에 표시합니다.\r\n• 캐릭터 상호작용과 성격·관계에 따른 반응을 다양하게 했습니다. 캐릭터를 누르면 현재 행동을 확인하고 할 일을 고를 수 있습니다.\r\n• 생활 로그를 최신순·오래된순으로 정렬하고, 여러 인물을 가로로 볼 수 있습니다. 멀티의 미래 기록 표시를 수정했습니다.\r\n• 건물 위 주민 표시, 침대 앞뒤 표시, 반려동물 이동 초기화, 샤워 장소, 생일의 마을 이동 제한과 평온한 행동의 번개 효과를 수정했습니다.\r\n• 건강 기록과 일부 생활·관계 배경 설정, 도움말을 보완했습니다. 우편에 선물을 고를 때 발신자가 바뀌는 문제도 수정했습니다.\r\n• 응원자 명단과 글자 가독성을 개선했습니다. 설정의 ‘함께 만든 서랍마을’ 아래 ‘익명 문의’에서 의견과 오류를 보내실 수 있습니다. 질문 선택지에도 구체적인 의견을 남길 수 있습니다.\n\n## Play 출시 노트\n<ko-KR>\n캐릭터 슬롯 가격을 1개 1,000원으로 변경하고 5개 묶음 판매를 종료합니다. 마을은 1개 1,900원이며 기존 구매 슬롯은 유지됩니다.\n저장 한도 때문에 설정·잠금·우편 답변을 저장하지 못하던 상황의 처리를 개선했습니다. 늦은 사진 복원이 새 사진을 덮지 않도록 수정했습니다.\n아이돌·취미 선물과 수락 기능, 보낸 사람 이름표를 반영했습니다. 금지행동을 유형별로 나누고 자동 수면·식사·용변 제한을 추가했습니다. 침대의 중복 이름표와 멀티 오류 안내를 정리했습니다.\n</ko-KR>\n<en-US>\nCharacter slots now cost KRW 1,000 each. Five-slot packs are discontinued; town slots remain KRW 1,900 each. Purchased slots are retained.\nImproved saving settings, locks and letter replies at storage limits. Prevented delayed photo restoration from overwriting newer images.\nRestored idol/hobby gifts, added gift acceptance and sender labels. Grouped activity restrictions with automatic sleep, meal and toilet options. Fixed duplicate bed labels and clarified multiplayer errors.\n</en-US>\n<ja-JP>\nキャラクター枠を1個1,000ウォンに変更し、5個セットの販売を終了します。村枠は1個1,900ウォンです。購入済みの枠は維持されます。\n保存上限で設定・固定・手紙の回答を保存できない場合の処理を改善。遅れて完了した写真復元が新しい写真を上書きしないよう修正しました。\nアイドル・趣味の贈り物、受取確認、贈り主の名前を反映。禁止行動を分類し、自動睡眠・食事・トイレの制限を追加。ベッドの重複ラベルとマルチのエラー案内を改善しました。\n</ja-JP>\n\n## 検証 / Verification\n- Actual discovery lock click under injected snapshot QuotaExceededError: Chrome and WebKit, saved lock survives reload.\n- Existing snapshot migration, recovery-copy preservation, failed writes and account-isolation tests passed; photo restore/world-switch regressions passed.\n- Not verified on the reporter's physical device; build252 original photo corruption remains unconfirmed.\n- Announcement to be sent only after release submission status is known. No claim of rollout completion yet.\r\n","code":"ko","label":"한국어 및 스토어 3개 언어"}],"title":"1.0.335(387) 공개 업데이트 안내"});
Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==='dv-release387-photo-save'),{completed:true,title:'1.0.335 (387) · Android·Apple 정식 심사 제출 완료',summary:'Android387 정식 검토 접수. Apple387 심사 대기 확인(385f23b0-eb50-4554-8884-35752d34a4e9), 이전382 회수·승인 후 자동 출시 유지. Apple5개 묶음 개발자 판매중단 저장 완료. 상점 가격인상 안내 제거, 공지 release-387 발송. 저장한도 실제 잠금·재실행 Chrome/WebKit 통과; 제보자 실기기와252 사진 원인/복구는 미확인. dev a25ffb2 / 공개main10043f9. KO/EN 스토어 안내 반영, JA 번역 준비100%(일본어 스토어 미개설).'});
window.SEORAP_DATA.updates.unshift({version:'1.0.335 (387 Apple 심사 대기)',code:387,date:'2026-09-14',items:['Apple387 심사 제출 접수·심사 대기 확인 / 승인 후 자동 출시','이전382 심사 회수 후 최신 저장·사진 수정 빌드로 교체','Apple 캐릭터5개 묶음 신규 판매중단 저장 완료','앱 공개 승인 완료 상태와 구분하여 기록']});
window.SEORAP_DATA.tasks.push({id:'dv-apple-worldwide387',project:'서랍마을',type:'배포 설정',section:'release',subsection:'production',completed:true,title:'App Store 전 세계 제공 설정 · 앱/캐릭터1개',summary:'사용자 승인 후 앱175개 전체 및 향후국가 선택 저장. 기존3개 사용가능+171개 처리중, 아프가니스탄1개는 콘텐츠등급상 Apple판매불가. 반영최대24시간. 캐릭터1개 상품6811144000은 이미175개전체+향후지역 선택 확인, 심사대기. 가격·콘텐츠등급 변경없음. 기록dev649606c.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.335 (387 전 세계 제공 설정)',code:387,date:'2026-09-14',items:['앱 다운로드 지역을 전체로 확대·향후 국가 자동포함','기존3개 외171개 반영처리중 / 아프가니스탄은 Apple 등급제한','캐릭터1개 상품은175개전체 판매설정 확인·심사승인 대기']});
window.SEORAP_DATA.tasks.push({id:'dv-life388',project:'서랍마을',type:'개발',section:'release',subsection:'testing',completed:true,title:'1.0.336 (388) 개발 · 욕구·관계 고정·집 상황표',summary:'전체설정10페이지에 수면·허기·용변·청결·사교 충족도와 욕구 고정, 관계/점수 고정3종 추가. 미선택 취미의 자동주제·동거인 취미 탐색 경로 수정. 선택됨 아래 사용/전체 슬롯. 가구 앞 상황표·화면경계·북쪽 의자 보정. 같은 가구 만남의 공동표시/개별로그. Chrome/WebKit 한영일 저장·재접속·관계고정·상황표 검증, 생활시뮬70검사·Android자산·웹준비 통과. 신규영일문구100%, 전체번역률미측정. 네이티브빌드·스토어/사이트배포 없음. iOS네이티브 검사는 격리폴더의 설정파일 부재로 미완료.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.336 (388 개발 준비)',code:388,date:'2026-09-14',items:['선택됨 아래 사용/전체 슬롯 표시','미선택 취미가 자동행동에 섞이는 경로 수정','상황표를 가구보다 앞에·화면 안에 표시, 북쪽 의자 위치 조정','같은 가구 만남의 공동 상황표와 개인별 로그','욕구5종 충족도·욕구 고정·관계 점수/관계 고정3종','dev 개발 완료·스토어와 사이트 미배포 / 영어·일본어 신규문구100%']});

window.SEORAP_DATA.documents.push({"id":"dv-life388-notes","project":"서랍마을","section":"release","subsection":"testing","title":"1.0.336 (388) 개발 준비 · 한영일 출시노트","description":"개발 코드와 자산 검증 완료. 앱 빌드·스토어/사이트 배포 전입니다.","content":"<ko-KR>\n선택됨 아래에 사용 중인 캐릭터 슬롯/전체 슬롯을 표시해요.\n설정과 무관한 취미가 자동 행동에 섞이던 경로를 수정했어요. 이름상황표가 가구 뒤에 숨거나 화면 밖으로 나가지 않도록 정리하고 북쪽 의자 위치를 조정했어요.\n같은 가구에 앉아 있는 캐릭터의 공동 상황표와 개인별 상호작용 로그를 연결했어요.\n전체설정 10페이지에 수면·허기·용변·청결·사교 충족도, 욕구 고정, 관계 점수와 관계 변화 3가지 설정을 추가했어요.\n</ko-KR>\n<en-US>\nCharacter slots now show used/total below Selected. Fixed unrelated hobbies entering automatic activities. Status cards appear in front of furniture and stay on screen; north-facing table seating is adjusted. Characters sharing furniture can interact, with a shared status card and individual logs. Full settings page 10 adds five need meters, Freeze needs, and three modes for relationship and score changes.\n</en-US>\n<ja-JP>\n選択中の下に使用枠数/合計枠数を表示します。設定と無関係な趣味が自発行動に混ざる経路を修正しました。名前と行動の表示を家具より手前に保ち、画面外へのはみ出しと北側の椅子の位置を調整しました。同じ家具に座る人物の交流を共通表示と個別ログに反映します。全体設定10ページに5つの欲求充足度、欲求固定、関係とスコアの変化を選ぶ3つのモードを追加しました。\n</ja-JP>\n"});
window.SEORAP_DATA.copyTemplates.unshift({"id":"dv-life388-status","emoji":"🛠️","title":"388 수정 상태 안내 · 배포 전","question":"설정하지 않은 취미와 가구 상황표, 욕구 기능은 수정됐나요?","replies":[{"label":"한국어","code":"ko","content":"설정과 무관한 취미가 자동 행동에 섞이는 경로와 가구 상황표 위치를 개발판에서 수정했습니다. 슬롯 사용량 표시, 같은 가구의 공동 상황표·개별 로그, 욕구5종과 욕구·관계 고정 설정을 추가했습니다. 1.0.336(388)은 아직 앱스토어와 사이트에 배포되지 않았습니다. 현재 설치된 버전에는 자동 적용되지 않습니다."}]});

Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==='dv-life388'),{summary:window.SEORAP_DATA.tasks.find(t=>t.id==='dv-life388').summary+' 게임 dev 커밋 f196aaf 반영 완료.'});

window.SEORAP_DATA.tasks.push({"id":"dv-occupant389","project":"서랍마을","type":"개발","section":"release","subsection":"testing","completed":true,"title":"1.0.337 (389) 내부 테스트 제공 · 욕구·관계 팝업·왕관","summary":"2026-09-14 15:03 Play 내부 테스터 제공 확인(release286). 자기 캐릭터 클릭: 욕구5종. 상대 클릭: 관계5축과 가구형 상호작용 바로 선택. 왕관으로 기준 전환. 친밀도·애정도·신뢰·편안함·갈등도 활동별 변화와 고정. 388 가구 상황표·슬롯·취미 수정 포함. Chromium/WebKit 한영일·직접대화·왕관·관계고정·수동수정 검증, 생활70검사, 서명 및366자산일치 통과. 게임dev d21fab4. 신규EN/JA100%, 전체미측정. 앞으로 수정은 내부테스트 제공 확인까지. 프로덕션과 iOS·사이트 신규배포 없음."});
window.SEORAP_DATA.updates.unshift({"version":"1.0.337 (389 내부 테스트 제공)","code":389,"date":"2026-09-14","items":["자기 캐릭터는 욕구5종 / 상대 캐릭터는 관계수치와 바로 상호작용","왕관 버튼으로 기준 캐릭터 변경","친밀도·애정도·신뢰·편안함·갈등도의 활동별 변화와 고정","388 슬롯사용량·취미자동행동·가구상황표·같은가구만남 수정 포함","Google Play 내부테스터 제공 확인 15:03 / 신규영어·일본어100%"]});
window.SEORAP_DATA.documents.push({"id":"dv-occupant389-notes","project":"서랍마을","section":"release","subsection":"testing","title":"1.0.337 (389) 내부 테스트 · 한영일 출시노트","description":"내부 테스터 제공 완료(2026-09-14 15:03). 각 언어500자이내.","content":"<ko-KR>\n기준 캐릭터를 누르면 수면·허기·용변·청결·사교를 확인하고, 상대를 누르면 관계 수치와 상호작용을 바로 선택해요. 왕관으로 기준 캐릭터를 바꿀 수 있어요.\n친밀도·애정도·신뢰·편안함·갈등도가 활동에 따라 달라져요. 전체설정에서 욕구와 관계 변화를 고정할 수 있어요.\n슬롯 사용량을 선택됨 아래에 표시하고, 가구 상황표의 가림·화면 밖 표시와 북쪽 의자 위치를 수정했어요. 같은 가구에 있는 캐릭터의 공동 상황표와 개인 로그를 연결했어요.\n설정하지 않은 취미가 자동 행동에 섞이는 경로와 저장·사진 복원 안정성을 개선했어요.\n</ko-KR>\n<en-US>\nTap your viewpoint character for five needs, or another for relationship meters and interactions. Switch viewpoint with the crown. Closeness, affection, trust, comfort and tension respond to activities. Freeze needs or relationship changes in settings. See used/total slots below Selected. Fixed furniture status overlap, off-screen cards and north seats. Shared furniture encounters have joint cards and individual logs. Fixed unrelated hobbies; improved saving and photo restoration.\n</en-US>\n<ja-JP>\n基準キャラクターを押すと睡眠・空腹・トイレ・清潔・社交を確認でき、相手を押すと関係の数値と交流を選べます。王冠で基準を切り替えられます。\n親密度・愛情度・信頼・安心感・葛藤度が行動に応じて変わります。全体設定で欲求や関係の変化を固定できます。\n選択中の下に使用枠数/合計枠数を表示します。家具による表示の隠れ、画面外へのはみ出し、北側の椅子の位置を修正しました。同じ家具にいる人物の共通表示と個別ログを連携しました。\n未設定の趣味が自発行動に混ざる経路を修正し、保存と写真復元の安定性を改善しました。\n</ja-JP>"});
window.SEORAP_DATA.copyTemplates.unshift({"id":"dv-occupant389-status","emoji":"👑","title":"389 내부 테스트 · 욕구와 캐릭터 팝업","question":"욕구·관계와 캐릭터 클릭 화면이 어떻게 바뀌었나요?","replies":[{"label":"한국어","code":"ko","content":"1.0.337(389)을 내부 테스트에 올렸습니다. 자기 캐릭터를 누르면 욕구5종이, 상대를 누르면 관계수치와 상호작용 버튼이 나옵니다. 왕관으로 기준 캐릭터를 바꿀 수 있습니다. 관계는 친밀도·애정도·신뢰·편안함·갈등도로 나누었고 전체설정에서 욕구와 관계의 변화를 고정할 수 있습니다. 이전388의 가구상황표·슬롯사용량·취미자동행동 수정도 포함했습니다."}]});

window.SEORAP_DATA.tasks.push({"id": "dv-mail390", "project": "서랍마을", "type": "개발", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.338 (390) 내부 테스트 제공 · 질문 저장·이름표·관계 편지", "summary": "2026-09-14 17:36 Play 내부 테스터 제공 확인(release287). 고정 성향 질문의 잘못된 저장 실패 수정. 이름표의 상대위치 스타일 충돌과 다른 캐릭터 가림 수정. 관계 자동 확정 대신 우편 선택. 프로필 강조, 응원자 7명 복원·신규 반영. 지역 말투와 하오체·풍류 선비·재상 선비 구분. 새 5말투 570문구 한영일 및 PDF 51쪽. Chromium/WebKit 회귀·369자산 AAB일치·서명 통과. 게임 dev 265296e. 새 범위 영어/일본어100%, 전체미측정."});
window.SEORAP_DATA.updates.unshift({"version": "1.0.338 (390 내부 테스트 제공)", "code": 390, "date": "2026-09-14", "items": ["질문 답변 시 성향 고정으로 저장 실패가 뜨던 오류 수정", "이름표가 주변 캐릭터와 다른 이름표를 피하도록 위치 계산 개선", "관계 변화는 우편 제안 후 수락·나중에·유지하기로 선택", "캐릭터 프로필 강조 / 전체설정 선택 안내", "응원자 명단 7명 복원 및 새 신청 반영", "경상도·전라도·하오체·풍류 선비체·재상 선비체 한영일 570문구 및 PDF", "Play 내부 테스터 제공 17:36 확인"]});
window.SEORAP_DATA.documents.push({"id": "dv-mail390-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.338 (390) 내부 테스트 · 한영일 출시 노트", "description": "2026-09-14 17:36 제공 완료. 직전 내부389 대비 변경. 비공개 트랙 배포가 아님.", "content": "<ko-KR>\n캐릭터 질문 답변 시 성향 고정 때문에 저장 실패가 나오던 오류를 수정했어요.\n이름상황표가 다른 캐릭터와 이름표를 피하도록 배치하고, 위치 계산에 간섭하던 스타일을 수정했어요.\n관계는 자동 확정 대신 우편으로 제안하며 수락·나중에·유지하기를 선택해요.\n캐릭터 프로필을 더 강조하고 전체설정은 선택 사항으로 안내해요.\n응원자 명단을 복원하고 새 신청자를 반영했어요. 불필요한 상품 문구를 정리했어요.\n경상도·전라도 말투를 다듬고 하오체·풍류 선비체·재상 선비체를 구분했어요. 영어·일본어 문구도 함께 적용했어요.\n</ko-KR>\n<en-US>\nFixed question saving when affected traits are locked. Name cards now avoid nearby characters and cards; corrected conflicting positioning styles. Relationship changes arrive as letters: accept, later, or keep things as they are. Highlighted Character Profile and clarified optional detailed settings. Restored supporter credits and added new names. Refined regional voices and added distinct classical, scholar and statesman voices, with English and Japanese text. Simplified shop wording.\n</en-US>\n<ja-JP>\n性格の固定により質問の回答が保存できない不具合を修正しました。名前表示が周囲の人物や表示を避けるよう配置し、位置計算に干渉するスタイルを修正しました。\n関係の変化は自動確定せず、手紙で提案します。承諾・後で・今のままを選べます。\nキャラクタープロフィールを強調し、詳細設定は任意と案内します。応援者の名前を復元し、新しい申請を反映しました。\n地域の口調を調整し、古風な丁寧口調・風流な文人・思慮深い宰相を区別しました。英語・日本語も対応しています。商品説明の不要な文を整理しました。\n</ja-JP>"});
window.SEORAP_DATA.copyTemplates.unshift({"id": "dv-question390", "emoji": "✉️", "title": "390 질문 저장 오류 수정", "question": "캐릭터 질문을 선택할 때마다 저장하지 못했다고 나와요.", "replies": [{"label": "한국어", "code": "ko", "content": "불편을 드려 죄송합니다. 답변에 해당하는 성향이 고정되어 있을 때 정상 선택을 저장 실패로 처리하던 오류를 수정했습니다. 고정된 성향은 그대로 유지되고 질문 답변 기록이 저장됩니다. 수정본 1.0.338(390)은 현재 내부 테스트에 반영했습니다."}]});

window.SEORAP_DATA.tasks.push({"id": "dv-voices391", "project": "서랍마을", "type": "개발", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.339 (391) 내부 테스트 제공 · 말투 순화·공동 상황표", "summary": "2026-09-14 18:16 내부 테스터 제공 확인(release288). 하오체/하게체, 오사카·히로시마 / 스코틀랜드·미국남부 말투 현지화. 판교어·귀여니체 선택 표기 제외. 욕설은 가림표 대신 젠장·망할 수준으로 순화하고 이전 캐릭터 편지에도 적용. 상호작용 중 가구 메뉴가 열리던 클릭 경로 수정. 같은 좌석·탁자·소파 상황표 공동 표시와 각자 로그 유지. 앉은 캐릭터 약10~15% 확대. 공지 사용자사진 제거, 관계탭 마을 선택 정리. Chromium/WebKit 회귀, Android서명/370파일일치 통과. 게임dev bde4cdb. 변경범위 EN/JA100%, 대사4종456문구 PDF41쪽."});
window.SEORAP_DATA.updates.unshift({"version": "1.0.339 (391 내부 테스트 제공)", "code": 391, "date": "2026-09-14", "items": ["하오체/하게체로 정리 · 언어별 지역 말투 이름과 문구 현지화", "거친 말투를 젠장·망할 같은 표현으로 순화 · 이전 캐릭터 편지도 반영", "상호작용 중 캐릭터 클릭 시 가구 메뉴가 열리던 오류 수정", "같은 좌석·탁자·소파 상황표 공동 표시 · 개인 행동 로그 유지", "의자·소파 캐릭터 크기 소폭 확대", "공지 사용자사진 제거 · 관계탭 마을 선택 UI 개선", "Play 내부 테스터 제공 18:16 확인 · 한영일 대사PDF41쪽"]});
window.SEORAP_DATA.documents.push({"id": "dv-voices391-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.339 (391) 내부 테스트 · 한영일 출시 노트", "description": "2026-09-14 18:16 제공 완료. 직전 내부390 대비. 각 언어500자 이내.", "content": "<ko-KR>\n말투를 하오체·하게체로 정리하고 판교어·귀여니체 표기를 선택 목록에서 제외했어요. 지역 말투는 영어의 스코틀랜드·미국 남부, 일본어의 오사카·히로시마 말투로 현지화했어요.\n거친 대사는 젠장·망할 같은 표현으로 순화했어요. 이전 캐릭터 편지도 순화해 표시해요.\n상호작용 중 캐릭터를 다시 눌렀을 때 가구 메뉴가 뜨던 오류를 수정했어요.\n같은 좌석·탁자·소파의 상황표는 함께 표시하고, 개인 로그는 각자의 행동을 유지해요. 앉은 캐릭터를 조금 키웠어요.\n업데이트 공지에 사용자 사진이 나오지 않도록 수정하고 관계탭의 마을 선택창을 정리했어요.\n</ko-KR>\n<en-US>\nUpdated classical voices and removed startup/internet-novel labels. Regional voices use Scottish and Southern US English, or Osaka and Hiroshima Japanese. Softened coarse dialogue and older character mail. Fixed character taps opening furniture menus during interactions. Shared seating has one status card; personal logs retain individual activities. Seated characters are larger. Removed user photos from update notices and refined the village selector.\n</en-US>\n<ja-JP>\n古風な丁寧口調と語り口を整理し、スタートアップ語・ネット小説風の名称を選択肢から外しました。地域の口調は日本語では大阪弁・広島弁、英語ではスコットランド・米国南部の表現にしました。\n荒い台詞を穏やかな表現に調整し、過去のキャラクターの手紙にも適用します。\n交流中の人物を押すと家具メニューが開く不具合を修正しました。同じ座席・テーブル・ソファでは状況をまとめて表示し、個別ログは各自の行動を保ちます。座った人物を少し大きくしました。\n更新のお知らせに利用者の写真が出ないよう修正し、関係画面の村選択を整えました。\n</ja-JP>"});

window.SEORAP_DATA.tasks.push({"id": "dv-production391", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.339 (391) 프로덕션 전체 출시 심사 요청", "summary": "9월 14일 18:40 검토 중인 변경사항 확인. 자동 검사 진행 중이며 통과 후 심사 전송; 일반 사용자 제공 완료 아님. 기존 프로덕션387 대비 욕구5종·욕구창·왕관·관계5수치·관계우편·고정설정, 공동상황표/개인로그, 질문저장·이름표·클릭 오류 및 말투 순화 누적 반영. 100% 전체 국가, 지원기기 감소 없음. 기존 서명된391 AAB 승급. 변경범위 영어/일본어100%; 게임dev, 작업판main."});
window.SEORAP_DATA.updates.unshift({"version": "1.0.339 (391 프로덕션 심사 요청)", "code": 391, "date": "2026-09-14", "items": ["기존 프로덕션387 대비 내부388~391 누적 업데이트", "욕구5종·캐릭터 욕구창·왕관으로 기준 전환", "관계5수치·우편으로 관계 결정·욕구/관계 고정", "공동 상황표/개인 로그·이름표/질문저장/클릭 오류 수정", "말투 현지화·강한 표현 순화·공지사진/프로필/슬롯 개선", "18:40 심사 요청 접수 · 자동 검사 진행 · 일반 사용자 제공 대기"]});
window.SEORAP_DATA.documents.push({"id": "dv-production391-announcement", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.339 프로덕션 · 387 대비 누적 업데이트 안내", "description": "욕구·관계 기능 중심. 391 심사 요청 접수, 아직 일반 사용자 제공 확인 전.", "content": "# 서랍마을 1.0.339 업데이트\n\n이번 업데이트는 이전 프로덕션 1.0.335(387) 이후의 변경사항을 모두 포함합니다.\n\n## ✨ 욕구 5종과 캐릭터 상호작용\n- 수면·허기·용변·청결·사교의 충족도를 확인할 수 있어요. 시간과 생활 행동에 따라 수치가 달라집니다.\n- 기준 캐릭터를 누르면 최근 로그 대신 현재 욕구가 나타나요. 100에 가까울수록 충족된 상태예요.\n- 전체설정에서 욕구를 현재 값으로 고정할 수 있어요.\n- 다른 캐릭터를 누르면 두 사람의 관계 수치와 상호작용을 바로 선택할 수 있어요. 왕관 버튼으로 기준 캐릭터를 바꿔 보세요.\n\n## 💌 관계와 함께하는 생활\n- 친밀도·애정도·신뢰·편안함·갈등도가 행동에 따라 달라져요.\n- 관계는 자동 확정되지 않고 우편으로 제안돼요. 수락하거나 나중에 답하거나 현재 관계를 유지할 수 있어요.\n- 점수와 관계 모두 고정 / 점수만 변화 / 점수 변화와 우편으로 관계 결정 중에서 선택할 수 있어요.\n- 같은 좌석·탁자·소파에 있으면 집의 상황표를 함께 표시해요. 각자의 개인 로그는 개별 행동을 유지합니다.\n\n## 🎨 보기 편해진 화면\n- 이름상황표의 가구 뒤 가림과 화면 밖 표시를 개선하고 주변 캐릭터와 이름표를 피하도록 배치해요.\n- 침대 그림에 더 가깝게 상황표를 배치하고 북쪽 의자 위치를 조정했어요. 앉은 캐릭터 크기도 조금 키웠어요.\n- 사용한 슬롯/전체 슬롯을 ‘선택됨’ 아래에 표시해요.\n- 캐릭터 프로필을 강조하고 전체설정은 선택 사항으로 안내해요. 관계탭의 마을 선택창도 정리했어요.\n\n## 🐛 오류 수정과 대사 정리\n- 성향을 고정했을 때 질문 답변이 저장 실패로 처리되던 오류를 수정했어요.\n- 상호작용 중 캐릭터를 다시 누르면 가구 메뉴가 열리던 오류를 수정했어요.\n- 설정하지 않은 취미가 자동 행동에 섞이던 경로를 수정했어요.\n- 응원자 명단의 누락을 복원하고 신규 신청자를 반영했어요. 업데이트 공지에 사용자 사진이 나오던 문제를 수정했어요.\n- 하오체·하게체를 구분하고 지역 말투를 언어에 맞게 다듬었어요. 일본어는 오사카·히로시마, 영어는 스코틀랜드·미국 남부 표현을 사용해요.\n- 강한 욕설은 젠장·망할 같은 표현으로 순화했어요. 이전 캐릭터 편지에도 적용돼요.\n\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-save-audit391", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.339 (391) 욕구 알고리즘 개발 전 저장 안정성 점검", "summary": "noise 8개 선택지·5캐릭터 욕구값/관계정책·실패시 답변 롤백·기존 저장본 보존·재시도·pagehide 저장을 Chromium/WebKit에서 검증. 계정격리/비동기 충돌/용량복구/관계우편 검사 통과. 추가 앱 결함 발견 없음. 낡은 검사2개 보완, 회귀검사 추가. 앱 코드·버전·번역 변경 없음, 새 배포 없음. 실제 신고 계정/실기기 강제종료/운영 클라우드 왕복은 미검증."});
window.SEORAP_DATA.documents.push({"id": "dv-save-audit391-report", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "391 저장 점검 결과와 검증 범위", "description": "욕구 알고리즘 확장 전 저장 점검. 신규 버전 배포 아님.", "content": "# 391 저장 안정성 점검 — 2026-09-14\n\n기준: dev 082487e, Android 1.0.339 / versionCode 391. 앱 실행 코드 변경 없음. 테스트와 기록만 변경하므로 신규 빌드·업로드·버전 증가는 하지 않음.\n\n## 결과\n- 신고된 noise 질문: 모든 8개 선택지를 성향 고정 상태에서 답변하고 매번 다시 불러오기. 답변 이력 저장, 고정 성향 유지. Chromium/WebKit 통과.\n- 캐릭터 5명 각각 다른 욕구5종 값과 관계 정책을 저장하고 다시 불러오기. 값·고정 설정·관계 정책 모두 유지.\n- 질문 임시 기록 저장 실패를 주입: 실패 전달, 답변 변경 롤백. 정상화 후 재시도 가능.\n- 전체 저장 실패를 주입: false 반환, 이전 영구 저장본과 현재 화면의 수정 내용 보존. 저장 재시도 후 재실행 복원.\n- 자동 저장 대기 중 pagehide: 종료 직전 변경이 실제 저장소에 즉시 기록되는지 확인.\n- 저장 도중 새 수정, 계정 전환/왕복, 삭제: 오래된 비동기 결과가 최신 저장이나 다른 계정을 덮지 않음.\n- 저장 한도: 압축 및 IndexedDB 이동, 복구본 보존, 실패한 교체 롤백, 계정 격리, 손상 복구본 보존 통과.\n- 관계 수치·관계 우편·욕구 고정 UI 저장 및 다시 불러오기 통과.\n- 명시 저장 실패 안내: 한국어/영어/일본어 모두 실패를 성공으로 처리하지 않음.\n\n## 검사 보완\n- check-save-read311: 현재 명시 저장 함수가 사용하는 saveFailureMessage를 검사 실행 환경에 주입.\n- check-restore-storage: 현재 기본 데이터가 증가해 낡은 30KB 성공 시나리오 예산을 초과함. 성공 복구 시나리오 예산을 200KB로 변경. 앞부분의 엄격한 용량 제한/압축/보존 검사는 유지.\n- 신규 qa-save391: 실제 브라우저와 실제 상태/질문 저장 모듈을 사용하는 실패 주입 및 재실행 검사. 초기 기본값/잠금 메타데이터 정규화 후 기준을 잡아 답변 변화만 비교.\n\n## 실행한 검사\ncheck-input-save361, check-save-read311, check-save-pricing-dev, check-restore-storage, check-account-isolation, check-cloud-character-merge, check-forward-schema-recovery, check-answer-journal345, check-snapshot370, qa-snapshot385(Chromium), qa-mail390(Chromium/WebKit), qa-life388(WebKit), qa-save391(Chromium/WebKit).\n\n## 확인 범위와 한계\n이 범위에서 추가 앱 결함을 발견하지 못했다. 모든 기기와 모든 실패 상황이 해결됐다는 보증은 아니다. 테스트용 데이터만 사용했고 외부 네트워크를 차단했다. 실제 신고 계정 데이터, Android 실기기 강제 종료/저장장치 장애, 운영 Firebase의 인증된 저장 왕복은 이번 검사에 포함하지 않았다. 클라우드 병합·계정 경계는 모의 응답으로 검증했다. pagehide는 브라우저 생명주기 이벤트 검사이며 OS 강제 종료와 동일하지 않다.\n\n앱/사이트/iOS 공통 실행 코드와 번역 문구는 변경 없음. 기존 391 변경 범위 영어·일본어 100% 유지(앱 전체 번역률을 의미하지 않음).\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-interaction392", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.340 (392) 내부 테스트 · 대화 주제/포옹 성격/공유코드", "summary": "9월14일20:31 내부테스터 제공 확인(release289). 일상대화18주제·양쪽 주제/상대이름 연결. 냉정/과묵한 성격의 포옹 절제, 거절유지. 말끊기 항의 등 직접행동 상대아이콘, 기존 해당로그도 고유이름으로 복원. 공유코드 저장완료 대기·실패롤백·슬롯부족/코드문자 안내. Chromium/WebKit·저장회귀·사진/옷장/코드서비스 검사통과, AAB372파일일치/서명검증. 실제 신고코드/운영요청은 미재현. 게임dev2646b9e, 작업판main. 변경범위영어/일본어100%. iOS실기기/서명배포 없음."});
window.SEORAP_DATA.updates.unshift({"version": "1.0.340 (392 내부 테스트 제공)", "code": 392, "date": "2026-09-14", "items": ["대화18주제 추가 · 양쪽 제목/로그의 공통주제 연결", "냉정·과묵한 캐릭터의 포옹 표현 절제", "직접행동 상대아이콘 연결 · 기존 말끊기 항의 로그 복원", "공유코드 저장 완료 확인·실패한 불러오기 정리·슬롯/입력문자 안내", "20:31 내부테스터 제공 · 변경범위 영어/일본어100%"]});
window.SEORAP_DATA.documents.push({"id": "dv-internal392-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.340 (392) 내부 테스트 · 한영일 출시 노트", "description": "9월14일20:31 내부테스터 제공 확인(release289). 일상대화18주제·양쪽 주제/상대이름 연결. 냉정/과묵한 성격의 포옹 절제, 거절유지. 말끊기 항의 등 직접행동 상대아이콘, 기존 해당로그도 고유이름으로 복원. 공유코드 저장완료 대기·실패롤백·슬롯부족/코드문자 안내. Chromium/WebKit·저장회귀·사진/옷장/코드서비스 검사통과, AAB372파일일치/서명검증. 실제 신고코드/운영요청은 미재현. 게임dev2646b9e, 작업판main. 변경범위영어/일본어100%. iOS실기기/서명배포 없음.", "content": "<ko-KR>\n대화 주제 18종을 추가하고, 두 캐릭터의 제목과 로그가 같은 주제로 이어지도록 다듬었어요.\n냉정하고 과묵한 캐릭터의 포옹은 들뜬 웃음 대신 절제된 행동으로 표현해요.\n말을 끊지 말라고 따지는 등 상대에게 직접 하는 행동에 상대 정보를 연결해 로그에 아이콘을 표시해요.\n공유코드 불러오기는 저장 완료 후 성공을 안내하며, 실패한 불러오기가 캐릭터를 남기지 않도록 수정했어요. 슬롯 부족 안내와 복사한 코드 인식도 개선했어요.\n</ko-KR>\n<en-US>\nAdded 18 conversation topics, with matching subjects in both characters’ titles and logs.\nReserved characters now hug with restrained gestures instead of an excited smile.\nDirect actions such as confronting someone about interruptions now link the other character’s icon in the log.\nSharing-code imports now wait for saving to finish and remove unfinished imports after failure. Improved slot-limit messages and pasted-code recognition.\n</en-US>\n<ja-JP>\n会話の話題を18種類追加し、二人のタイトルとログが同じ話題につながるようにしました。\n冷静で寡黙な人物の抱擁は、はしゃいだ笑顔ではなく控えめな仕草で表現します。\n話を遮らないよう注意するなど、相手に直接働きかける行動のログに相手のアイコンを表示します。\n共有コードの読み込みは保存完了後に成功を案内し、失敗した人物が残らないよう修正しました。空き枠の案内と貼り付けたコードの認識も改善しました。\n</ja-JP>\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-ios-public391", "project": "서랍마을", "section": "release", "subsection": "production", "completed": true, "title": "iOS 1.0.339 (391) 공개 심사 제출 완료 · 승인 후 자동 공개", "summary": "2026-09-14 20:52 KST iOS1.0.339(391) 공개 심사 제출 완료·심사대기 확인. 승인후 자동출시/전체사용자 즉시 업데이트. 기존387 심사 회수·391로 교체. macOS서명/Apple검증/업로드 성공, 고정소스a34ff8e. 욕구5종·관계5축·우편결정 중심 누적 KO/EN설명 등록, JA문구파일완료. dev392 보존, 게임main 미변경. Apple승인·실제공개는대기. 제출ID0a8bd47c-784e-426c-8655-3669b00d4ad2. 게임dev946aec5."});

window.SEORAP_DATA.updates.unshift({"version": "iOS 1.0.339 (391 공개 심사 대기)", "code": 391, "date": "2026-09-14", "items": ["욕구5종·관계수치·관계우편·질문저장·이름표 등391 누적변경을 iOS 공개심사 제출", "9월14일20:52 심사대기 / 승인후 자동공개·모든사용자 즉시업데이트", "macOS 서명·Apple검증·업로드 성공 / Android392 내부테스트 보존", "한국어·영어 설명등록, 일본어 문구완료 / 실제 공개는Apple승인대기"]});
window.SEORAP_DATA.documents.push({"id": "dv-ios-public391-notes", "project": "서랍마을", "section": "release", "subsection": "production", "title": "iOS 391 공개 심사 · 욕구·관계 중심 출시 설명", "description": "2026-09-14 20:52 KST iOS1.0.339(391) 공개 심사 제출 완료·심사대기 확인. 승인후 자동출시/전체사용자 즉시 업데이트. 기존387 심사 회수·391로 교체. macOS서명/Apple검증/업로드 성공, 고정소스a34ff8e. 욕구5종·관계5축·우편결정 중심 누적 KO/EN설명 등록, JA문구파일완료. dev392 보존, 게임main 미변경. Apple승인·실제공개는대기. 제출ID0a8bd47c-784e-426c-8655-3669b00d4ad2. 게임dev946aec5.", "content": "ko\n수면·허기·용변·청결·사교, 욕구 5종을 추가했어요. 기준 캐릭터를 누르면 충족도를 확인하고, 전체설정에서 현재 값으로 고정할 수 있어요.\n\n상대 캐릭터를 누르면 친밀도·애정도·신뢰·편안함·갈등도와 상호작용을 확인해요. 왕관 버튼으로 기준 캐릭터를 바꿀 수 있어요. 관계 변화는 자동 확정하지 않고 우편으로 제안하며, 수락·나중에·현재 관계 유지 중에서 선택해요. 관계와 점수의 고정 방식도 정할 수 있어요.\n\n같은 가구에 앉은 캐릭터는 공동 상황표로 표시하고, 개인 생활 로그는 각자의 행동을 유지해요. 가구나 다른 캐릭터에 가려지는 이름표, 화면 밖으로 나가는 표시, 침대 주변 상황표 위치와 의자·소파 착석 표시를 개선했어요. 상호작용 후 잘못 열리는 캐릭터 메뉴도 수정했어요.\n\n질문에 답할 때 성향 고정 때문에 저장 실패가 뜨던 오류와 설정하지 않은 취미가 자동 행동에 섞이는 경로를 수정했어요. 저장 한도에서 설정·잠금·우편 답변을 저장하는 처리를 개선하고, 늦게 복원된 사진이 새 사진을 덮지 않도록 했어요.\n\n캐릭터 프로필을 강조하고, 사용 슬롯 수와 마을 선택 화면을 보기 쉽게 다듬었어요. 응원자 명단을 복원하고 새 신청자를 반영했어요. 하오체·하게체와 언어별 지역 말투를 정리하고 거친 대사를 순화했어요. 업데이트 안내에 사용자 사진이 표시되던 문제도 수정했어요.\n\n아이돌·취미 선물과 수락 기능, 보낸 사람 이름표를 개선했어요. 자동 수면·식사·용변 등 금지행동 설정과 생활 로그·가구 편집·스크롤·익명 문의를 다듬었어요. iOS 프로필 PNG·PDF 내보내기는 공유 시트로 연결돼요.\n\n캐릭터 슬롯은 1개씩 구매할 수 있으며 5개 묶음 판매를 종료해요. 기존에 구매한 슬롯은 유지돼요. 최종 가격은 결제 화면에서 확인할 수 있어요.\n\nen-US\nFive needs are here: sleep, hunger, toilet, hygiene and social. Tap your viewpoint character to see how fulfilled each need is. You can freeze the current values in detailed settings.\n\nTap another character to view closeness, affection, trust, comfort and tension, and choose an interaction. Use the crown to switch your viewpoint character. Relationship changes now arrive as letters for you to accept, postpone or decline. Choose whether to freeze both the relationship and scores, only the relationship, or neither.\n\nCharacters sharing furniture have a joint status card while their personal activity logs retain their individual actions. Improved name cards that overlap characters or furniture, off-screen labels, bed status positioning, and chair and sofa seating. Fixed incorrect character menus after interactions.\n\nFixed question-save errors caused by locked traits and unrelated hobbies appearing in automatic activities. Improved saving settings, locks and letter replies at storage limits. Delayed photo restoration no longer overwrites newer images.\n\nHighlighted Character Profile and improved used-slot counts and village selection. Restored supporter credits and added new names. Refined classical and regional voices in each language and softened harsh dialogue. Fixed personal photos appearing in update notices.\n\nImproved idol and hobby gifts, gift acceptance and sender labels. Refined automatic activity restrictions, life logs, furniture editing, scrolling and anonymous support. iOS profile PNG/PDF export uses the native share sheet.\n\nCharacter slots are now sold individually and five-slot packs are discontinued. Previously purchased slots are retained. Final local prices appear in the payment sheet.\n\nja\n睡眠・空腹・トイレ・清潔・社交の5つの欲求を追加しました。基準キャラクターを押すと充足度を確認でき、全体設定で現在の値に固定できます。\n\n相手を押すと親密度・愛情度・信頼・安心感・葛藤度と交流を確認できます。王冠で基準キャラクターを切り替えられます。関係の変更は自動で確定せず、手紙で提案されます。受け入れる・後で考える・今の関係を保つ、から選べます。関係と数値の固定方法も設定できます。\n\n同じ家具に座る人物は共通の状況表示にまとめ、個別ログにはそれぞれの行動を残します。人物や家具に隠れる名前表示、画面外へのはみ出し、ベッド周辺の表示位置、椅子とソファの着席表示を改善しました。交流後に誤ったメニューが開く問題も修正しました。\n\n性格の固定による質問の保存エラーと、未設定の趣味が自発行動に混ざる問題を修正しました。容量の上限付近での設定・固定・手紙への返信の保存を改善し、遅れて復元された写真が新しい写真を上書きしないようにしました。\n\nプロフィールを強調し、使用枠数と村の選択画面を見やすくしました。応援者名簿を復元して新しい申請者を追加しました。言語ごとの古風な口調と地域の表現を整え、荒い台詞を和らげました。更新のお知らせに利用者の写真が表示される問題も修正しました。\n\nアイドル・趣味の贈り物、受け取り、差出人の表示を改善しました。自発行動の制限、生活ログ、家具編集、スクロール、匿名問い合わせを調整しました。iOSでのプロフィールPNG・PDFの書き出しは共有シートを使います。\n\nキャラクター枠を1枠ずつ購入できるようになり、5枠セットの販売を終了します。購入済みの枠はそのまま使えます。最終価格は決済画面で確認できます。"});

window.SEORAP_DATA.tasks.push({"id": "dv-speech393", "project": "서랍마을", "type": "개선", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.341(393) 말투 복원·게임 채팅체 내부 테스트 완료", "summary": "Android 1.0.341(393) release290, 9월14일21:22 내부 테스터 제공됨. 인터넷소설 감성체·스타트업 업무체 복원, 게임 채팅체와 3개 언어114문구 추가. 과묵한 직설체 가벼운 표현·상스러운 말투 기호 처리 분리. 일본어 말투 창 넘침 수정. Chromium/WebKit 말투 선택·저장·화면 검사, 저장/상호작용 회귀, 서명 AAB 검증 통과. 게임 dev d94045e, main 유지. 이번 EN/JA100%, 전체 미측정. Apple 수익화는 섹션 제목이며 하위 메뉴 정상, 계약·은행·세금 활성·캐릭터1개 상품 심사대기 확인."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.341 (Android 내부 테스트)", "code": 393, "date": "2026-09-14", "items": ["인터넷소설 감성체·스타트업 업무체 복원 / 장난스러운 게임 채팅체 추가", "과묵한 직설체 가벼운 표현, 상스러운 말투 욕설 기호 처리", "영어·일본어 대사 반영, 긴 예문 선택창 넘침 수정", "9월14일21:22 내부 테스터 제공됨 / 게임dev d94045e"]});

window.SEORAP_DATA.documents.push({"id": "dv-speech393-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "393 말투 업데이트·App Store 수익화 확인", "description": "Android 1.0.341(393) release290, 9월14일21:22 내부 테스터 제공됨. 인터넷소설 감성체·스타트업 업무체 복원, 게임 채팅체와 3개 언어114문구 추가. 과묵한 직설체 가벼운 표현·상스러운 말투 기호 처리 분리. 일본어 말투 창 넘침 수정. Chromium/WebKit 말투 선택·저장·화면 검사, 저장/상호작용 회귀, 서명 AAB 검증 통과. 게임 dev d94045e, main 유지. 이번 EN/JA100%, 전체 미측정. Apple 수익화는 섹션 제목이며 하위 메뉴 정상, 계약·은행·세금 활성·캐릭터1개 상품 심사대기 확인.", "content": "# Android 1.0.341 (393) 내부 테스트\n\n기준: dev 946aec5 / 392. 이번 말투 변경은 dev 개발이며 게임 main은 유지한다.\n\n## 변경\n- 인터넷소설 감성체·스타트업 업무체를 복원하고 이전 저장 이름을 호환한다.\n- 장난스러운 게임 채팅체 추가: 일상 연락 22종, 관계 편지 16종 × 한국어·영어·일본어 = 114개 문구. 나이·브랜드 표현을 이름에 사용하지 않는다.\n- 과묵한 직설체의 가벼운 젠장·망할 표현은 유지하고, 상스러운 말투의 욕설은 @#$%로 표시한다. 작성된 캐릭터 대사의 강한 욕설은 기호로 가린다.\n- 긴 일본어 예문이 말투 선택창을 넘지 않도록 기존 그리드와 줄바꿈 규칙 수정.\n- 이번 변경 문구 EN/JA 번역 100%. 앱 전체 번역률은 미측정.\n\n## 검증\n- check-speech393: 별칭 호환, 35개 말투, 3개 언어 질문·연락·계획·관계 편지, 마스킹, 새 문구 114개 및 자리표시자 통과.\n- qa-speech393 Chromium/WebKit: 3개 언어 말투 선택·저장·384px 화면 경계 통과.\n- qa-interaction391 Chromium: 캐릭터 상호작용 팝업, 안내 사진 분리, 기존 캐릭터 우편 표시 마스킹, 관계 선택 회귀 통과.\n- qa-save391 Chromium: 잠긴 질문 8개 선택·새로고침, 욕구·정책, 실패 롤백·기존 저장 유지·재시도·pagehide 통과. 제보 기기 실측 검증은 아님.\n- Android Gradle bundleRelease 성공, jarsigner jar verified, 154개 런타임 모듈 포함, 패키징된 웹 파일 373개 원본 바이트 일치.\n- WebKit 검증은 브라우저 검사이며 iOS 실기기·새 IPA 검증이 아니다. iOS 391 기존 심사 제출은 유지한다.\n\n## App Store Connect 수익화 확인\n수익화는 클릭 가능한 링크가 아닌 섹션 제목이다. 하위 가격 및 사용 가능 여부 / 앱 내 구입 / 구독 메뉴를 사용한다. 계약·은행·세금 활성 확인. town_slot_1·green_tea 승인, character_slot_1 심사 대기, 이전 character_slots_5 개발자 판매 제거. 설정 변경 없음.\n\n## 빌드\n- 파일: C:/Users/Public/drawer-releases/drawer-village-1.0.341-393.aab\n- SHA256: 00D895392EEF5B32D2B696D2D9F0CB8092B4DE6212E544019E04ED76ADB3DD69\n- Play 내부 테스트 release 290: 2026-09-14 21:22 KST 내부 테스터에게 제공됨 확인.\n\n## Play 출시 노트\n<ko-KR>\n인터넷소설 감성체와 스타트업 업무체를 다시 선택할 수 있어요. 장난스러운 게임 채팅체를 추가했어요. 과묵한 직설체에는 가벼운 거친 표현을 쓰고, 상스러운 말투의 욕설은 기호로 표시해요. 영어·일본어 대사를 다듬고 긴 예문이 선택창 밖으로 나가던 문제를 수정했어요.\n</ko-KR>\n<en-US>\nRestored nostalgic web-romance chat and startup office jargon, and added playful gaming chat. Terse speech uses mild expressions, while vulgar speech uses symbols for swearing. Refined English and Japanese dialogue and fixed long examples overflowing the voice picker.\n</en-US>\n<ja-JP>\n懐かしのケータイ小説風とスタートアップ業務口調を再び選べるようにし、ノリのいいゲームチャット口調を追加しました。寡黙な口調では軽い苛立ちの表現を使い、下品な口調の悪態は記号で表示します。英語・日本語の台詞を調整し、長い例文が選択画面からはみ出す問題を修正しました。\n</ja-JP>\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-language394", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.342(394) 대명사·자칭 및 영어 문구 내부 테스트 완료", "summary": "Android1.0.342(394) release291, 9월14일22:41 내부 테스터 제공됨. 성별 아래 대명사·자칭 직접입력/3언어 보존/미리보기, 영어5형태·동사활용, 한국어 자칭 조사. 해당 대사·기본/음료/알림 생활로그 연결. 영어 기존31종682문구·지역슬롯 장르편지32개 반영. Chromium/WebKit 프로필 저장·재실행·공유코드 프로필 복제·화면 검증, 저장 및 상호작용 회귀, 서명AAB 검증 통과. 게임dev a0c46ec·게임main 유지. 새UI EN/JA100%, 영어원고연결31/37종83.8%, 전체미측정."});

window.SEORAP_DATA.tasks.push({"id": "dv-language-new-voices", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "신규 영어 말투6종 · 세 언어 대응 확정", "summary": "394 원고에 중세 귀족/중세 서민/전문 분석/쑥스러운 호감/느긋함/엉뚱한 연상 6종 자료 보존. 기존35개 옵션과 별개로 신규 유형·한국어/일본어 문구·중세풍 강도 확정 필요. 현재 선택지 추가나 실행 연결은 하지 않음. 기존말투31종은394에 연결 완료."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.342 (Android 내부 테스트)", "code": 394, "date": "2026-09-14", "items": ["성별과 독립적인 대명사·자칭 / 직접입력·3언어·미리보기", "해당 대사·생활로그 영어활용 및 한국어 자칭 형태 반영", "기존말투31종 영어682문구 / 장르 관계편지32개 조정", "9월14일22:41 내부 테스터 제공됨 / 게임dev a0c46ec"]});

window.SEORAP_DATA.documents.push({"id": "dv-language394-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "394 대명사·자칭 출시 노트와 남은 말투 대응", "description": "Android1.0.342(394) release291, 9월14일22:41 내부 테스터 제공됨. 성별 아래 대명사·자칭 직접입력/3언어 보존/미리보기, 영어5형태·동사활용, 한국어 자칭 조사. 해당 대사·기본/음료/알림 생활로그 연결. 영어 기존31종682문구·지역슬롯 장르편지32개 반영. Chromium/WebKit 프로필 저장·재실행·공유코드 프로필 복제·화면 검증, 저장 및 상호작용 회귀, 서명AAB 검증 통과. 게임dev a0c46ec·게임main 유지. 새UI EN/JA100%, 영어원고연결31/37종83.8%, 전체미측정.", "content": "# 1.0.342 (394) 대명사·자칭 및 영어 문구\n\n기준: 게임 dev d94045e / Android393. 이번 작업은 dev 계열이며 공개 웹 main은 유지한다.\n\n## 반영 범위\n- 성별 아래 대명사·자칭 카드. 현재 언어를 먼저 보이고 나머지 언어는 펼침 영역. 직접 입력과 문장 미리보기 제공.\n- 한국어 자칭/제3자 지칭, 자칭의 주어/소유 형태. 일본어 자칭/제3자 지칭. 영어 he/she/they, 5형태 직접 입력, is/are 동사 활용, themself/themselves.\n- 성별로 대명사를 추정하지 않음. 언어별 필드는 저장·공유코드·멀티 프로필 데이터에 보존.\n- 작성된 질문·관계편지·연락의 자칭을 적용. 주어 생략 문장은 유지. 기본 영어 생활 로그/음료 로그/생활 알림의 소유자 지칭에 적용. 기존 사용자 자유문장이나 전체 과거 로그를 일괄 치환하지 않음.\n- 영어 원고는 실제 37종×22개=814문구. 기존 앱과 명시적으로 대응한 31종×22개=682문구 등록. 기존 앱에 없는 archaic_high, archaic_low, expert, tsundere, languid, whimsical 6종은 원고 데이터 보존, 선택지/실행 연결은 보류. 기본 추천안을 알린 뒤 기존 대응 범위로 진행; 신규 유형 확정 답변 없음.\n- 영어 지역 슬롯의 표시와 푸시를 Frontier Plainspoken / Seafaring Adventure로 대응. 한국어 저장 말투 값 유지. 관련 영어 관계 편지32개도 같은 표현 방식으로 정리. 지역에 성격을 부여하는 원고 설명은 반영하지 않음.\n- 강한 욕설은 기호 표기, 원고의 강압적인 일부 표현 수정. 원고의 중세영어 역사/문법 정확성을 인증하거나 전부 원어민 감수 완료했다고 주장하지 않음.\n\n## 검증\n- check-language394: 37개 원고 풀 길이, 31개 대응 출력, 자리표시자, 강한 욕설 검사, 성별 독립, 영어 활용, 자칭 형태, 로그 연결.\n- qa-language394 Chromium/WebKit: 384×854 실제 프로필 화면, KO/EN/JA 입력·미리보기·저장·재실행·언어간 유지·공유코드 가져오기 프로필 복제. 화면 경계 및 시각 확인.\n- qa-save391 Chromium: 잠긴 noise 질문8개·재실행, 욕구/정책 보존, 실패 롤백, 기존 디스크 보존, 재시도, pagehide 저장 통과.\n- qa-interaction391 Chromium: 캐릭터 상호작용·기준 캐릭터·관계 UI·공지사진 분리 회귀 통과.\n- check-speech393 및 qa-speech393: 기존 말투35선택지/별칭/3개 언어/마스킹 회귀 통과. 기존 영어 질문에 반드시 Damn이 있어야 한다는 구문 검사는 신규 원고로 바뀌어 제거; 가벼운 표현 보존 검사는 유지.\n- Android Gradle bundleRelease 성공. jarsigner jar verified. 런타임157모듈 포함, AAB 웹 파일376개 원본 바이트 일치.\n- 이 검증은 로컬 모의 계정 기반이며 실제 제보 기기나 운영계정 공유코드 재현을 의미하지 않음. iOS는 공통 코드 영향 + WebKit 검사, 신규 IPA 빌드/업로드 없음.\n\n## 번역 및 남은 범위\n새 설정 UI: EN100% / JA100%. 영어 원고 연결: 31/37종 (83.8%). 보류6종의 KO/JA 대사·말투 최종대응은 미완료. 기존 일본어 말투 대사는 유지. 앱 전체 번역률 미측정.\n\n## 배포\n- Android 1.0.342 / versionCode394 / Build20260914dev394\n- AAB: C:/Users/Public/drawer-releases/drawer-village-1.0.342-394.aab\n- SHA256: 486304BFF525E36DDF539D5C04419E313CD43D4B36DFBD954629A99F044F9AB0\n- Play 내부 테스트 release291: 2026-09-14 22:41 KST 내부 테스터에게 제공됨 확인.\n\n## Play 출시 노트\n<ko-KR>\n캐릭터 프로필의 성별 아래에 대명사·자칭 설정을 추가했어요. 한국어·영어·일본어 표현을 따로 고르거나 직접 입력하고 예문으로 확인할 수 있어요. 대사와 생활 로그의 해당 문장에 설정을 반영해요. 기존 말투 31종의 영어 연락 문구를 다듬고, 두 장르 말투의 관계 편지도 맞췄어요.\n</ko-KR>\n<en-US>\nAdded pronouns and self-reference below gender in Character Profile. Set Korean, English and Japanese expressions independently, including custom forms and previews. Supported dialogue and life-log sentences now use these settings. Refined English contact messages for 31 existing voices and aligned relationship letters for the frontier and seafaring voices.\n</en-US>\n<ja-JP>\nキャラクタープロフィールの性別の下に、代名詞・一人称の設定を追加しました。韓国語・英語・日本語を個別に選択・自由入力し、例文で確認できます。対応する台詞と生活ログの文に設定を反映します。既存31種類の英語連絡文を調整し、開拓・航海風の関係の手紙も統一しました。\n</ja-JP>\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-language395", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.343(395) 대명사 카드 디자인·영어 문장집 완료", "summary": "Android1.0.343(395) release292, 9월14일23:06 내부 테스터 제공됨. 대명사·자칭 종이 카드/선택 버튼/예문/언어별 펼침으로 정돈. 영어 1,538개 PDF·TXT 원문 대조본 제공: 첨부814개 중677개 동일·5개 수정·132개 미연결. Chromium/WebKit 실제 프로필 저장·공유·화면 및 PDF 텍스트·경계, 서명AAB 웹376파일 일치. 게임dev 3b36ea4. 새 UI EN/JA100%, 영어원고 연결31/37종83.8%."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.343 (Android 내부 테스트)", "code": 395, "date": "2026-09-14", "items": ["대명사·자칭 종이 카드, 선택 버튼, 예문 디자인", "다른 언어 표현을 언어별로 펼쳐 확인", "영어1,538개 문장집 / 적용677개 동일·5개 수정·132개 미연결", "9월14일23:06 내부 테스터 제공됨 / 게임dev 3b36ea4"]});

window.SEORAP_DATA.documents.push({"id": "dv-language395-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "395 대명사 카드·영어 원고 대조 및 내부 테스트", "description": "Android1.0.343(395) release292, 9월14일23:06 내부 테스터 제공됨. 대명사·자칭 종이 카드/선택 버튼/예문/언어별 펼침으로 정돈. 영어 1,538개 PDF·TXT 원문 대조본 제공: 첨부814개 중677개 동일·5개 수정·132개 미연결. Chromium/WebKit 실제 프로필 저장·공유·화면 및 PDF 텍스트·경계, 서명AAB 웹376파일 일치. 게임dev 3b36ea4. 새 UI EN/JA100%, 영어원고 연결31/37종83.8%.", "content": "# 1.0.343 (395) 대명사 설정 디자인과 영어 문장집\n\n기준: dev a0c46ec / 내부 테스트394. 게임은 dev에 반영하며 main은 유지.\n\n## 변경\n- 성별 아래 대명사·자칭을 종이 카드, 펜 장식, 둥근 입력칸, 선택 버튼, 예문 카드로 정돈.\n- 기본·자주 쓰는 자칭/지칭을 버튼으로 선택. 직접 입력도 유지. 선택 상태와 예문 즉시 갱신.\n- 다른 언어 설정을 언어별 접기 영역으로 분리. 기존 모바일 전역 스타일의 잘못된 적용 범위를 수정.\n- 영어 런타임 문구는 394와 동일. 원고 814개 중 682개 연결(677개 동일, 5개 수정), 132개 미연결.\n- 변경 5개: coarse 주말/휴식/일하기 싫음/음료, scholar 늦잠. 수정 전후를 문장집에 수록.\n- 원고37종 전체814개 + 별도 푸시44개 + 실제 우편 본문544개 + 질문·계획·연락 예시136개 = 1,538개 수록.\n- output/pdf/english-dialogue-395.pdf 및 txt/md/json 생성. 앱 전체 영어 UI나 모든 생활 로그를 수록한 자료는 아님.\n\n## 검증\n- qa-language395 Chromium/WebKit: 384px KO/EN/JA 실제 프로필, 선택 버튼, 직접 입력, 미리보기, 저장/재실행, 언어 보존, 공유코드 프로필 복제, 화면 넘침 통과.\n- PDF 122쪽: 추출 텍스트 1,538개 모두 대조 일치(공백 정규화), 전체 페이지 문자 경계 통과. 표지·원문 대조·긴 문장·중세 원고·관계 편지·끝 페이지 렌더 확인.\n- Gradle bundleRelease 성공. jarsigner jar verified. AAB 웹 파일376개 원본 바이트 일치.\n- 테스트는 로컬 모의 계정 기반. iOS 신규 빌드/업로드 없음.\n\n## 번역\n새 UI 영어100% / 일본어100%. 영어 원고 연결31/37종83.8%, 기존 미연결6종 유지. 앱 전체 번역률 미측정.\n\n## 배포\n- Android1.0.343 / versionCode395 / Build20260914dev395\n- AAB: C:/Users/Public/drawer-releases/drawervillage-1.0.343-395-internal.aab\n- SHA256: 8E0FAD67C4EAD28291251E8313DEA271866D16474F6FCB5BBE876B2DF8D6E944\n- Play 내부 테스트 release292: 2026-09-14 23:06 KST 내부 테스터에게 제공됨 확인.\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-fixes396", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.344(396) 대명사 팝업·공유 집 삭제 및 저장 재검증", "summary": "Android1.0.344(396) release293, 9월15일10:47 내부 테스터 제공됨. 프로필 대명사 설정 버튼→팝업. 멀티 집 삭제의 일괄 비활성화/미연결 수정, 방장·관리자·집 주인만 삭제, 대상 집 구분·실패 재시도·개인 집 보존. 기존387 질문 저장 및391 공유코드 제보 경로 회귀 통과(실제 운영계정 재현 아님). Chromium/WebKit 모달/삭제 검증, 서명AAB 웹377파일 일치. 게임dev513e4fb. 새 문구 EN/JA100%."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.344 (Android 내부 테스트)", "code": 396, "date": "2026-09-15", "items": ["대명사 설정 버튼을 누르면 기존 디자인 팝업 열림", "멀티 방장·관리자·집 주인의 공유 집 삭제 복구", "질문 저장·공유코드 이전 수정 회귀검사 통과", "9월15일10:47 내부 테스터 제공됨 / dev513e4fb"]});

window.SEORAP_DATA.documents.push({"id": "dv-fixes396-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "396 출시 노트·제보별 검증 결과", "description": "Android1.0.344(396) release293, 9월15일10:47 내부 테스터 제공됨. 프로필 대명사 설정 버튼→팝업. 멀티 집 삭제의 일괄 비활성화/미연결 수정, 방장·관리자·집 주인만 삭제, 대상 집 구분·실패 재시도·개인 집 보존. 기존387 질문 저장 및391 공유코드 제보 경로 회귀 통과(실제 운영계정 재현 아님). Chromium/WebKit 모달/삭제 검증, 서명AAB 웹377파일 일치. 게임dev513e4fb. 새 문구 EN/JA100%.", "content": "# 1.0.344 (396) 대명사 팝업 · 공유 집 삭제\n\n기준 dev 3b36ea4 / 내부395. 새 기능과 수정은 dev, 게임 main 유지.\n\n## 변경\n- 프로필 성별 아래 대명사 설정 버튼. 기존395 카드 디자인을 모달 안에 표시, 완료로 닫고 프로필 저장. KO/EN/JA 동일.\n- 공유 집 화면은 삭제 버튼을 일괄 비활성화하던 처리를 제거. 방장·관리자·집 주인 권한에 맞춰 기존 서버의 공유 집 삭제 API 연결.\n- 집 이동 목록에서 현재 집이 아닌 선택한 집을 삭제. 마을 건물 상세 및 배치 도구의 집 삭제도 연결.\n- 진행 중인 집 배치 저장이 끝난 뒤 삭제, 중복 클릭 방지, 계정/그룹 변경 시 취소, 실패 후 재시도. 개인 월드 삭제 이벤트 차단.\n- 삭제 완료 후 방문 대상과 공유 집 목록 갱신. 캐릭터/개인 집 삭제 없음. Firestore 권한 변경이나 운영 데이터 삭제 테스트 없음.\n\n## 기존 제보 재검증\n- 질문 저장387 제보: qa-save391 Chromium에서 잠긴 noise 질문8회·재실행, 5명 욕구·정책 보존, 저장실패 롤백/디스크 보존/재시도/pagehide 통과.\n- 공유코드391 제보: 기존392 수정이 유지됨. qa-interaction392 Chromium의 10명 불러오기·영속 저장/재실행·슬롯 부족 거절·실패 롤백·실제 미리보기/불러오기·코드 정규화 통과.\n- 위 두 제보의 실제 운영계정·기기 재현이나 모든 저장 오류의 해결을 의미하지 않음. 이번396에서 해당 로직의 추가 변경은 없음.\n\n## 새 검증\n- qa-language396 Chromium/WebKit: KO/EN/JA 버튼/모달/직접입력/선택/예문/완료/프로필저장/재실행/공유코드 프로필 복제 및384px 경계. 한국어 팝업 시각 확인.\n- qa-home396 Chromium/WebKit: 실제 삭제 핸들러와 모의 API로 방장/관리자/집주인/일반구성원/취소/실패/그룹변경, 대상 집 구분·배치 저장 대기·중복클릭·개인 집 보존 통과.\n- 웹/Android/iOS 공통 코드. Android 내부 테스트 대상. WebKit 검증, 신규 IPA/공개 사이트 배포 없음.\n- 새 문구 EN100% / JA100%. 전체 앱 번역률 미측정.\n\n## 배포\nAndroid1.0.344 / code396 / Build20260915dev396. Gradle bundleRelease 및 jarsigner 검증 통과. AAB 웹377개 원본 바이트 일치.\nAAB: C:/Users/Public/drawer-releases/drawervillage-1.0.344-396-internal.aab\nSHA256: 164F78C2F6B8C229307F7E524311088BFE3F6D218C7D0228889EF127FED7F618\nPlay 내부 테스트 release293: 2026-09-15 10:47 KST 내부 테스터에게 제공됨 확인.\n\n## 출시 노트\n<ko-KR>\n캐릭터 프로필에 ‘대명사 설정’ 버튼을 두고, 누르면 설정 팝업이 열리도록 바꿨어요. 멀티플레이에서 방장·관리자·집 주인이 공유 집을 삭제할 수 있도록 수정했어요. 삭제에 실패하면 다시 시도할 수 있어요.\n</ko-KR>\n<en-US>\nCharacter Profile now opens pronoun settings in a popup from a dedicated button. Fixed shared-home deletion for group owners, managers and home owners in multiplayer. Failed deletions can be retried.\n</en-US>\n<ja-JP>\nキャラクタープロフィールの「代名詞の設定」ボタンから、設定ポップアップが開くようにしました。マルチプレイでグループのオーナー・管理者・家の所有者が共有の家を削除できるよう修正しました。削除に失敗した場合は再試行できます。\n</ja-JP>\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-web397", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.345(397) 공개 사이트·전체읽음·화면/로딩 개선", "summary": "공개 drawervillage.com web397b 배포 완료(Cloudflare0f7bf9b5), 최신 런타임·우편함 전체읽음·질문받기 아이콘·긴화면 지도/상단 겹침 수정. 초기 대량 이미지 다운로드 제거·버전파일 캐시·WebP216참조 적용. Android1.0.345(397) release294 9월15일11:02 내부 제공됨. 모바일/데스크톱/KO·EN·JA 및 이전우편 읽음·새우편/그룹식별 검증. 실제 계정 동기화 속도 개선율 미측정. dev a15f0a8, 새문구EN/JA100%."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.345 (공개 웹·Android 내부 테스트)", "code": 397, "date": "2026-09-15", "items": ["drawervillage.com 최신 웹 배포 완료", "전체 읽음 버튼·질문받기 아이콘 복구", "긴 화면 마을 하단 채우기·상단 버튼 겹침 수정", "초기 다운로드·재방문 캐시·이미지 최적화", "Android397 11:02 내부 테스터 제공됨 / dev a15f0a8"]});

window.SEORAP_DATA.documents.push({"id": "dv-web397-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "397 공개 사이트 배포·출시 노트·검증 범위", "description": "공개 drawervillage.com web397b 배포 완료(Cloudflare0f7bf9b5), 최신 런타임·우편함 전체읽음·질문받기 아이콘·긴화면 지도/상단 겹침 수정. 초기 대량 이미지 다운로드 제거·버전파일 캐시·WebP216참조 적용. Android1.0.345(397) release294 9월15일11:02 내부 제공됨. 모바일/데스크톱/KO·EN·JA 및 이전우편 읽음·새우편/그룹식별 검증. 실제 계정 동기화 속도 개선율 미측정. dev a15f0a8, 새문구EN/JA100%.", "content": "# 1.0.345 (397) 공개 웹·우편 읽음·마을 화면\n\n기준 dev513e4fb / Android396. 사용자가 drawervillage.com 공개 배포를 명시함. 게임 main과 기존 자동 배포 연결은 변경하지 않고 dist를 Cloudflare production으로 배포.\n\n## 변경\n- 우편함 공지/받은우편에 전체 읽음으로 표시. 이전 페이지를 불러온 뒤 계정별 읽음 상태를 한 번에 저장. 제안/선물의 수락·응답 상태는 유지. 실패 시 성공 안내 없이 재시도. 계정 전환 시 중단.\n- 질문받기 아이콘: 숨겨진 탭에서 렌더될 때 기존 아이콘만 지우고 재생성하지 않던 조건 제거.\n- 마을 캔버스가 화면보다 짧지 않게 계산. 긴 화면의 지도 하단 빈 공간, 마을 이름/선택 버튼의 높이 의존 겹침 수정. 데스크톱은 지도 비율을 유지하며 넘치는 지도는 이동 가능.\n- 웹은 최신dev 런타임 전체를 배포. 전 웹341 이후 앱에서 수정한 대명사·욕구·관계·저장·공유 집 수정 포함.\n- 최초 서비스워커의 대량 이미지/글꼴 선다운로드 제거. 새 버전 키가 붙은 JS/CSS는 서비스워커 cache-first. HTML/config는 네트워크 확인 유지.\n- 웹 패키지의 정적 이미지216개 참조를 기존 검증 WebP로 연결. 대상98개 원본 합42,223,140B → WebP합23,803,612B(전체 페이지 전송량/로딩 개선율과 다름). 사용자 이미지/데이터는 변환하지 않음.\n- 웹 런타임157모듈의 버전 키 통일, 동적 import 의존 파일도 포함. 최종web cache20260915web397b.\n\n## 검증\n- qa-web397: 400×960/400×1600/800×1920/1440×1000 가로 넘침·지도 경계, 질문 버튼. 60건 읽음·그룹 식별·새 우편 미읽음, 실제 전체읽음 클릭과 이전페이지 로드 및 제안pending 보존.\n- qa-web341 회귀: KO/EN/JA 데스크톱 메뉴·계정·멀티·브라우저 음소거·모바일HUD·상점, pageerror 없음.\n- 긴 모바일 마을 화면 렌더 확인. 초기에 발견한 마을 제목/버튼 겹침을 수정한 후 재검증.\n- Gradle 서명release 빌드 통과, AAB 웹377개 www원본과 일치. SHA256 C6431E61C63C921885EC198B40677A833B2D0D010CCC391C251EE6A27F1887E0.\n- 속도 검증 범위는 초기 자산/캐시 구조와 로컬 10명 UI 경로. 실제 사용자 계정의 클라우드 동기화 지연이나 기기별 전체 속도 개선율은 미측정.\n- 새 UI 문구 영어100% / 일본어100%, 전체 앱 번역률 미측정. iOS 공통코드 영향, 신규IPA 배포 없음.\n\n## 배포\n- 공개웹 https://drawervillage.com : 최종 Cloudflare Pages 0f7bf9b5. web397b app.js 제공 및 공개 우편함 전체읽음 버튼 확인.\n- Android1.0.345 / code397 / Build20260915dev397. Play 내부 테스트 release294, 2026-09-15 11:02 KST 내부 테스터에게 제공됨 확인.\n- AAB C:/Users/Public/drawer-releases/drawervillage-1.0.345-397-internal.aab\n\n## Play 출시 노트\n<ko-KR>\n우편함에 전체 읽음으로 표시 버튼을 추가했어요. 긴 화면에서도 마을 배경이 끝까지 채워지도록 하고, 상단 마을 이름과 버튼 겹침을 수정했어요. 질문받기 아이콘이 화면 갱신 중 사라지는 문제를 개선했어요.\n</ko-KR>\n<en-US>\nAdded Mark all as read to the mailbox. The town map now fills tall screens, and town names no longer overlap the header buttons. Fixed the question icon disappearing during background screen updates.\n</en-US>\n<ja-JP>\n郵便箱に「すべて既読にする」を追加しました。縦長の画面でも村の背景が下まで表示され、上部の村名とボタンが重ならないようにしました。画面の更新中に質問アイコンが消える問題を改善しました。\n</ja-JP>\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-home398", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "398 홈 재배치·광장·서랍·친구 코드", "summary": "홈 5개 메뉴, 사용자 서랍·휴대폰 그림, 심리테스트 위치 이동. 친구 코드 요청·수락·거절·취소·해제. 공개웹 및 내부 테스트398 제공 완료 / dev90f5cfc."});

window.SEORAP_DATA.tasks.push({"id": "dv-social-playground", "project": "서랍마을", "section": "development", "subsection": "features", "completed": false, "title": "광장 놀이: 캐릭터 이입 마피아·무도회와 참여 게임 원형 표시", "summary": "사용자 방향 확정. 현재398은 실제 멀티 원형 바로가기와 광장 진입까지. 게임 세션·차례·모집·초대·무도회 규칙은 후속 설계/구현 필요."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.346 (Android 내부 테스트·공개웹)", "code": 398, "date": "2026-09-15", "items": ["홈: 집·마을·광장·서랍·상점 / 우편함 아래 친구", "서랍에 캐릭터·관계·사전·일정·기록·통계, 심리테스트·시간은 생활 카드", "친구 코드 검색·요청·수락·거절·취소·해제 및 서버 권한 처리", "공개웹 e666db1e / 내부 테스트release295 12:06 제공됨 / dev90f5cfc", "이번 UI 영어100%·일본어100%, 전체 미측정"]});

window.SEORAP_DATA.documents.push({"id": "dv-home398-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "398 홈·친구 업데이트 (복붙용 3개 언어 포함)", "description": "새 홈과 친구 코드, 공개웹/내부 테스트 배포 및 검증 기록. 게임dev90f5cfc, main 유지.", "content": "# 398 · 홈 재구성 및 친구 코드\n\nAndroid 1.0.346 / code398 / Build20260915dev398. dev 개발, 게임 main 유지.\n\n## 변경\n- 첨부 HTML을 기준으로 모바일 홈 하단 집·마을·광장·서랍·상점. 왼쪽 메뉴는 서랍 안 6개 기능으로 통합.\n- 사용자 새 그림의 서랍과 휴대폰을 추출하고 광장에는 기존 공원 외관 사용.\n- 오른쪽 우편함 아래 친구, 그 아래 설정. 심리테스트와 남은 시간은 생활 카드의 이전 할 일 정하기 위치.\n- 광장은 실제 멀티 목록·참여 경로를 제공. 원형 바로가기는 실제 참여 멀티를 표시. 마피아·무도회 및 게임 진행/차례 모델은 후속 작업이며 구현된 것으로 표시하지 않음.\n- 친구 코드 검색→요청→상대 수락 후 양쪽 친구 목록에 저장. 거절·요청 취소·친구 해제 제공. 계정별 코드, 중복 방지, 상대방 수락 권한, 양방향 차단 검사, 수량·요청 제한, 계정 삭제 연동.\n- 자동 폴링 없이 친구 창 열기 및 새로고침 때만 조회. 받은 요청은 친구 창에서 확인.\n- 데스크톱 관찰에도 광장·서랍·친구 진입 추가.\n\n## 검증\n- check-friends398: 개인 코드, 검색, 자기 자신 제한, 중복·교차 요청, 수신자 외 수락 거부, 양쪽 친구 등록·해제, 거절·취소, 차단·요청량 제한, Firestore 읽기/쓰기 순서 통과.\n- qa-home398 Chromium/WebKit: KO/EN/JA, 360·412px 홈/서랍/광장 경계와 진입, 심리테스트 위치, 친구 수락 UI 및 이름 HTML 이스케이프 통과. 친구 UI는 격리 fixture로 검증, 실제 사용자 두 계정 간 실기기 왕복은 미검증.\n- qa-web397: 지도 화면 채움, 질문 아이콘, 전체 읽음 및 제안 상태 보존 회귀 통과.\n- 기존 user-safety 검사 통과. 서명 AAB 빌드 성공, 새 JS/CSS/이미지 원본 바이트와 index398 표식 일치, jarsigner 검증 통과.\n- AAB SHA256: 599431E15A374E0BB4CC22E73D330B64FA1E0808A6BF01B804DF9F6DAA5E0ACE\n- 새 화면 영어100% / 일본어100%, 앱 전체 번역률 미측정. iOS는 공통 WebKit 검증, 이번 IPA 업로드 없음.\n\n## 출시 노트\n<ko-KR>\n홈 하단을 집·마을·광장·서랍·상점으로 정리했어요. 캐릭터·관계·사전·일정·기록·통계를 서랍에서 열 수 있어요. 우편함 아래에 친구를 추가하고, 친구 코드 검색과 요청·수락·거절·취소를 지원해요. 심리테스트와 남은 시간을 생활 카드로 옮겼어요.\n</ko-KR>\n<en-US>\nReorganized the home dock into Home, Town, Plaza, Drawer and Shop. Open character settings, relationships, the dictionary, schedules, records and stats from the Drawer. Added Friends below Mail, with friend codes and requests you can accept, decline or cancel. Moved the personality test and countdown to the activity card.\n</en-US>\n<ja-JP>\nホーム下部を家・村・広場・引き出し・店に整理しました。キャラクター・関係・辞典・予定・記録・統計は引き出しから開けます。郵便の下にフレンドを追加し、コード検索と申請・承認・辞退・取消に対応しました。心理テストと残り時間を生活カードに移動しました。\n</ja-JP>\n\n## 배포 완료\n- 공개웹 drawervillage.com: Cloudflare Pages e666db1e, web398. 실제 공개 홈의 광장·서랍·친구·심리테스트 표시와 서랍 팝업 확인.\n- sharedTownApi, accountDeletionApi 서버 배포 완료. 원래 공개 API 인증 경로 사용, 새 데이터 컬렉션은 서버에서만 접근.\n- Android 내부 테스트 release295, 2026-09-15 12:06 KST 내부 테스터에게 제공됨 확인.\n- 계정 삭제 회귀에 친구 코드 삭제 및 다른 사용자의 관계만 정리하는 검사 추가·통과.\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-mafia399", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "399 서랍 CSS 배포 수정·마피아 첫 버전", "summary": "공개웹 누락 CSS와 intro-tour 복구·배포파일 검사. 우측 심리테스트·편지·이름. 멀티 방장 개설, 동의 NPC, 계획·카드토론·투표. 서버·공개웹5fef745f·내부테스트release296 12:57 제공됨. 게임dev f97eac3."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.347 (공개웹·Android 내부 테스트)", "code": 399, "date": "2026-09-15", "items": ["서랍 대형 아이콘 깨짐: 배포 CSS 누락 수정·스타일 누락 빌드 검사", "우측 심리테스트·새 편지 그림·흰 글씨 검정 테두리 메뉴 이름", "광장 마피아 첫 버전: 모집·동의 NPC·이동/임무/조사·목격 카드·토론·투표", "100개 조건 결정론 완주, dist Chromium/WebKit 세 언어 경계·권한·기밀 검사", "공개웹5fef745f / 내부테스트399 release296 12:57 제공됨", "새 UI 영어100%·일본어100%, 실제 멀티 장시간 밸런스는 미검증"]});

window.SEORAP_DATA.documents.push({"id": "dv-mafia399-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "399 마피아 첫 버전·UI 복구·출시노트", "description": "구현 범위, 후속 항목, 배포 및 검증, 3개 언어 복붙용 노트", "content": "# 399 · 서랍 배포 수정 / 마피아 놀이 첫 버전\n\nAndroid1.0.347 / code399 / Build20260915dev399. dev 개발, 게임 main 유지.\n\n## 홈 UI 수정\n- 398 공개웹의 home-social-ui.css 누락이 원인. 로컬 원본 테스트만으로 놓쳤으므로 배포 폴더(dist) 대상 QA로 변경.\n- HTML이 참조하는 로컬 스타일이 빠지면 prepare-web이 실패하도록 검사. 함께 발견한 intro-tour.css 누락도 수정.\n- 심리테스트·남은 시간은 오른쪽 우편 위. 사용자 새 그림에서 편지 에셋 추출. 우편·친구·설정 명칭은 아이콘 아래 겹치는 흰 글씨/검정 외곽선.\n- 실제 공개 DOM에서 서랍 grid 2열 / 아이콘66px 확인.\n\n## 마피아 첫 버전\n- 광장에서 멀티 선택 → 방장/관리자가 개설, 4~10명(기본5), 단계별6/12/24시간. 실제 마을/집의 장소3~8개를 선택 순서의 원형 동선으로 연결.\n- 사용자당 직접 조종 1명. 빈자리는 소유자가 미리 자동 참가 허용한 캐릭터만 충원. NPC도 시민/마피아 배정.\n- 이동·임무·조사6칸 계획을 동시 제출. 미제출/NPC 계획은 자동. 방해·술래 지목은 마피아 전용. 밤에는3회 이동, 늦게 자는 캐릭터는 첫 밤 목격 가능.\n- 자기 알리바이/목격/흔적 카드, 공개 카드 보드, 장소 진술 충돌 표시. 카드 공개·의심·옹호·보류, 의심에 자동 알리바이 반박. 마피아는 하루1회 위조 가능, NPC 위조 선택 포함.\n- NPC 의심은 자기 카드·공개 기록과 약한 기존 시선 가중치만 사용. 대상의 숨은 역할을 읽지 않음. 기존 말투 변환으로 대사 표시.\n- 토론3단계→투표, 동률 유보. 임무100%/마피아 전원 퇴장 시 시민 승, 마피아 수가 시민 이상이면 마피아 승.\n- 서버 절대 마감 시간·트랜잭션으로 중복 처리 방지. 재접속 시 지난 단계 최대50회 따라잡기. 종료 시 원래 관계에 쓰지 않고 잠깐의 기분 효과만 적용. 주최 취소/참가 철회 제공.\n- 홈 원형 표시는 선택한 멀티의 실제 참여 놀이. 게임 자체 상태는 참가 멀티의 서버 API에서 확인.\n- 계정 삭제 시 다른 멀티에 남은 게임의 해당 계정 이름·개인 카드·제출을 정리.\n\n## 첫 버전의 범위 / 후속\n- 솔로·무도회·음악회·요리·서바이벌·릴레이·보드게임은 미구현.\n- 실제 마을 좌표 기반 길 찾기, 감각별 흐릿한 기억, 고급 모순 종류, 대사100종, 라운드 우편 알림, 장기 기록 정리와 상세 리플레이는 후속.\n- 토론은 비동기 동시 제출 방식. 누구도 접속하지 않을 때 서버 크론이 매번 진행하는 방식은 아니며, 놀이를 열면 서버가 마감 상태를 따라잡음.\n- 실제 사용자 여러 기기의6~24시간 왕복과 재미/밸런스는 미검증. 서버 시뮬레이션과 격리 UI fixture로 검증한 초기 플레이 버전.\n\n## 검증\n- check-games399: 100개 seed 완주·결정론, 역할/개인카드 분리, NPC 지식 제한, 이동 제한, 방장/가입/소유권, 동의 NPC 충원, 지난 단계 거부·멱등, 기분 처리.\n- qa-games399 실제dist Chromium/WebKit KO/EN/JA 360px 계획/토론/투표 경계·제출 경로. WebKit 카드 선택의 긴 옵션 넘침을 번호 선택+별도 상세 카드로 수정 후통과.\n- qa-home399 실제dist Chromium/WebKit 360·412px 서랍grid/아이콘 크기·광장·우편 위치·친구 회귀.\n- 친구 요청 및 계정 삭제 회귀 통과. 새CSS/게임모듈/편지에셋 AAB원본 바이트 일치, 빌드399 표식·jarsigner 통과.\n- AAB SHA256 F7486D370D9BEF6219163303EB2F4F449C74CA93E1A2635C101393C6DC708A42\n- 새UI 영어100% / 일본어100%, 전체앱 미측정. iOS는 WebKit 공통 UI 검증, 신규IPA 없음.\n\n## 배포\n- 공개웹 최종5fef745f / web399b, 앞서 UI만 먼저 복구 후 마피아 포함본 재배포.\n- sharedTownApi / accountDeletionApi 서버 배포 성공.\n- Play 내부 테스트 release296, 2026-09-15 12:57 KST 내부 테스터에게 제공됨 확인.\n\n## Play 출시노트\n<ko-KR>\n서랍 메뉴가 큰 아이콘으로 깨지던 문제를 수정했어요. 심리테스트를 오른쪽 맨 위로 옮기고 새 편지 그림과 메뉴 이름을 적용했어요. 광장에 마피아 놀이 첫 버전을 추가했어요. 방장 개설, 참가와 허용된 NPC 충원, 이동·임무·조사 계획, 목격 카드 토론과 투표를 지원해요.\n</ko-KR>\n<en-US>\nFixed oversized icons in the Drawer. Moved the personality test above Mail and added the new letter artwork with menu labels. Added the first Mafia game in the Plaza: host a game, join with a character, fill seats with opted-in NPCs, submit movement and task plans, reveal witness cards, discuss and vote.\n</en-US>\n<ja-JP>\n引き出しのアイコンが大きく崩れる問題を修正しました。心理テストを郵便の上に移し、新しい手紙の絵とメニュー名を表示しました。広場にマフィアゲームの初期版を追加しました。ホストによる開設、参加と許可済みNPCの補充、移動・任務・調査の計画、目撃カードでの討論と投票に対応しました。\n</ja-JP>\n"});

{const t=window.SEORAP_DATA.tasks.find(t=>t.id==="dv-social-playground");if(t){t.summary="399 마피아 비동기 첫 버전 및 실제 놀이 원형 표시 완료. 실제 지도 동선·감각 기억·고급 모순·다중 사용자 밸런스와 무도회/음악회 등 후속 확장 남음.";}}

window.SEORAP_DATA.tasks.push({"id": "dv-home-opening400", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.348 (400) 홈 놀이 표시·마을 선택·마피아 첫 진술", "summary": "1.0.348(400) 홈 참여 놀이를 프로필 아래 배치, 방장 사진·흰 테두리 글씨·남은 시간·참여 인원. 자아만들기 이름 변경 및 시계 아래 마을 선택. 마피아 첫 회의 아침/점심/저녁/밤 진술과 공개 비교. drawervillage.com c56b9c77 배포, Play release297 9/15 14:31 내부 제공됨. 서버 최종 배포 및 KO/EN/JA·화면/권한/기존 앱 호환 검사 통과. 게임 dev 4032ea9, 신규 문구 EN/JA 각100%."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.348 (공개 웹·Android 내부 테스트)", "code": 400, "date": "2026-09-15", "items": ["참여 게임 위치·방장 사진·시간/인원 표시 개선", "자아만들기 메뉴 및 시계 아래 마을 선택", "마피아 첫 차례에 아침·점심·저녁·밤 진술", "공개 웹 배포·Android400 14:31 내부 테스터 제공됨 / dev4032ea9"]});

window.SEORAP_DATA.documents.push({"id": "dv-home-opening400-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "400 배포·검증·한국어/영어/일본어 출시노트", "description": "1.0.348(400) 홈 참여 놀이를 프로필 아래 배치, 방장 사진·흰 테두리 글씨·남은 시간·참여 인원. 자아만들기 이름 변경 및 시계 아래 마을 선택. 마피아 첫 회의 아침/점심/저녁/밤 진술과 공개 비교. drawervillage.com c56b9c77 배포, Play release297 9/15 14:31 내부 제공됨. 서버 최종 배포 및 KO/EN/JA·화면/권한/기존 앱 호환 검사 통과. 게임 dev 4032ea9, 신규 문구 EN/JA 각100%.", "content": "# 1.0.348 (400) — 홈 참여 게임 · 마을 선택 · 첫 진술\n\n기준: dev ffd485d / Android 399. 새 기능은 dev에만 반영하며 game main은 유지한다.\n\n## 변경\n- 참여 놀이 목록을 실제 프로필 원의 아래로 배치. 일반 테마 버튼 규칙에서 제외하여 미색 네모 배경 제거.\n- 멀티 멤버의 방장 프로필 사진을 원 안에 표시. 사진이 없거나 로드 실패하면 이름 첫 글자. 게임명은 흰색·검은 테두리, 아래에 현재 단계의 남은 시간과 참가 인원/정원.\n- 심리테스트 메뉴를 자아만들기 / Self-discovery / 自分づくり로 변경.\n- 홈 날짜·시간 아래에 내 마을/참여 멀티 선택. 기존 인증된 마을 전환 이벤트 이용.\n- 마피아 회의 첫 라운드는 아침·점심·저녁·밤 진술. 본인 초안을 수정하여 제출하고 NPC/미제출자는 기본 진술. 공개 주장은 개인 증거 카드와 구분하며 전원 진술 후 카드 토론·투표로 이어진다.\n- 이전 앱이 첫 라운드에 기존 토론 동작을 제출해도 기본 진술로 호환. 제출자 소유권/장소/동작 검증과 비밀 역할·카드 분리 유지.\n- 첨부 설계안 전체(60초 동시 턴, 끼어들기, 실제 지도 등)는 이번 UI/첫 진술 요청의 구현 확정으로 취급하지 않음. 기존 비동기 단계 시간 유지.\n\n## 검증\n- check-games400: 네 시간대 순서, 사용자 수정, NPC 기본 진술, 개인 초안/역할 분리, 증거와 주장 구분, 중복 방지, 기존 게임·클라이언트 호환 및 인증/소유권/입력 정규화.\n- check-games399: 100개 seed 완주와 결정론, 게임 권한·NPC 동의·역할/개인 카드·자동 진행 회귀 통과.\n- qa-home400 실제 dist: KO/EN/JA, 360×640·384×854·412×892·1024×768 native preview. 프로필 겹침·사진/흰 글씨/투명 배경·시간/참여 인원·마을 선택 이벤트·기존 서랍/친구/광장 경계 검사.\n- qa-games400 실제 dist Chromium/WebKit: 3개 언어, 계획/첫 진술/카드 토론/투표 화면 경계와 제출 경로 검사.\n- 친구 요청 및 계정 삭제 회귀 통과. AAB의 공통 UI 파일 원본 바이트·400 빌드 표식·jarsigner 서명 확인.\n- 영어/일본어: 이번 변경 문구 각 100%. 전체 앱 번역률은 미측정.\n- iOS 영향: 공통 UI 및 WebKit 검사만 수행. 신규 서명 IPA/스토어 배포 없음.\n- 실제 사용자 계정 간 장시간 멀티 플레이와 밸런스는 미검증.\n\n## 배포\n- 공개 사이트 drawervillage.com: Cloudflare Pages c56b9c77 / web400 배포 완료. 공개 DOM에서 app.js?v=20260915web400, 자아만들기와 모바일 마을 선택·가로 넘침 없음 확인.\n- sharedTownApi: 최종 호환 처리 포함 업데이트 성공.\n- Android: Play 내부 테스트 release297, 2026-09-15 14:31 KST 내부 테스터에게 제공됨 확인. 프로덕션/비공개 테스트 승격 없음.\n- AAB: C:/Users/Public/drawer-releases/drawervillage-1.0.348-400-internal.aab\n- SHA256: b4ef4a74e2c9ff3372454c6fca2a8cdee15e7c7bee8365e4a405419b510a74de\n\n## Play 출시노트\n<ko-KR>\n참여 중인 놀이를 프로필 아래로 옮겼어요. 방장 프로필 사진과 남은 시간·참여 인원을 표시하고 네모 배경을 없앴어요. 심리테스트 이름을 자아만들기로 바꾸고 날짜·시간 아래에 마을 선택을 추가했어요. 마피아 회의 첫 차례에 아침·점심·저녁·밤의 행동을 진술하고, 모두의 진술을 목격 카드와 비교할 수 있어요.\n</ko-KR>\n<en-US>\nMoved joined games below your profile. Game shortcuts show the host’s portrait, time remaining and player count without a square background. Renamed the personality test to Self-discovery and added a village selector below the clock. Mafia meetings now start with statements about the morning, afternoon, evening and night, ready to compare with witness cards.\n</en-US>\n<ja-JP>\n参加中のゲームをプロフィールの下へ移しました。四角い背景をなくし、ホストの写真・残り時間・参加人数を表示します。心理テストの名称を「自分づくり」に変更し、時計の下に村の選択を追加しました。マフィアの会議では最初に朝・昼・夕方・夜の行動を証言し、全員の証言を目撃カードと比較できます。\n</ja-JP>\n"});

window.SEORAP_DATA.tasks.push({"id": "dv-plaza-live402", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "1.0.350 (402) 광장 활동 UI·실시간 턴·멀티 산책 수정", "summary": "1.0.350(402) SVG 참고 광장→함께하는 활동 카드 목록·체크무늬 설정·지도 행동 선택. 새 마피아 일과60초/진술·추리·투표45초, 기존게임시간 유지. 멀티 갱신 시 산책 출발점으로 튀는 현상 재현·수정. 공개web402 f2f6e62a 배포, Play release298 9/15 15:49 내부 제공됨. 401 임시 업로드는 미출시. dev b1fe6aa, 새문구 EN/JA 각100%."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.350 (공개 웹·Android 내부 테스트)", "code": 402, "date": "2026-09-15", "items": ["SVG 참고 활동 카드 목록·체크무늬 설정·지도 행동 선택", "새 게임 일과60초 / 진술·추리·투표45초", "멀티 화면 갱신 시 산책 위치 연속성 수정", "공개 사이트 배포·15:49 내부 테스터 제공됨 / dev b1fe6aa"]});

window.SEORAP_DATA.documents.push({"id": "dv-plaza-live402-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "402 배포·검증·3개 언어 출시노트", "description": "1.0.350(402) SVG 참고 광장→함께하는 활동 카드 목록·체크무늬 설정·지도 행동 선택. 새 마피아 일과60초/진술·추리·투표45초, 기존게임시간 유지. 멀티 갱신 시 산책 출발점으로 튀는 현상 재현·수정. 공개web402 f2f6e62a 배포, Play release298 9/15 15:49 내부 제공됨. 401 임시 업로드는 미출시. dev b1fe6aa, 새문구 EN/JA 각100%.", "content": "# 1.0.350 (402) — 광장 활동 UI · 짧은 마피아 턴 · 멀티 산책 연속성\n\n기준: dev4032ea9 / Android400. 사용자 SVG 3종을 시각 배치 참고로 사용. 원본 SVG의 대용량 임베디드 이미지를 통째로 탑재하지 않고 기존 나무·마을·버튼 에셋과 반응형 DOM으로 구성.\n\n## 변경\n- 홈의 광장 명칭은 유지하고 내부를 함께하는 활동으로 구성. 멀티별/전체 게임 카드 목록, 정렬, 실제 참여 인원, 방장 사진, 멀티 초대 코드 참여.\n- 체크무늬 설정 화면: 게임명/정원/내 참가 캐릭터/게임 장소, 소유자가 허용한 NPC로 충원 후 시작. 기존 자동 참가 허용 설정도 유지.\n- 새 게임 live 모드: 낮 행동 6회, 1회 60초에 장소·행동 하나 제출. 기존 밤 처리는 낮 행동 뒤 진행. 첫 진술·추리2회·투표는 각45초. 서버가 마감 기준으로 진행하며 미제출자는 자동 행동.\n- 이미 만들어진 async 게임은 6/12/24시간 유지. 예전 클라이언트의 6칸 제출은 live 게임에서 첫 행동만 검증·적용하여 입력 오류 방지.\n- 지도 위 장소 선택과 행동 선택. 이동 가능한 이웃 장소만 선택하며 타 장소 선택 시 이동 동작만 허용. 위조 위치나 마피아 전용 동작은 서버에서도 검증.\n- 회의 내용은 밝은 종이 패널로 분리. 라이브 행동 폼은 화면 처음에, 부가 정보/참가자/기록은 펼침 영역에 배치.\n- 산책 애니메이션의 지연값을 목록 순서 대신 절대 시각과 캐릭터/장면 시드로 계산. 멀티 갱신 때 DOM이 다시 만들어져도 같은 경로의 애니메이션 위치 유지.\n\n## 검증\n- check-games401: 60초당 단일 행동, 6회 기록 누적, 45초 첫 진술·추리 단계, 중복 진행 방지, 기존 시간 유지, 실시간 게임30개 완주, live 생성 및 이전 클라이언트 첫 행동 호환.\n- check-games399/400: 기존100개 완주·서버 권한·소유권·NPC 동의·비밀 카드·첫 진술 입력 회귀.\n- qa-games401 실제dist Chromium/WebKit KO/EN/JA: 목록/설정/지도, 작은 화면 경계·1개 행동 제출. qa-games400으로 첫 진술·추리·투표 화면도 확인.\n- qa-home400: 4개 화면 크기 홈·마을 선택·서랍·광장 경계 회귀.\n- qa-movement401: 이전 고정 시작 방식에서 재렌더 이동 점프 검사가 실패함을 확인하고, 수정된 실제 CSS에서 3회 반복 재렌더 위치 연속성 통과.\n- 신규 사용자 문구 EN/JA 각100%. 앱 전체 번역률 미측정.\n- 실사용자 여러 기기의 지연/재접속 장시간 플레이와 재미·밸런스는 별도 테스트 필요. iOS 공통 WebKit 확인, 새 IPA/스토어 업로드 없음.\n\n## 배포\n401은 임시 업로드만 했으며 출시하지 않음. 회의 글씨 대비 보완 후 최종402로 교체.\n- drawervillage.com: Cloudflare f2f6e62a / web402 공개 배포 완료. 실제 공개 DOM에서 app.js?v=20260915web402, 412px 활동 대화상자 폭/나무 배경/카드 grid/가로 넘침 없음 확인.\n- sharedTownApi 서버 업데이트 성공.\n- Android402: Play 내부 테스트 release298 / 2026-09-15 15:49 KST 내부 테스터에게 제공됨 확인. 401은 출시 대상에서 제외했고 프로덕션/비공개 테스트 승격 없음.\n- 서명 AAB 71,417,748 bytes, SHA256 9fc329010c95bab51a2174a1d35831a1c20e681ba25e0f8b7761ca44e049705c. www와 번들 내 UI 파일 바이트 및402표식 일치, jarsigner 통과.\n- 이전 이동 방식의 동일 재렌더 테스트에서 약41.6px 되돌아감 재현; 수정 후3회 반복 위치 연속성 통과.\n\n## Play 출시노트\n<ko-KR>\n광장에 함께하는 활동 화면을 새롭게 꾸몄어요. 게임 카드 목록, 체크무늬 설정 화면, 지도 위 장소·행동 선택을 추가했어요. 새 마피아 게임은 일과 60초, 진술·추리·투표 45초로 진행돼요. 기존 게임의 시간은 유지돼요. 멀티마을 화면이 갱신될 때 산책하던 캐릭터가 출발점으로 튀던 문제를 수정했어요.\n</ko-KR>\n<en-US>\nRedesigned Plaza activities with game cards, a checkered setup screen and map-based location and action choices. New Mafia games use 60-second action turns and 45-second statement, discussion and voting turns. Existing games keep their timing. Fixed walking characters jumping back when the multiplayer town view refreshed.\n</en-US>\n<ja-JP>\n広場の活動画面を一新しました。ゲームカード一覧、チェック柄の設定画面、地図上での場所・行動選択を追加しました。新しいマフィアゲームは行動60秒、証言・推理・投票45秒で進行します。既存ゲームの時間は変わりません。マルチの村の画面更新時に、散歩中のキャラクターが出発点へ戻る問題を修正しました。\n</ja-JP>\n"});

{const t=window.SEORAP_DATA.tasks.find(t=>t.id==="dv-social-playground");if(t){t.summary="402 활동 목록/설정/지도 선택 UI 및 새 게임60초/45초 턴 완료. 실제 지도 이동 고도화·감각 기억·고급 모순·다중 사용자 밸런스와 무도회/음악회 등 후속 확장 남음.";}}

window.SEORAP_DATA.tasks.push({"id": "dv-release403-404", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "405 공개 심사 제출 · 406 내부/TestFlight 제공 완료", "summary": "공개 웹405 배포, Google Play405·App Store405 공개 심사 제출 완료(승인 후 자동 전체 공개). Android 내부406 release299 16:26 제공, TestFlight406 기존 내부 그룹 설치됨 확인. 공개 광장 준비중 / 내부 광장 활성. 대명사·전체설정·홈/마을 버튼 겹침 수정, 우편 전체읽음 디자인·광장/서랍 순서 변경, 과묵한 직설체 젠장 제거, 멀티 캐릭터 생성 반복 저장 대기 감소. Chromium/WebKit 3언어 UI·저장 분기·서명 패키지 검증. 신규 EN/JA100%, 전체 미측정. 게임 dev 반영, 게임 main은 기존 배포 연결 보존.", "version": "1.0.353 / 1.0.354"});
window.SEORAP_DATA.documents.push({"id": "dv-public403-internal404", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "405 공개 / 406 내부 배포 결과·출시노트", "description": "공개 웹405 배포, Google Play405·App Store405 공개 심사 제출 완료(승인 후 자동 전체 공개). Android 내부406 release299 16:26 제공, TestFlight406 기존 내부 그룹 설치됨 확인. 공개 광장 준비중 / 내부 광장 활성. 대명사·전체설정·홈/마을 버튼 겹침 수정, 우편 전체읽음 디자인·광장/서랍 순서 변경, 과묵한 직설체 젠장 제거, 멀티 캐릭터 생성 반복 저장 대기 감소. Chromium/WebKit 3언어 UI·저장 분기·서명 패키지 검증. 신규 EN/JA100%, 전체 미측정. 게임 dev 반영, 게임 main은 기존 배포 연결 보존.", "content": "# 공개405 / 내부406\n\n공개1.0.353(405), 내부1.0.354(406). 개발 dev; 공개 앱 업데이트는 사용자 명시 요청에 따라 진행.\n\n## 완료한 수정\n- 과묵한 직설체의 젠장 제거: 예문·관계 편지 원본과 생성 대사 필터. 영어 감탄사도 대응 정리.\n- 전체 설정의 기본 프로필: 고정 그림 좌표에서 스크롤 2열 폼으로 변경. 성별/성지향 아래 대명사 버튼. 간단한 프로필 팝업과 전체설정 각각 배치를 검증.\n- 홈 멀티 선택과 마을 선택 버튼을 상단 표시와 분리. 광장·서랍 순서 교체. 우편 전체읽음은 종이색 체크 버튼.\n- 멀티 캐릭터 생성: 개인 목록/마을/이동 revision이 core와 같으면 전체 업로드를 반복하지 않음. 다른 경우 기존 저장을 먼저 수행하며 서버 슬롯/승인 검증 유지.\n- 공개 웹·스토어 빌드 광장은 준비 중 안내, 게임 목록 조회 생략. 내부 빌드만 실제 활동 사용.\n\n## 검증\n- qa-ui403: dist Chromium/WebKit, KO/EN/JA ×384×854/360×640/1024×768. 전체설정·간단프로필 각각 대명사 popup, 닫기, 너비, 성별 아래 순서. 공개 광장 준비중.\n- qa-home400: 4 viewport, 게임/프로필 간격, 멀티선택/시간/우측메뉴 간격 및 세 언어.\n- qa-release405: 마을·우편384×854, 실제 렌더 사진 확인. 제목과 마을 선택 버튼 분리, 전체 읽음 버튼 디자인.\n- qa-games401: 내부 채널 활성화된 dist 활동 목록/설정/지도·1회 행동 제출, 세 언어. 기존 live60초/45초 규칙 유지.\n- check-resident403: 서버와 같은 roster 생략, 목록/이동 revision/누락 상태에서 저장 수행, 저장 실패·계정 전환 시 생성 중단.\n- Android405/406 signed bundleRelease 성공. 패키지의 광장 false/true 및 수정 파일 일치 검증, jarsigner 확인.\n- 실제 사용자 네트워크 시간 개선율/실기기 조작은 별도이며 측정한 것으로 표현하지 않음.\n- 바뀐 문구 EN/JA100%; 전체 앱 번역률 미측정.\n\n## 배포 결과\n- drawervillage.com web405 c0877be3 배포. 실제 공개 DOM에서 app.js?v=20260915web405 및 광장 준비 중 안내 확인.\n- Google Play405 100% 공개 출시 검토 전송, 현재 검토 중인 변경사항/사전 자동검사 대기. 403 초안 제외, 일반 사용자 미출시.\n- Google Play406 release299, 2026-09-15 16:26 KST 내부 테스터에게 제공됨 확인.\n- Apple405 Actions34940842211 / 내부406 Actions34940995345 모두 서명·검증·업로드 성공. App Store Connect 처리 완료. 406 기존 내부 그룹에서 설치됨 확인. 405 공개 심사 제출 완료(2026-09-15 16:38 KST). 제출 ID 808e87ff-c1f6-4a29-a9ea-dc8827eac2d7. 승인 후 자동 전체 공개. 이전391 제출은 교체를 위해 취소.\n\n\n## 공개 출시노트\n<ko-KR>\n대명사 설정을 버튼과 팝업으로 정리하고 전체 설정의 겹침을 수정했어요.\n홈 메뉴를 새로 배치하고 광장과 서랍 위치를 바꿨어요. 자아만들기, 친구 코드와 요청·수락, 우편 전체 읽음을 이용할 수 있어요.\n마을 선택 버튼과 지도 화면, 이름표·착석 표시를 다듬었어요. 멀티 캐릭터 생성 시 불필요한 저장 대기를 줄였어요.\n공유코드 불러오기와 멀티 집 삭제를 수정하고, 성격에 맞는 포옹과 같은 주제의 대화를 보강했어요.\n언어별 말투·대명사 표현을 추가하고 과묵한 직설체에서 ‘젠장’을 뺐어요.\n공개 버전의 광장 활동은 준비 중입니다.\n</ko-KR>\n<en-US>\nPronoun settings open in a popup; detailed profile layout is clearer.\nReorganized home menus, friend codes and requests, Self-discovery and Mark all as read.\nImproved town selectors, map sizing and name cards. Reduced unnecessary saving waits for multiplayer character creation.\nFixed shared-code imports and multiplayer home deletion. Added shared conversation topics and personality-aware hugs.\nUpdated voices and removed “damn” from the blunt voice.\nPlaza activities are coming soon.\n</en-US>\n<ja-JP>\n代名詞の設定をボタンとポップアップに整理し、詳細設定の表示崩れを修正しました。\nホームメニューを整理し、広場と引き出しの位置を入れ替えました。自分づくり、フレンドコード・申請・承認、郵便の一括既読を利用できます。\n村の選択ボタン、地図、名前表示を調整し、マルチでキャラクターを作る際の不要な保存待ちを減らしました。\n共有コードの読み込みとマルチの家の削除を修正。共通の話題での会話や性格に合うハグを充実させました。\n言語別の口調と代名詞表現を更新しました。\n公開版の広場の遊びは準備中です。\n</ja-JP>\n\n## 내부 출시노트\n<ko-KR>\n공개용 405의 대명사 설정·전체 설정 배치, 마을 선택 버튼, 우편 전체 읽음 버튼 개선을 반영했어요.\n광장과 서랍 위치를 바꾸고, 과묵한 직설체에서 ‘젠장’을 뺐어요.\n멀티 캐릭터 생성 시 불필요한 클라우드 저장 대기를 줄였어요.\n내부 테스트에서는 광장 활동과 마피아 놀이를 계속 이용할 수 있어요. 일과 60초, 진술·추리·투표 45초 규칙을 유지해요.\n</ko-KR>\n<en-US>\nIncludes public 405's pronoun popup, detailed profile layout, town selector and Mark all as read improvements.\nSwapped Plaza and Drawer and removed “damn” from the blunt voice.\nReduced unnecessary cloud-saving waits when creating multiplayer characters.\nPlaza activities and Mafia remain available in internal testing, with 60-second actions and 45-second statement, discussion and voting turns.\n</en-US>\n<ja-JP>\n公開用405の代名詞ポップアップ、詳細設定、村の選択ボタン、郵便の一括既読ボタンの改善を反映しました。\n広場と引き出しを入れ替え、口数の少ない直接的な口調の表現を調整しました。\nマルチでキャラクターを作る際の不要なクラウド保存待ちを減らしました。\n内部テストでは広場とマフィアを引き続き利用できます。行動60秒、最初の証言・推理・投票45秒のルールを維持しています。\n</ja-JP>\n"});
window.SEORAP_DATA.updates.unshift({"version": "1.0.353 공개 심사 / 1.0.354 내부 테스트", "code": 406, "date": "2026-09-15", "items": ["공개 웹405 반영 · Google Play/App Store405 심사 제출 완료, 승인 후 자동 공개", "Android 내부406 제공 · TestFlight406 제공 및 설치 확인", "공개 광장 준비중, 내부 광장 유지 · 서랍/광장 위치 교체", "대명사 전체설정·상단바 겹침·우편 전체읽음 디자인 개선", "과묵한 직설체 젠장 제거 · 멀티 캐릭터 생성 반복 저장 대기 감소"]});

window.SEORAP_DATA.tasks.push({"id": "dv-release407", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "407 · 장소와 생활로그 일치 / 마피아 이동·실내 행동 분리", "summary": "dev 1e37674 구현·검증 완료. 1.0.355(407) Android 서명 AAB 빌드 완료, Play 내부 테스터 제공9/17 20:15(release329). TestFlight Mac 빌드 실행 중. 공개웹 광장 준비중 유지, 미색 안내 및 생활로그 수정 배포 중."});
window.SEORAP_DATA.updates.unshift({"version": "1.0.355 (407) 내부 테스트 준비", "code": 407, "date": "2026-09-15", "items": ["동거인의 실제 장소·방 확인, 병원 일정 중 집 생활 로그 제외", "혼자 있을 때 상대를 전제한 성격 대사 수정", "만나기 전 이동·대기 문구를 함께 행동하는 번역이 덮던 오류 수정", "마을에서 직접 건물 선택 60초 → 동석자 확인 후 실내 행동 15초", "임무·서로 카드 교환·흔적·발견회의·첫 진술, 공개 광장 미색 준비중 안내", "새 문구 EN100% JA100%, 배포 검증 진행 중"]});

window.SEORAP_DATA.documents.push({"id": "dv-release407-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "407 · 생활로그·마피아 변경 및 출시노트", "description": "Android 내부407 제공, 공개 웹407 적용. Apple 처리 확인 중.", "content": "# 1.0.355 (407) · 장소에 맞는 생활 로그 / 마피아 이동·실내 행동\n\n개발 dev. Android 및 Apple 내부 테스트 수정판. 공개 앱405 심사 요청은 유지한다.\n\n## 수정한 내용\n- 일정 중에 자동으로 생성된 집 생활 문구가 생활 로그에 끼어들지 않도록 표시 경로를 수정했다.\n- 동거인이라는 이유만으로 함께 있는 것으로 처리하지 않고 실제 집·방·건물과 상대의 일정을 확인한다.\n- 혼자 있을 때 상대를 전제로 한 성격 대사를 혼자 하는 장면으로 바꾼다. 기존 profileScene 기록에도 표시 시 확인을 적용한다.\n- 이동·대기 문구를 도착 후 함께 행동하는 번역이 덮어쓰던 오류를 수정했다.\n- 공개 광장 준비 중 제목과 설명을 미색으로 바꿨다.\n- 새 마피아 게임: 실제 마을의 건물 좌표·그림으로 이동 선택 60초 → 건물 안 동석자 확인·행동 15초. 이동 중 타인의 위치와 비공개 카드는 서버 응답에서 제외한다. 기존 게임은 기존 규칙을 유지한다.\n- 인원−2(최소4·최대8)곳 무대, 개인 임무3개·공동 임무·연속2턴 임무, 귀가·늦은 밤 추가 턴.\n- 상호 선택으로 카드 교환, 출처 기록, 흔적 조사·기척·흔적 지우기·물건 흘리기. 습격은 첫날 금지, 하루1회, 건물에 단둘일 때만 가능.\n- 발견·광장 긴급회의·아침 회의. 처음에는 아침·점심·저녁·밤 진술 후 카드 토론과 투표.\n- 서버 보완: 이전 형식의 거주지 연결도 귀가 장소에 반영. 퇴장자의 미완료 임무 때문에 시민 임무 승리가 막히지 않도록 남은 시민 기준으로 계산.\n\n## 검증\n- check-presence407: 부재 동거인 양쪽, 병원 시간대 로그, 기존 독거 성격 대사, KO/EN/JA.\n- check-shared-life: 200명 계산, 이동·대기·도착 후 식사, 병원 일정 경계, 반대 방향 명령, 혼자 하는 행동으로 변경.\n- check-games407: 60/15초 마감, 위치·카드 비공개, 습격 조건, 발견회의, 양방향 카드 교환·출처, 30게임 완주.\n- check-games401: 기존 규칙과 기존 클라이언트 입력 호환, 신규 게임 생성 API.\n- qa-games407 Chromium/WebKit: KO/EN/JA, 384px, 지도 직접 선택, 실내 동석자, 네 구간 첫 진술, 가로 넘침 검사. 화면 이미지 확인.\n- 서명 AAB의 내부 광장 플래그·새 화면·장소 판정·이동 대기 수정 파일 포함 확인.\n- 새 화면 문구 세 언어 포함. 전체 앱 번역률, 실제 여러 사용자 장시간 밸런스 및 실기기 조작은 측정하지 않았다.\n\n## 배포\n- Android407 release300: 2026-09-15 18:25 KST 내부 테스터에게 제공됨 확인.\n- 공개 웹407: Cloudflare 11df3f77 배포. 실제 사이트 DOM app.js?v=20260915web407, 준비 중 제목·설명 rgb(255,241,214) 확인.\n- 공통 서버 업데이트 적용. 마지막 거주지/임무 보완 배포 상태는 최종 기록에서 확인.\n- Apple407: Mac Actions34952166788 빌드·업로드 진행 중. 완료 확인 후 기록 갱신.\n- 소스 1e37674. 게임 main은 운영 브랜치 정책에 따라 합치지 않음. 작업판은 main 반영.\n\n\n## Play 출시노트\n\n<ko-KR>\n실제 장소와 맞지 않던 생활 로그를 수정했습니다. 일정으로 자리를 비운 동거인과 함께 있는 듯한 표현과, 만나기 전부터 함께 행동하는 문구를 바로잡았습니다.\n광장 준비 중 안내를 밝은 미색으로 바꿨습니다.\n내부 마피아는 마을에서 이동 선택 60초, 건물 안 행동 15초로 바뀝니다. 임무, 동석자, 카드 교환, 흔적 조사와 첫 진술을 새 흐름에 맞췄습니다.\n</ko-KR>\n<en-US>\nFixed life logs that did not match a character’s location, including absent housemates and interactions shown before arrival.\nThe plaza’s coming-soon notice now uses light cream text.\nInternal Mafia games now use 60-second destination selection and 15-second actions inside buildings, with tasks, occupants, card exchanges, traces and opening statements.\n</en-US>\n<ja-JP>\n現在地と合わない生活ログを修正しました。予定で不在の同居人と一緒にいる表現や、到着前から一緒に行動する表示を直しました。\n広場の準備中案内を明るいクリーム色にしました。\n内部テストのマフィアは、村で移動先を選ぶ60秒と建物内で行動する15秒に分かれます。任務、同席者、カード交換、痕跡調査、最初の証言を新しい流れに合わせました。\n</ja-JP>\n"});

Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==="dv-release407"),{"completed": true, "summary": "1.0.355(407) Android 내부 release300 18:25 제공, TestFlight407 처리·기존 내부 그룹 제공 확인. 공개웹407(11df3f77) 및 서버 반영. 신규 UI 입력/안내 문구 EN/JA100%, 전체 앱 번역률·실기기 조작·장기 밸런스는 미측정."});
Object.assign(window.SEORAP_DATA.documents.find(d=>d.id==="dv-release407-notes"),{"description": "1.0.355(407) Android 내부 release300 18:25 제공, TestFlight407 처리·기존 내부 그룹 제공 확인. 공개웹407(11df3f77) 및 서버 반영. 신규 UI 입력/안내 문구 EN/JA100%, 전체 앱 번역률·실기기 조작·장기 밸런스는 미측정.", "content": "# 1.0.355 (407) · 장소에 맞는 생활 로그 / 마피아 이동·실내 행동\n\n개발 dev. Android 및 Apple 내부 테스트 수정판. 공개 앱405 심사 요청은 유지한다.\n\n## 수정한 내용\n- 일정 중에 자동으로 생성된 집 생활 문구가 생활 로그에 끼어들지 않도록 표시 경로를 수정했다.\n- 동거인이라는 이유만으로 함께 있는 것으로 처리하지 않고 실제 집·방·건물과 상대의 일정을 확인한다.\n- 혼자 있을 때 상대를 전제로 한 성격 대사를 혼자 하는 장면으로 바꾼다. 기존 profileScene 기록에도 표시 시 확인을 적용한다.\n- 이동·대기 문구를 도착 후 함께 행동하는 번역이 덮어쓰던 오류를 수정했다.\n- 공개 광장 준비 중 제목과 설명을 미색으로 바꿨다.\n- 새 마피아 게임: 실제 마을의 건물 좌표·그림으로 이동 선택 60초 → 건물 안 동석자 확인·행동 15초. 이동 중 타인의 위치와 비공개 카드는 서버 응답에서 제외한다. 기존 게임은 기존 규칙을 유지한다.\n- 인원−2(최소4·최대8)곳 무대, 개인 임무3개·공동 임무·연속2턴 임무, 귀가·늦은 밤 추가 턴.\n- 상호 선택으로 카드 교환, 출처 기록, 흔적 조사·기척·흔적 지우기·물건 흘리기. 습격은 첫날 금지, 하루1회, 건물에 단둘일 때만 가능.\n- 발견·광장 긴급회의·아침 회의. 처음에는 아침·점심·저녁·밤 진술 후 카드 토론과 투표.\n- 서버 보완: 이전 형식의 거주지 연결도 귀가 장소에 반영. 퇴장자의 미완료 임무 때문에 시민 임무 승리가 막히지 않도록 남은 시민 기준으로 계산.\n\n## 검증\n- check-presence407: 부재 동거인 양쪽, 병원 시간대 로그, 기존 독거 성격 대사, KO/EN/JA.\n- check-shared-life: 200명 계산, 이동·대기·도착 후 식사, 병원 일정 경계, 반대 방향 명령, 혼자 하는 행동으로 변경.\n- check-games407: 60/15초 마감, 위치·카드 비공개, 습격 조건, 발견회의, 양방향 카드 교환·출처, 30게임 완주.\n- check-games401: 기존 규칙과 기존 클라이언트 입력 호환, 신규 게임 생성 API.\n- qa-games407 Chromium/WebKit: KO/EN/JA, 384px, 지도 직접 선택, 실내 동석자, 네 구간 첫 진술, 가로 넘침 검사. 화면 이미지 확인.\n- 서명 AAB의 내부 광장 플래그·새 화면·장소 판정·이동 대기 수정 파일 포함 확인.\n- 새 화면 문구 세 언어 포함. 전체 앱 번역률, 실제 여러 사용자 장시간 밸런스 및 실기기 조작은 측정하지 않았다.\n\n## 배포\n- Android407 release300: 2026-09-15 18:25 KST 내부 테스터에게 제공됨 확인.\n- 공개 웹407: Cloudflare 11df3f77 배포. 실제 사이트 DOM app.js?v=20260915web407, 준비 중 제목·설명 rgb(255,241,214) 확인.\n- 공통 서버 업데이트 완료. 거주지/임무 보완 cc81827도 재배포 성공.\n- Apple407: Mac Actions34952166788 서명·검증·업로드 성공. App Store Connect 처리 완료 및 암호화 정보 저장. TestFlight 테스트 준비 완료, 기존 내부 그룹에서 1.0.355(407) 설치됨 표시 확인. 실기기 조작 검증을 수행한 것은 아님.\n- 소스 1e37674. 게임 main은 운영 브랜치 정책에 따라 합치지 않음. 작업판은 main 반영.\n\n\n## Play 출시노트\n\n<ko-KR>\n실제 장소와 맞지 않던 생활 로그를 수정했습니다. 일정으로 자리를 비운 동거인과 함께 있는 듯한 표현과, 만나기 전부터 함께 행동하는 문구를 바로잡았습니다.\n광장 준비 중 안내를 밝은 미색으로 바꿨습니다.\n내부 마피아는 마을에서 이동 선택 60초, 건물 안 행동 15초로 바뀝니다. 임무, 동석자, 카드 교환, 흔적 조사와 첫 진술을 새 흐름에 맞췄습니다.\n</ko-KR>\n<en-US>\nFixed life logs that did not match a character’s location, including absent housemates and interactions shown before arrival.\nThe plaza’s coming-soon notice now uses light cream text.\nInternal Mafia games now use 60-second destination selection and 15-second actions inside buildings, with tasks, occupants, card exchanges, traces and opening statements.\n</en-US>\n<ja-JP>\n現在地と合わない生活ログを修正しました。予定で不在の同居人と一緒にいる表現や、到着前から一緒に行動する表示を直しました。\n広場の準備中案内を明るいクリーム色にしました。\n内部テストのマフィアは、村で移動先を選ぶ60秒と建物内で行動する15秒に分かれます。任務、同席者、カード交換、痕跡調査、最初の証言を新しい流れに合わせました。\n</ja-JP>\n"});
Object.assign(window.SEORAP_DATA.updates.find(u=>u.code===407),{"version": "1.0.355 (407) 내부 테스트 제공 완료", "items": ["Android407 내부 테스터 제공 / TestFlight407 기존 내부 그룹 제공 확인", "공개웹407·서버 적용, 공개 광장 준비중 미색 안내", "부재 동거인·독거·병원 생활로그 수정, 만나기 전 이동·대기 표시 복구", "마을 직접 선택60초 → 실내 동석자 확인·행동15초, 임무·카드 교환·흔적·첫 진술", "개발 dev 반영, 공개 앱405 심사 유지, 작업판 main 반영"]});

window.SEORAP_DATA.tasks.push({"id": "dv-release408", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "408 · 캐릭터 팝업 / 마피아 선택·연출·추리 화면", "summary": "dev 1.0.356 (408): 45초 이동·행동 선택, 연출 분리, 2초 NPC 진행, 자동 알리바이·선착순 지적, 실제 집 배치와 SVG 추리 화면. 검증 및 내부 배포 진행."});

window.SEORAP_DATA.updates.unshift({"version": "1.0.356 (408) 내부 배포 진행", "code": 408, "date": "2026-09-15", "items": ["캐릭터 팝업 화면 이탈 수정", "마피아 이동45초 → 이동 연출 → 행동45초 → 결과 연출", "전원 선택 즉시 진행 / 1인+NPC 선택2초 후 진행", "실제 방·가구 표시, 추리 SVG 구성, 카드 획득·시신·관전", "자동 알리바이 후보와 선착순 지적, 마피아 익명 인원 힌트", "공개 웹408 적용, 서버 배포 완료; Android·Apple 내부 업로드 진행"]});
window.SEORAP_DATA.documents.push({"id": "dv-release408-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "408 · 팝업 및 마피아 개선", "description": "1.0.356 / 408 검증·배포 기록", "content": "# 1.0.356 (408) · 팝업 위치 / 마피아 선택·연출·추리\n\n개발 dev. 새 마피아 게임에 규칙 v3 적용. 진행 중인 v1/v2 게임은 기존 규칙을 유지한다.\n\n- 캐릭터 팝업을 visual viewport와 원래 캐릭터 위치에 맞춰 다시 배치한다. 내용 증가·화면 크기 변경·키보드 영역 변화 때 화면 안에 유지한다.\n- 이동 선택45초 → 걷기 연출3.5초 → 행동 선택45초 → 결과 연출6초. 선택 시간과 연출 단계가 분리된다.\n- 모든 직접 참가자가 선택하면 즉시 전환. 한 사용자와 NPC 조합은 선택2초 후 전환한다.\n- 진행 확인과 행동 제출이 화면 전체를 로딩 문구로 교체하지 않는다. 같은 단계의 화면·카드 선택을 유지한다. 상태가 바뀌지 않은 진행 조회는 서버에 다시 저장하지 않는다.\n- 마을 건물 그림·좌표, 집의 방 배치·바닥·가구 렌더러를 사용한다. 건물·가구·캐릭터를 눌러 선택한다.\n- 살해 우선 연출, 현장의90도 시신 표시, 피해자 관전. 첫날에도 단둘인 시민을 하루1회 습격할 수 있다.\n- 마피아 전용 익명 인원수, 임무 집중 장소, 직전 혼자 있었던 건물 정보.\n- 회의 전 알리바이 정비: 가진 카드에서 함께 있었음 / 방문했던 건물 / 기억 안 남을 선택한다. 미제출 시 자동 선택한다.\n- 한 명씩 말투를 적용한 알리바이를 말한다. 모순되는 카드를 가진 사람만 지적 예약을 할 수 있고 첫 예약자가 발언 뒤 근거 카드를 낸다.\n- 추리 SVG의 참가자 줄·발언 캐릭터·말풍선·끼어들기·하단 손패 구성. 제공받은 종이 그림을 카드에 사용한다.\n- 결과 단계에서 새 카드 획득 연출과 짧은 설명을 표시한다.\n\n## 검증\n- check-games408: 45초·2초·전원 제출, 연출 중 입력 거절, 첫날 습격·시신·비공개 정보, 알리바이 검증, 선착순 예약 및30판 완주.\n- check-games407 / check-games401: 이전 규칙과 API 회귀 검사.\n- qa-games408 Chromium/WebKit: KO/EN/JA, 384×832, 실제 방 가구 클릭, 지도 선택, 알리바이 제출, 추리 배치와 화면 넘침.\n- qa-popup408 Chromium/WebKit: KO/EN/JA, 384×832 / 384×450 / 320×568, 팝업 내용 증가 후 화면 안 배치.\n- Android 모듈·에셋 포함 검사, 서명 빌드 성공.\n\n신규 고정 UI 문구 영어·일본어 포함. 기존 건물·방·캐릭터 이름은 사용자 작성값을 유지한다. 전체 앱 번역률은 재측정하지 않았다. 실제 여러 사용자 장기 플레이 밸런스와 Android/iOS 실기기 조작은 별도 확인이 필요하다.\n\n## 배포 상태\n내부 Android408 및 TestFlight408 업로드 준비. 공개 앱405 승격·심사 설정은 변경하지 않는다. 공개 웹은 광장 준비 중을 유지한다.\n\n\n<ko-KR>\n캐릭터 창이 화면 위로 밀리던 문제를 수정했습니다.\n새 마피아 게임은 이동·행동 선택 각각45초와 별도의 연출 단계로 진행됩니다. 모두 선택하면 바로, 혼자 NPC와 플레이하면 선택2초 후 넘어갑니다.\n실제 마을·집에서 직접 선택하고, 추리 화면과 카드 획득 연출을 바꿨습니다. 알리바이는 목록에서 고르며 지적은 선착순으로 예약합니다. 마피아 전용 인원 정보를 추가하고 첫날 습격을 허용했습니다.\n</ko-KR>\n<en-US>\nFixed character popups moving off-screen.\nNew Mafia games have 45-second movement and action choices with separate playback. All players ready advances immediately; solo play with NPCs advances after 2 seconds.\nChoose directly in village and home scenes. Updated the deduction screen, card collection, suggested alibis and first-come objections. Mafia players receive anonymous occupancy hints and can strike on day one.\n</en-US>\n<ja-JP>\nキャラクターのウィンドウが画面外にずれる問題を修正しました。\n新しいマフィアは移動先・行動の選択が各45秒、演出は別の段階です。全員選択で即進行、NPCとの1人プレイは選択2秒後に進みます。\n村・家で直接選ぶ画面、推理画面、カード入手演出を更新しました。アリバイは候補から選び、指摘は先着で予約します。マフィア専用の匿名人数情報を追加し、初日の襲撃を可能にしました。\n</ja-JP>\n"});

Object.assign(window.SEORAP_DATA.tasks.find(x=>x.id==="dv-release408"),{"completed": true, "summary": "Android·TestFlight408 내부 제공 확인. 웹·서버 배포 완료. 팝업·새 마피아 규칙·3언어 UI 검증. 게임 dev, 작업판 main."});
Object.assign(window.SEORAP_DATA.updates.find(x=>x.code===408),{"version": "1.0.356 (408) 내부 테스트 제공 완료", "items": ["Android408 release301 내부 테스터 제공 / TestFlight408 기존 내부 그룹 제공 확인", "공개 웹408 b9aaaf79 및 서버 적용; 공개 광장은 준비 중 유지", "캐릭터 팝업 화면 이탈 수정, 3언어·3화면 크기 확인", "새 마피아45초 선택·연출 분리, 전원 즉시/1인+NPC 2초 진행", "실제 집·가구와 SVG 추리 구성, 알리바이 후보·선착순 지적·시신·카드 연출", "게임 dev 반영; 작업판 main 반영. 새 규칙은408에서 생성한 게임부터 적용"]});
Object.assign(window.SEORAP_DATA.documents.find(x=>x.id==="dv-release408-notes"),{"description": "Android·TestFlight408 내부 제공 / 웹·서버 적용 완료", "content": "# 1.0.356 (408) · 팝업 위치 / 마피아 선택·연출·추리\n\n개발 dev. 새 마피아 게임에 규칙 v3 적용. 진행 중인 v1/v2 게임은 기존 규칙을 유지한다.\n\n- 캐릭터 팝업을 visual viewport와 원래 캐릭터 위치에 맞춰 다시 배치한다. 내용 증가·화면 크기 변경·키보드 영역 변화 때 화면 안에 유지한다.\n- 이동 선택45초 → 걷기 연출3.5초 → 행동 선택45초 → 결과 연출6초. 선택 시간과 연출 단계가 분리된다.\n- 모든 직접 참가자가 선택하면 즉시 전환. 한 사용자와 NPC 조합은 선택2초 후 전환한다.\n- 진행 확인과 행동 제출이 화면 전체를 로딩 문구로 교체하지 않는다. 같은 단계의 화면·카드 선택을 유지한다. 상태가 바뀌지 않은 진행 조회는 서버에 다시 저장하지 않는다.\n- 마을 건물 그림·좌표, 집의 방 배치·바닥·가구 렌더러를 사용한다. 건물·가구·캐릭터를 눌러 선택한다.\n- 살해 우선 연출, 현장의90도 시신 표시, 피해자 관전. 첫날에도 단둘인 시민을 하루1회 습격할 수 있다.\n- 마피아 전용 익명 인원수, 임무 집중 장소, 직전 혼자 있었던 건물 정보.\n- 회의 전 알리바이 정비: 가진 카드에서 함께 있었음 / 방문했던 건물 / 기억 안 남을 선택한다. 미제출 시 자동 선택한다.\n- 한 명씩 말투를 적용한 알리바이를 말한다. 모순되는 카드를 가진 사람만 지적 예약을 할 수 있고 첫 예약자가 발언 뒤 근거 카드를 낸다.\n- 추리 SVG의 참가자 줄·발언 캐릭터·말풍선·끼어들기·하단 손패 구성. 제공받은 종이 그림을 카드에 사용한다.\n- 결과 단계에서 새 카드 획득 연출과 짧은 설명을 표시한다.\n\n## 검증\n- check-games408: 45초·2초·전원 제출, 연출 중 입력 거절, 첫날 습격·시신·비공개 정보, 알리바이 검증, 선착순 예약 및30판 완주.\n- check-games407 / check-games401: 이전 규칙과 API 회귀 검사.\n- qa-games408 Chromium/WebKit: KO/EN/JA, 384×832, 실제 방 가구 클릭, 지도 선택, 알리바이 제출, 추리 배치와 화면 넘침.\n- qa-popup408 Chromium/WebKit: KO/EN/JA, 384×832 / 384×450 / 320×568, 팝업 내용 증가 후 화면 안 배치.\n- Android 모듈·에셋 포함 검사, 서명 빌드 성공.\n- 실제 컨트롤러 제출·주기 조회 후 동일 DOM과 선택 팝업 유지 검사(Chromium/WebKit).\n\n신규 고정 UI 문구 영어·일본어 포함. 기존 건물·방·캐릭터 이름은 사용자 작성값을 유지한다. 전체 앱 번역률은 재측정하지 않았다. 실제 여러 사용자 장기 플레이 밸런스와 Android/iOS 실기기 조작은 별도 확인이 필요하다.\n\n## 배포 상태\nAndroid408 release301: 2026-09-15 20:34 KST 내부 테스터에게 제공됨 확인.\n공개 웹408 Cloudflare b9aaaf79 배포 및 실제 app.js?v=20260915web408 확인.\nsharedTownApi 서버 배포 완료.\nTestFlight408 Mac Actions34963559344 서명·검증·업로드 성공. App Store Connect 처리 완료, 암호화 정보 저장 후 테스트 준비 완료. 기존 내부 그룹에 1.0.356(408) 설치됨 표시 확인. 실기기 조작 QA를 수행했다는 뜻은 아니다. 공개 앱405 승격·심사 설정은 변경하지 않는다. 공개 웹은 광장 준비 중을 유지한다.\n\n소스 af39291 · 게임 dev 반영. 작업판은 main 반영.\n\n\n<ko-KR>\n캐릭터 창이 화면 위로 밀리던 문제를 수정했습니다.\n새 마피아 게임은 이동·행동 선택 각각45초와 별도의 연출 단계로 진행됩니다. 모두 선택하면 바로, 혼자 NPC와 플레이하면 선택2초 후 넘어갑니다.\n실제 마을·집에서 직접 선택하고, 추리 화면과 카드 획득 연출을 바꿨습니다. 알리바이는 목록에서 고르며 지적은 선착순으로 예약합니다. 마피아 전용 인원 정보를 추가하고 첫날 습격을 허용했습니다.\n</ko-KR>\n<en-US>\nFixed character popups moving off-screen.\nNew Mafia games have 45-second movement and action choices with separate playback. All players ready advances immediately; solo play with NPCs advances after 2 seconds.\nChoose directly in village and home scenes. Updated the deduction screen, card collection, suggested alibis and first-come objections. Mafia players receive anonymous occupancy hints and can strike on day one.\n</en-US>\n<ja-JP>\nキャラクターのウィンドウが画面外にずれる問題を修正しました。\n新しいマフィアは移動先・行動の選択が各45秒、演出は別の段階です。全員選択で即進行、NPCとの1人プレイは選択2秒後に進みます。\n村・家で直接選ぶ画面、推理画面、カード入手演出を更新しました。アリバイは候補から選び、指摘は先着で予約します。マフィア専用の匿名人数情報を追加し、初日の襲撃を可能にしました。\n</ja-JP>\n"});

window.SEORAP_DATA.tasks.push({"id": "release409", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "1.0.357 (409) 내부 테스트", "summary": "멀티 실제 동석 로그·마피아 연결 회의와 모집 화면 개선. 검증 통과, Android/iOS 내부 배포 진행 중."});
window.SEORAP_DATA.updates.unshift({"version": "1.0.357", "code": 409, "date": "2026-09-15", "items": ["멀티 서버 로그의 일정·동석 검사", "마피아 지목 응답·증거 개입·반박·동의, 회의 최대300초", "모집 좌석·바로 시작·선택 표시·건물/실내 개선", "내부 테스트 배포 진행 중"]});

Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==="release409"),{"completed": true, "summary": "1.0.357(409): Android 내부 테스트 release302 제공, TestFlight 기존 내부 그룹 제공, 웹 web409·서버 배포 완료. 실제 장소 로그 및 연결 회의·모집·실내 개선. 게임 dev, 작업판 main."});
Object.assign(window.SEORAP_DATA.updates.find(u=>u.code===409),{"items": ["같은 집이어도 실제 장소가 다른 상대와의 생활로그를 서버 저장 단계에서 확인", "마피아 지목 답변→증거 개입→반박·동의, 회의 최대300초", "6명 게임 활동장소3곳, 이동 미선택은 머무르기", "모집 좌석·바로 시작·선택 피드백·외관/실내 개선", "Android409 내부 제공·TestFlight409 제공·웹 web409 및 서버 배포 완료"]});
window.SEORAP_DATA.documents.push({"id": "release409-record", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.357 (409) 배포와 출시 노트", "description": "2026-09-15 Android·Apple 내부 테스트 / 웹 / 서버", "content": "# 1.0.357 (409) · 실제 동석 로그와 이어지는 마피아 회의\n\n작업 브랜치 dev. 새 게임은 규칙 v4, 진행 중인 v1/v2/v3은 유지.\n\n- 멀티 서버가 저장하는 생활로그에서도 일정 중 집 활동과 실제 장소가 다른 상대를 걸러냄. 기상 습관이 없는 동거인을 만들어내지 않도록 수정.\n- 한 진술 안에서 상대 확인·부인·기억 안 남 → 증거 개입 → 진술자 반박 → 다른 참가자 동의가 이어짐. 공개 증거와 대화는 회의 기록으로 다시 읽을 수 있음.\n- 회의 전체 최대300초, 마지막20초는 확인이 부족한 참가자의 설명 뒤 투표. 의심 수치는 유죄 판정이 아님.\n- 6명일 때 활동 장소3곳, 사용자 이동 미선택 시 현재 허용 장소에 머무름. 임무 달성 승리는 회의/투표 이후 판정.\n- 모집 화면을 참가자 좌석 중심으로 교체. NPC 충원 시작 성공 응답에서 바로 게임으로 연결. 활동 제목의 중복 바깥 틀 제거.\n- 선택 즉시 저장 중 표시와 목적지 강조. 외관의 사용자 지정 모양·이미지 경로 지원 확대. 실내 사진 없는 카페·병원·도서관은 가구가 있는 실내를 표시.\n- 이전 기본 사전 ID food-malatang 항목만 김밥으로 정정하며 참조 ID는 유지. 사용자 직접 작성 항목은 유지.\n\n## 검증\n- check-games409: 3개 장소, 이동 미선택, 지목 응답 권한, 선착순 증거, 반박·동의, 300초 제한, 개인 카드 비공개, 20판 완주.\n- check-games408/407/401: 이전 규칙과 이전 클라이언트 API 회귀 검사 통과.\n- check-presence409: 같은 집의 외출자·남은 사람·독거와 병원 일정 검사, 서버가 직렬화한 실제 lifeJson 로그 검사 통과.\n- qa-games409 Chrome/WebKit: 384×832, KO/EN/JA, 지목 응답3개·증거 개입, 카페 가구, 모집 시작, 지도 선택, 실제 방·가구, 동일 단계 DOM 유지 검사 통과.\n- Android 준비 모듈164개/에셋389개 포함 검사 통과.\n\n실제 여러 사용자의 장기 플레이 밸런스 및 물리적인 Android/iPhone 조작 테스트는 수행하지 않음.\n## 배포\nAndroid409 release302: 2026-09-15 21:23 KST 내부 테스터에게 제공됨 확인.\n공개 웹 web409 / Cloudflare70b8e5e7, 실제 app.js?v=20260915web409 확인.\nsharedTownApi 최종14b1996 배포 완료. 미래 일정 보존 검사 추가.\nApple Actions34968177686: Mac 서명·검증·업로드 성공(9분17초). App Store Connect409 처리 완료. 암호화 정보 저장 후 테스트 준비 완료 및 기존 내부 그룹의1.0.357(409) 제공·설치됨 표시 확인. 실제 기기 조작 QA를 뜻하지는 않음.\n클라이언트 소스 adf6e76, 서버 소스14b1996. 공개 앱405 승격은 하지 않음.\n- 실제 앱 패키지(www)에서도 WebKit 3개 언어 UI 검사 통과. 6명 설정3곳과 NPC 시작 체크값 전달 검사 통과.\n- 기본 음식 이전 데이터 정정, ID 참조 유지, 사용자 직접 작성 항목 유지 검사 통과.\n새 고정 UI는 KO/EN/JA. 사용자 작성 이름은 유지. 전체 앱 번역률 재측정하지 않음.\n\n\n<ko-KR>\n멀티 생활로그에서 자리에 없는 상대와 행동하거나 외출 중 집 활동이 나오던 경로를 수정했습니다.\n새 마피아 회의는 상대의 확인·부인, 증거 개입, 반박·동의로 이어지며 최대300초 진행됩니다. 6명 게임은 활동 장소3곳을 사용합니다.\n모집 화면과 바로 시작하기, 선택 즉시 표시, 건물 외관과 기본 실내를 개선했습니다. 이전 기본 사전의 마라탕을 김밥으로 정정했습니다.\n</ko-KR>\n<en-US>\nFixed multiplayer logs showing absent companions or home activities during scheduled outings.\nNew Mafia meetings connect named replies, evidence, rebuttals and agreement within 300 seconds. Six-player games use three active venues.\nUpdated recruitment, direct starting, selection feedback, building images and default interiors. Corrected the old starter food entry to Gimbap.\n</en-US>\n<ja-JP>\nマルチの生活記録で、不在の相手との行動や外出中の家の行動が表示される経路を修正しました。\n新しいマフィア会議は相手の確認・否定、証拠、反論・同意がつながり、最大300秒です。6人のゲームでは活動場所を3か所に絞ります。\n募集画面、直接開始、選択表示、建物画像と標準の室内を改善しました。旧初期辞典の食べ物をキンパに訂正しました。\n</ja-JP>\n"});

window.SEORAP_DATA.tasks.push({"id": "release410-mafia-personal", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "1.0.358 (410) 내 마을 마피아·질문과 지적", "summary": "개인 마을 개설, 일과 단축, 의문 추천·집중 지적, 기록 보드. 검증 완료, 내부 배포 진행."});

Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==="release410-mafia-personal"),{"completed": true, "summary": "1.0.358(410) Android 내부 제공·Apple TestFlight 내부 제공·web410·멀티 서버 배포 완료. 새 문구 영어/일본어100%, 전체 앱 미측정."});
window.SEORAP_DATA.updates.unshift({"version": "1.0.358", "code": 410, "date": "2026-09-15", "items": ["내 마을 마피아 개설, 모집 화면에서 NPC 충원", "아침·저녁 모임·밤 일과로 단축", "이상한데 질문 추천·지적 집중 장면·최대3장 손패와 개인 기록 보드", "NPC 개입·관계 기반 동의·모순과 반박에 따른 의심", "Android 및 Apple 내부 테스트 제공, 웹·서버 배포 완료"]});
window.SEORAP_DATA.documents.push({"id": "release410-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.358 (410) 업데이트·출시노트", "description": "내 마을 마피아, 일과·추리 개선. 내부 테스트 배포 완료.", "content": "# 1.0.358 / 410 — 내부 테스트\n\n개발 브랜치 dev. 공개 앱 승격 없음.\n\n내 마을 게임, 모집 화면 NPC 충원 통일, 아침·저녁모임·밤 일과, 근거 없는 질문도 가능한 이상한데 버튼, 지적 집중 장면과 명시 제출, 3장 손패·개인 기록 보드, NPC 개입 및 관계 기반 동의, 모순·반박에 따른 누적 의심.\n\n검증: 기존 규칙 20판, 새 규칙 40판 완주·질문/사생활/선착순 검사. Chrome/WebKit KO·EN·JA 및 실제 www 패키지 UI 검사. 내 마을 5인 개설·재조회와 역할 비공개 검사.\n\n새 고정 문구 EN/JA100%. 전체 앱 번역률 미측정. 원본 말투·그림은 유지. 비밀 목적 전용 시스템·마지막 날 별도 규칙·음성 효과는 이번 변경에 포함하지 않음.\n\nAndroid: 2026-09-15 22:20 KST 내부 테스터 제공 확인, release303.\n웹: Cloudflare4d6cdec9, 실제 DOM에서 web410 확인. 공개 광장 잠금 유지.\n멀티 서버: 같은 차례 NPC 반응 저장 보완 d2679b1까지 배포 완료.\nApple: Actions34973923354 Mac 서명·검증·업로드 성공. TestFlight 처리 완료, 기존 내부 그룹34개 빌드 및410 설치됨 표시 확인. 실제 iPad 조작 QA를 수행한 것은 아님.\n\n추가 검증: 동일 차례 NPC 동의 저장 회귀 검사 통과. 100개 시드 자동 진행(인간 자리 무입력) 시민81/마피아19, 총습격55, 평균2.53일. 실제 사용자 승률이나 플레이 밸런스를 보장하는 수치가 아님.\n\n<ko-KR>\n내 마을에서도 마피아 게임을 열 수 있습니다. 설정의 즉시 시작 항목을 없애고 모집 화면에서 NPC를 충원합니다.\n새 게임의 일과를 아침·저녁 모임·밤으로 줄였습니다. 회의에서 ‘이상한데?’로 확인할 점을 고르고, 지적 장면에서 근거를 확인한 뒤 제출할 수 있습니다.\n전체 기록은 내 기록 보드에 정리하고 손에는 최대 3장의 카드를 보여줍니다. NPC 개입과 반박에 따른 의심 변화를 추가했습니다.\n</ko-KR>\n<en-US>\nHost Mafia in your own village. NPC filling now stays on the recruitment screen.\nNew games use morning, an evening gathering and night. Choose a suggested question with “Wait a moment…” and review evidence before submitting an objection.\nYour record board keeps all available records, while your hand shows up to three cards. NPCs can intervene, and challenges and rebuttals affect suspicion.\n</en-US>\n<ja-JP>\n自分の村でもマフィアゲームを開けます。NPCの補充は募集画面で行います。\n新しいゲームの一日を朝・夕方の集まり・夜に短縮しました。「あれ、おかしくない？」で確認する点を選び、指摘の場面で根拠を確認して提出できます。\n記録は自分のボードに整理し、手元には最大3枚のカードを表示します。NPCの介入と反論による疑いの変化を追加しました。\n</ja-JP>\n"});

window.SEORAP_DATA.updates.unshift({"version": "1.0.359-public-hotfix / 1.0.360-internal", "code": 411, "date": "2026-09-16", "items": ["홈 할 일 정하기 복원과 작은 화면 팝업 위치 수정", "멀티 금지행동 저장·알림 캐릭터 목록·삭제된 구성원 그룹 정리", "지정 방 우선 및 빈 침대 사용, 이름표 가림·중복과 좁은 방 의자 수정", "Android411·Apple411 공개 심사 제출 완료. 승인 후 자동 공개, 아직 승인 완료 아님", "Android 내부412 및 TestFlight412 기존 내부 테스터 제공", "웹web411·멀티 서버 반영, 공개 광장 잠금 유지", "Chrome/WebKit KO/EN/JA와 저장·권한·70개 생활 검사 통과. 구형 알림 검사 4개는 미통과로 기록", "이번 변경 문구 영어100%·일본어100%, 전체 앱 번역률 미측정"]});
window.SEORAP_DATA.documents.push({"id": "release411-record", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "411 공개 핫픽스 / 412 내부 업데이트", "description": "공개 심사 제출·내부 배포·웹/서버 반영 결과", "content": "홈 할 일 정하기 복원과 작은 화면 팝업 위치 수정\n멀티 금지행동 저장·알림 캐릭터 목록·삭제된 구성원 그룹 정리\n지정 방 우선 및 빈 침대 사용, 이름표 가림·중복과 좁은 방 의자 수정\nAndroid411·Apple411 공개 심사 제출 완료. 승인 후 자동 공개, 아직 승인 완료 아님\nAndroid 내부412 및 TestFlight412 기존 내부 테스터 제공\n웹web411·멀티 서버 반영, 공개 광장 잠금 유지\nChrome/WebKit KO/EN/JA와 저장·권한·70개 생활 검사 통과. 구형 알림 검사 4개는 미통과로 기록\n이번 변경 문구 영어100%·일본어100%, 전체 앱 번역률 미측정\n\n\n## Deployment record — 2026-09-16 08:23 KST\n\n- Google Play public: 411 / 1.0.359, production release26 submitted for review, 100% rollout after approval. Review in progress; not yet confirmed publicly available.\n- Apple public: 411 / 1.0.359, upload35033904868 succeeded. Replaced pending405 and submitted d56ab31b-441c-490b-abea-82ca486a951c. Automatic release to all users after approval. Submission success confirmed; not yet publicly available.\n- Android internal: 412 / 1.0.360, release304, provided to internal testers at08:16 KST.\n- Apple internal: 412 / 1.0.360, upload35033880969 succeeded; export info completed, Ready to Test, existing internal group attached (1 tester). KO/EN/JA test notes saved.\n- Web: Cloudflare deployment7bef4496 initially supplied web412; after main source alignment, live drawervillage.com was rechecked and serves app.js?v=20260916web411. Public plaza remains disabled.\n- sharedTownApi deployed with the authorized orphan-group deletion endpoint, preserving current dev server features. Unauthenticated request rejected401.\n- Feature source c6a4124, public/main history alignment c841a6c, dev5f923d4. Only the audited public405 hotfix tree is on main; ongoing development remains on dev.\n- Added endpoint regression test: remaining owner allowed, strangers denied, host can clean empty orphan, idempotency, resident records preserved.\n- Android signatures and packaged versions verified. No physical device or real-user account mutation tests performed.\n- Changed UI/release copy: English100%, Japanese100%. Full-project translation coverage not measured.\n\nAAB SHA256:\n- public411: D69D2EA36B94C2BAEBBCD60DF7E7CCA7D7E75933F5965856813107CC81304B55\n- internal412: C9D7A33C740EBE7FBA045FF4724EC4FDB2E53610A0DFF033D8726568B5F8A490\n\n\n<ko-KR>\n• 홈 화면에 할 일 정하기를 복원했습니다.\n• 캐릭터 팝업이 화면 밖으로 밀리는 문제를 수정했습니다.\n• 멀티 캐릭터의 금지행동 저장과 연락받을 캐릭터 목록을 개선했습니다.\n• 삭제된 구성원이 남은 그룹을 정리할 수 있도록 수정했습니다.\n• 방 지정이 없으면 빈 침대를 찾아 사용합니다.\n• 이름표의 가구 가림·중복 표시와 좁은 방의 의자 배치를 개선했습니다.\n</ko-KR>\n<en-US>\n• Restored Choose activity on the home screen.\n• Fixed character popups extending off-screen.\n• Improved saved activity restrictions and the notification character list in multiplayer.\n• Enabled cleanup of groups with deleted residents.\n• Characters can use a vacant bed when no room is assigned.\n• Improved name-label visibility, duplicate labels, and seating in narrow rooms.\n</en-US>\n<ja-JP>\n• ホーム画面の「行動を決める」を復元しました。\n• キャラクターのポップアップが画面外に出る問題を修正しました。\n• マルチの禁止行動の保存と通知キャラクター一覧を改善しました。\n• 削除済みの住民が残るグループを整理できるようにしました。\n• 部屋の指定がなければ空いているベッドを使います。\n• 名前表示の家具による隠れ・重複と狭い部屋の座席配置を改善しました。\n</ja-JP>\n"});

window.SEORAP_DATA.updates.unshift({"version": "1.0.365", "code": 417, "date": "2026-09-16", "items": ["다른 행동 메뉴 안에서 기존 모든 활동과 상대·주제 지정", "1인 침대 크기·잠자는 모습 및 욕구 회복 속도 개선", "거실·주방 등으로 가구를 찾고 방 종류와 무관하게 배치", "마피아 의심·변호·진술 요구와 반박·동조, NPC만 남으면 빠른 진행", "신규 EN/JA100%, 전체 번역률 미측정. Android 및 Apple 내부 배포 진행 중"]});

window.SEORAP_DATA.documents.push({"id": "release417-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.365 (417) 내부 테스트 출시노트", "description": "전체 행동 메뉴·1인 침대·욕구 회복·마피아 회의 개선", "content": "<ko-KR>\n다른 행동 메뉴 안에서 기존의 모든 할 일을 선택할 수 있어요. 1인 침대 크기와 잠자는 모습, 욕구 회복 속도를 개선했어요. 가구를 거실·주방 등으로 찾아 어디에든 배치할 수 있어요. 마피아 회의에 의심·변호·진술 요구·반박·동조를 추가하고, NPC만 남으면 빠르게 진행해요. 캐릭터 배치와 행동 움직임도 다듬었어요.\n</ko-KR>\n<en-US>\nChoose all previous activities within Other actions. Improved single-bed size, sleeping layers and need recovery. Browse furniture by room and place it anywhere. Mafia meetings now offer suspicion, defense, requests for accounts, rebuttals and agreement. Rounds advance faster when only NPCs remain. Improved character placement and action motion.\n</en-US>\n<ja-JP>\n「ほかの行動」内で以前の全行動を選べます。シングルベッドの大きさと寝姿、欲求の回復速度を改善。家具は部屋別に探してどの部屋にも置けます。マフィア会議に疑う・弁護・説明要求・反論・同調を追加し、NPCだけになると素早く進行します。キャラクターの配置と動きも調整しました。\n</ja-JP>"});

window.SEORAP_DATA.updates.find(u=>u.code===417).items.push("Android 417 내부 테스터 제공 확인(9월 16일 16:36), 멀티 서버 배포 완료. Apple 내부 빌드 업로드 진행 중.");

Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==="internal417-context-meeting"),{"completed": true, "summary": "1.0.365(417), 기능 dev61d38d9. 문맥 메뉴 내 전체 활동, 1인 침대 레이어·크기, 빠른 욕구 회복, 방별 가구 분류·자유 배치, 마피아 5종 발언·3종 반응·선착순·위증 및 NPC 2초. 새/기존 각30판, Chrome/WebKit 3언어·활동 실행·침대·360x648 회의 검증. AAB 서명 및 자산407개 일치. Play release309 내부 테스터 제공(9/16 16:36), 서버 배포 완료. Apple Actions35069105388 성공, TestFlight 준비 완료·나만 테스트 그룹417 설치됨 확인. 신규 EN/JA100%, 전체 미측정. 비밀목적·마피아 변호 후속 페널티·주제 전환 보너스는 미구현. 공개 main 유지."});
window.SEORAP_DATA.updates.find(u=>u.code===417).items.push("Android 내부 테스터 및 Apple TestFlight 기존 내부 그룹에 417 제공 완료. Apple 로그인 4.8 대응은 별도 후속 작업.");

window.SEORAP_DATA.updates.unshift({"version": "1.0.366", "code": 418, "date": "2026-09-16", "items": ["마피아 주 의견과 여러 반응·침묵 지적·입장 변경", "새 게임 낮 활동→회의·투표→밤 표적 선택→다음 날 아침 발견", "전체 회의 시간·전원 넘기기, 문장 증거와 놀이 능력 설정", "침대 크기·수면 위치, 실시간 욕구 회복·빠른 용변, 가구별 행동", "Android 및 Apple 내부 배포 완료. EN/JA 신규문구100%"]});
window.SEORAP_DATA.documents.push({"id": "release418-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.366 (418) 내부 테스트", "description": "회의 주 의견·반응, 낮/밤 규칙 및 침대·욕구·가구 수정", "content": "# Internal 418 · 1.0.366\n\n## Included\n- Stable main opinions with multiple visible reactions. Main opinions may be queued during another opinion and follow its response window. Reactions add one pressure point; silence and stance-change controls are available.\n- Five-minute whole-meeting countdown; all surviving human players can skip together, advancing after two seconds. NPCs do not vote to skip.\n- New games use two daytime activity periods, meeting/vote, private Mafia night-target selection, then morning discovery. Daytime kills are disabled in this cycle. Existing games retain their day/night cycle.\n- Evidence shown as sentences. Presence observations alone do not increase pressure as proof. Specific time/place claims can be compared with firsthand surveys or the named partner’s own record. Intuition is explicitly uncertain, not role detection.\n- Game abilities page between former pages 9 and 10: deception, intuition, stealth, reasoning, observation, composure. Saved/shared with the character and used in observations/impressions.\n- Flow layout for expanding meeting speech and multiple reactions, no bottom scene-record block. Evidence at upper left, muted contextual memory; private evidence choices inline.\n- Single-bed visual dimensions halved from 417; duplicate catalog entry hidden while existing furniture persists. Sleeping status removed from the body anchor; pillow/quilt layers retained.\n- Need recovery projected continuously during activity, without double credit on save. Toilet recovery approximately one minute and its task duration one minute.\n- Furniture Other activities now constrained to that furniture. The complete activity catalog remains accessible from character commands.\n\n## Validation\n- 30 updated meeting games, 30 night-cycle games, 30 legacy games finish.\n- Multiple reactions, queued main opinion, reaction pressure, silence/stance, specific contradiction, private evidence authorization, human-only skip +2s, no daytime kill, private night target and morning discovery.\n- Chrome/WebKit KO/EN/JA small-screen meeting controls, long dialogue geometry, private night selection.\n- Chrome/WebKit contextual furniture filtering, complete self activity catalog, actual hug, abilities saved and reloaded/shared.\n- Single-bed front/right/left geometry and base/person/quilt layers; needs continuous recovery/no double credit; seating regressions.\n- Native module closure and packaged asset validation.\n\nNew/changed UI text: English 100%, Japanese 100%. Whole application coverage not measured. Real multi-device latency and gameplay balance still require internal playtesting; automated completion is not a balance claim.\n\n## Delivery\nSource b449a54 pushed to dev. Public app main is not merged with these new features.\nPlay release 310: 418 (1.0.366) available to internal testers, verified September 16 19:18 KST.\nSigned Android AAB SHA256: 4F74A49651CBC8DEB5177D8A5A58257C55C2DB7A490DE1F7A145375C974B2659. All 407 packaged assets match the prepared files.\nsharedTownApi deployment succeeded. Apple internal TestFlight run 35083679716 succeeded: uploadAccepted=true, internalOnly=true, submittedForReview=false. App Store Connect build a9287faa-90c0-49ad-a5bd-64e9bc69649c is Ready to Test, one existing internal tester invited. Android and Apple internal delivery verified September 16. No public promotion or website deployment.\n\n## Store notes\n<ko-KR>\n마피아 회의에서 주 의견과 여러 반응을 이어서 나눌 수 있어요. 침묵 지적·입장 변경, 회의 시간과 모두 넘기기를 추가했어요. 새 게임은 낮 활동·회의 후 밤에 표적을 고르고 다음 날 아침 발견해요. 증거 문장과 놀이 능력 설정을 추가하고 말풍선 겹침을 고쳤어요. 1인 침대 크기·잠자는 위치, 행동 중 욕구 회복과 가구별 행동 목록을 수정했어요.\n</ko-KR>\n<en-US>\nMafia meetings now connect main opinions and multiple replies, with silence questions, stance changes, a meeting timer and group skip. New games use daytime activities and meetings, private night targets and morning discoveries. Added evidence sentences and game abilities. Fixed overlapping dialogue, single-bed size and sleeping position, continuous need recovery and furniture-specific actions.\n</en-US>\n<ja-JP>\nマフィア会議で主意見と複数の反応を続けられます。沈黙への質問・立場変更、会議時間と全員スキップを追加。新規ゲームは昼の活動・会議後、夜に標的を選び翌朝発見します。証拠の文章表示と遊びの能力設定を追加し、吹き出しの重なり、シングルベッドの大きさと寝姿、行動中の欲求回復、家具別の行動一覧を修正しました。\n</ja-JP>\n"});

window.SEORAP_DATA.updates.unshift({"version": "1.0.367-dev", "code": 419, "date": "2026-09-16", "items": ["놀이 모집 화면을 불러오지 못하는 오류 수정", "침대에서 잠자기·쉬기·독서 등 선택, 지정한 방의 침대 사용 및 1인 침대 수면 레이어 수정", "책장·화분 크기20% 확대, 실제 바닥·벽지 미리보기 선택", "대표 내부사진과 집 외형 아이콘으로 집 정보 정리, 사용자 광장 그림 적용", "Chrome/WebKit 실제 화면·행동·이미지 선택 검증, Android 서명 AAB 완료. Android/Apple 내부 배포 중. 신규 EN/JA100%."]});

window.SEORAP_DATA.updates.unshift({"version": "1.0.368-dev", "code": 420, "date": "2026-09-16", "items": ["집 외형 아이콘 뒤 흰 네모와 이름표 제거, 집 그림을 눌러 외형 선택", "419 놀이 불러오기·침대·가구·재질 선택 개선 포함", "Chrome/WebKit 밝은/어두운 테마 투명 배경·이름표 제거 확인. Android420 및 Apple TestFlight420 내부 제공 완료."]});

window.SEORAP_DATA.updates.unshift({"version": "1.0.369 / 1.0.370-dev", "code": 422, "date": "2026-09-16", "items": ["잠자기·식사·씻기 욕구가 행동 중에 차도록 수정, 용변은 빠르게 회복", "방 설정에 세부 활동 설정 추가: 기본 전부 체크, 방별로 활동 허용 선택", "공개 놀이 준비 중 유지, Android 내부 테스트의 잘못된 공개 설정 수정", "Android421 프로덕션 심사 제출·내부422 제공 완료, 공개 사이트 및 멀티 서버 적용. Apple421/422 업로드 완료·수출규정 답변 대기. Apple411 로그인4.8 미해결."]});

window.SEORAP_DATA.documents.push({"id": "internal423-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.371 (423) 내부 테스트 출시 노트", "description": "1.0.372(424) dev d74d596. 주 의견 순서제, 지목된 인물 먼저 답변·부수 의견 2초씩 한 개, NPC 반응 절제. 근거 분류·소형 증거 버튼·화면 스크롤 정돈, 나무바닥 설정·놀이 목록 복귀. 관전 지도·죽은 인물 표시, NPC만 생존 시 전 관전자 넘기면 즉시 투표. 5일차 아침 결과 덮임 수정. 40판 및 Chrome/WebKit 3언어 검증, 423 Android 제공21:47(release314)·Apple서명업로드 성공. 설정 요약 숫자 대비 추가 수정한424 Android 내부 제공21:55(release315), Apple424 서명업로드 성공(35098202685)·Apple 처리 중·설치 가능 미확인, 기존 수출규정 답변 대기. 멀티서버 배포 완료. 신규 EN/JA100%, 전체 미측정.", "content": "<ko-KR>\n마피아 회의를 돌아가며 의견을 내는 방식으로 다듬었어요. 지목받은 사람이 먼저 답하고, 반응은 하나씩 표시해요.\n근거 종류별 제출과 작은 증거 목록 버튼을 추가하고 회의 화면을 정돈했어요.\n관전자는 마을에서 모두의 위치를 볼 수 있어요. NPC만 남으면 모든 관전자가 회의를 넘기는 즉시 투표해요.\n아침 발견 후 결과 화면이 멈추던 문제와 놀이 나가기 화면을 고쳤어요. 불필요한 화면 갱신도 줄였어요.\n</ko-KR>\n<en-US>\nMafia meetings now use rotating speaking turns. The person addressed replies first, followed by one reaction at a time.\nAdded evidence categories and a compact evidence button, and tidied the meeting layout.\nSpectators can see everyone on the village map. With only NPCs alive, all spectators skipping starts voting immediately.\nFixed results getting stuck after a morning discovery and leaving a game. Reduced unnecessary screen updates.\n</en-US>\n<ja-JP>\nマフィア会議を順番に主意見を出す方式に変更。指名された人物が先に答え、反応は一つずつ表示します。\n根拠別の提出と小さな証拠ボタンを追加し、会議画面を整理しました。\n観戦者は村で全員の位置を確認できます。NPCのみ生存時は全観戦者が会議をスキップすると即座に投票へ進みます。\n朝の発見後に結果画面が止まる問題と退出画面を修正し、不要な画面更新を減らしました。\n</ja-JP>\n"});
window.SEORAP_DATA.updates.unshift({"version": "1.0.371-dev", "code": 423, "date": "2026-09-16", "items": ["마피아 회의 순서제·지목된 사람 우선 답변·반응 한 개씩 표시", "증거 분류 제출·작은 증거 버튼·화면 정돈·나무바닥 설정", "관전 지도 및 NPC만 생존 시 전원 넘기면 즉시 투표", "아침 발견 후 결과 멈춤·놀이 나가기 수정, 불필요한 화면 갱신 감소", "423 Android·Apple 업로드 완료, 최종424로 대체. 공개 놀이 준비 중 유지."]});

window.SEORAP_DATA.documents.push({"id": "internal424-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.372 (424) 내부 테스트 출시 노트", "description": "423 변경 모두 포함·설정 화면 요약 숫자 및 장소 선택 색 대비 보완", "content": "<ko-KR>\n마피아 회의를 돌아가며 의견을 내는 방식으로 다듬었어요. 지목받은 사람이 먼저 답하고, 반응은 하나씩 표시해요.\n근거 종류별 제출과 작은 증거 목록 버튼을 추가하고 회의 화면을 정돈했어요.\n관전자는 마을에서 모두의 위치를 볼 수 있어요. NPC만 남으면 모든 관전자가 회의를 넘기는 즉시 투표해요.\n아침 발견 후 결과 화면이 멈추던 문제와 놀이 나가기 화면을 고쳤어요. 불필요한 화면 갱신도 줄였어요.\n</ko-KR>\n<en-US>\nMafia meetings now use rotating speaking turns. The person addressed replies first, followed by one reaction at a time.\nAdded evidence categories and a compact evidence button, and tidied the meeting layout.\nSpectators can see everyone on the village map. With only NPCs alive, all spectators skipping starts voting immediately.\nFixed results getting stuck after a morning discovery and leaving a game. Reduced unnecessary screen updates.\n</en-US>\n<ja-JP>\nマフィア会議を順番に主意見を出す方式に変更。指名された人物が先に答え、反応は一つずつ表示します。\n根拠別の提出と小さな証拠ボタンを追加し、会議画面を整理しました。\n観戦者は村で全員の位置を確認できます。NPCのみ生存時は全観戦者が会議をスキップすると即座に投票へ進みます。\n朝の発見後に結果画面が止まる問題と退出画面を修正し、不要な画面更新を減らしました。\n</ja-JP>\n"});
window.SEORAP_DATA.updates.unshift({"version": "1.0.372-dev", "code": 424, "date": "2026-09-16", "items": ["423 회의 순서·근거별 제출·관전 지도·전 관전자 즉시 넘기기·아침 멈춤 수정 포함", "설정 화면: 나무바닥 위 밝은 글씨, 미색 요약 상자 안 진한 숫자", "Android424 내부 테스터 제공21:55(release315). Apple424 서명업로드 성공(35098202685), Apple 처리 중·설치 가능 미확인·기존 수출규정 답변 대기. 멀티 서버 반영 완료. 공개 준비중 유지."]});

window.SEORAP_DATA.documents.push({"id": "internal426-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.374 (426) 내부 테스트 출시 노트", "description": "낮 준비와 밤 침입·동맹·회의 반응·투표 내역", "content": "<ko-KR>\n낮에 도구를 챙기고 잠자리와 집 방어를 준비할 수 있어요. 밤의 침입은 낮 준비에 따라 달라지고, 다음 날 현장 흔적을 조사할 수 있어요. 정체를 숨긴 동맹과 애도 행동을 추가했어요. 회의 반응 시간을 조정하고 반박·감사 반응과 투표 내역을 추가했어요. 이동 연출 때 지도 위치를 유지해요. 새 준비 규칙은 새 놀이부터 적용돼요.\n</ko-KR>\n<en-US>\nGather tools, scout sleeping places and secure homes during the day. Night intrusions depend on preparation and leave clues to investigate. Added private alliances without role reveals and mourning. Meetings now have clearer reaction timing, rebuttals, thanks and visible voting results. The map keeps its position during movement. New preparation rules apply to newly created games.\n</en-US>\n<ja-JP>\n昼に道具を集め、寝る場所と家の守りを準備できます。夜の侵入は昼の準備で変わり、翌朝に現場の痕跡を調べられます。正体を明かさない同盟と追悼行動を追加。会議の反応時間を調整し、反論・感謝と投票結果の表示を追加しました。移動演出中も地図の位置を維持します。新しい準備ルールは新規のゲームに適用されます。\n</ja-JP>\n"});
window.SEORAP_DATA.updates.unshift({"version": "1.0.374-dev", "code": 426, "date": "2026-09-16", "items": ["도구 확보·잠자리 조사·집 단속과 밤 침입 연결, 다음 날 실제 사건 흔적 조사", "정체 비공개 동맹·애도·동거인 야간 목격", "즉시 NPC 주 의견·반응5초·지목된 사람 먼저 반박·감사·투표자 내역", "지도 카메라 유지 및 투표 화면 대비 수정", "Android 내부426 제공22:57(release316), 멀티 서버 반영. Apple426 서명 업로드 성공(35104844648), Apple 처리 중·설치 가능 미확인. 공개 준비중 유지."]});

// User-confirmed working rules, 2026-09-17.
window.SEORAP_DATA.gptPrompt += `

작업 범위와 코드 구조
1. 많은 부분을 수정해야 하면 먼저 범위를 설명하고 사용자 확인을 받습니다.
2. 하나의 파일에 코드를 몰아넣지 않고 기능별 모듈로 나눕니다.
3. 요청이 명확하지 않으면 추측해 실행하기 전에 이해한 내용을 확인합니다.
`;

window.SEORAP_DATA.updates.unshift({"version": "1.0.385", "code": 437, "date": "2026-09-17", "items": ["동기화 사진의 주소 변경 중복·다른 계정 사진 합산·과거 누적 개수 수정", "카운터 양 끝 고정과 가운데 확장, 상판 배치 범위·인덕션 사용 위치 개선", "시선과 접촉 허용에 따른 자동 감정 행동, 음식점 세 가지 주문과 동행 문구", "버튼 지연 감소, 홈 캐릭터 전환 책장 소리와 부드러운 선택음", "대화 두 이름·주제 통합 및 겹침 개선, 개인·멀티 편집과 효과음 개선 포함", "dev e6bec28; 이번 EN/JA100%, 전체미측정; iOS 준비만", "프로덕션 검토 제출 완료, 광장 잠금·승인 대기"]});
window.SEORAP_DATA.documents.push({"id": "release437-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.385 (437) 출시노트", "description": "프로덕션 검토 제출 완료, 광장 잠금·승인 대기", "content": "<ko-KR>\n버튼·선택창의 지연과 사진 사용량 중복 계산을 줄였습니다. 카운터 양 끝을 유지하며 가운데만 늘리고 상판 배치 범위와 인덕션 사용 위치를 개선했습니다. 시선에 따른 자동 감정 행동, 음식점 주문, 홈 캐릭터 전환 책장 소리를 추가하고 캐릭터·행동 선택음을 부드럽게 조정했습니다. 개인·멀티 집 편집과 대화 겹침·중복 이름표, 생활·욕구·동기화를 개선했습니다. 광장은 준비 중입니다.\n</ko-KR>\n<en-US>\nReduced tap delays and duplicate photo usage counts. Counter ends stay fixed while the center stretches; improved tabletop placement and cooktop positions. Added feelings-based interactions, restaurant orders and page sounds when switching characters, with softer character/action selection sounds. Improved solo/multiplayer home editing, conversation overlap and labels, daily activities, needs and sync. The plaza remains unavailable.\n</en-US>\n<ja-JP>\nタップの遅延と写真使用数の重複集計を軽減。カウンターの両端を固定して中央だけ伸ばし、天板への配置とIH使用位置を改善しました。気持ちに応じた自動交流、飲食店の注文、キャラクター切替時のページ音を追加し、キャラクター・行動の選択音を柔らかく調整。個人・マルチの家編集、会話の重なりと名前表示、生活・欲求・同期を改善しました。 広場は準備中です。\n</ja-JP>\n"});

window.SEORAP_DATA.updates.unshift({"version": "1.0.386", "code": 438, "date": "2026-09-17", "items": ["동기화 사진의 주소 변경 중복·다른 계정 사진 합산·과거 누적 개수 수정", "카운터 양 끝 고정과 가운데 확장, 상판 배치 범위·인덕션 사용 위치 개선", "시선과 접촉 허용에 따른 자동 감정 행동, 음식점 세 가지 주문과 동행 문구", "버튼 지연 감소, 홈 캐릭터 전환 책장 소리와 부드러운 선택음", "대화 두 이름·주제 통합 및 겹침 개선, 개인·멀티 편집과 효과음 개선 포함", "dev e6bec28; 이번 EN/JA100%, 전체미측정; iOS 준비만", "내부 테스터 제공9/17 16:47, 광장 열림"]});
window.SEORAP_DATA.documents.push({"id": "release438-notes", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.386 (438) 출시노트", "description": "내부 테스터 제공9/17 16:47, 광장 열림", "content": "<ko-KR>\n버튼·선택창의 지연과 사진 사용량 중복 계산을 줄였습니다. 카운터 양 끝을 유지하며 가운데만 늘리고 상판 배치 범위와 인덕션 사용 위치를 개선했습니다. 시선에 따른 자동 감정 행동, 음식점 주문, 홈 캐릭터 전환 책장 소리를 추가하고 캐릭터·행동 선택음을 부드럽게 조정했습니다. 개인·멀티 집 편집과 대화 겹침·중복 이름표, 생활·욕구·동기화를 개선했습니다. 내부 테스트에서는 광장을 이용할 수 있습니다.\n</ko-KR>\n<en-US>\nReduced tap delays and duplicate photo usage counts. Counter ends stay fixed while the center stretches; improved tabletop placement and cooktop positions. Added feelings-based interactions, restaurant orders and page sounds when switching characters, with softer character/action selection sounds. Improved solo/multiplayer home editing, conversation overlap and labels, daily activities, needs and sync. The plaza is enabled for internal testing.\n</en-US>\n<ja-JP>\nタップの遅延と写真使用数の重複集計を軽減。カウンターの両端を固定して中央だけ伸ばし、天板への配置とIH使用位置を改善しました。気持ちに応じた自動交流、飲食店の注文、キャラクター切替時のページ音を追加し、キャラクター・行動の選択音を柔らかく調整。個人・マルチの家編集、会話の重なりと名前表示、生活・欲求・同期を改善しました。 内部テストでは広場を利用できます。\n</ja-JP>\n"});

window.SEORAP_DATA.documents.push({"id": "public437-announcement", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "1.0.355 이후 누적 전체공지 · 1.0.385", "description": "발송완료 · notice-639d1546-4310-489f-9a84-e0173aab1643 · dev e6bec28", "content": "서랍마을 1.0.385 업데이트 안내\n\n보낸 이: 서랍마을\n받는 이: 서랍마을 주민\n\n1.0.355 이후 개선된 내용을 모아 안내드립니다. 이번 공개 버전에서 광장은 계속 준비 중으로 표시됩니다.\n\n🏠 집 꾸미기\n• 화분 2, 협탁, 카운터, 냉장고, 인덕션을 추가했어요. TV·냉장고·책장·화분 크기도 조정했어요.\n• 카운터 양 끝 모양은 유지하고 가운데만 늘려 자연스럽게 이어 붙일 수 있어요. 상판의 촘촘한 배치 칸에 소품을 올릴 수 있고, 협탁 위에도 소품 하나를 놓을 수 있어요. 올린 물건이 가구 뒤에 가려지던 문제를 고쳤어요.\n• 카운터 상판의 배치 범위를 넓히고, 인덕션을 사용하는 캐릭터가 카운터 앞 바닥에 서도록 위치를 조정했어요.\n• 개인·멀티 집 편집 도구를 통일하고, 접기와 드래그 이동으로 공간을 덜 가리게 했어요. 멀티 편집 완료와 저장 재시도도 개선했어요.\n• UI·가구·이름 숨김, 편집 취소, 방 프리셋 저장·적용을 추가했어요. UI 숨김에는 뒤로가기 버튼도 포함돼요.\n• 벽지와 바닥재는 각각 고르기 버튼을 눌러 선택해요. 방 이름은 가구 앞에 표시돼요.\n• 겹친 가구는 같은 자리를 다시 눌러 아래 가구를 선택할 수 있어요.\n\n👥 캐릭터의 생활\n• 잠·식사·씻기·용변 후 욕구가 제대로 회복되지 않던 문제와 행동·가구·방 표시가 어긋나는 문제를 수정했어요.\n• 침실에서 용변이나 식사를 하는 등 방 용도에 맞지 않는 행동을 기본적으로 제한해요. 방별 행동 설정과 낮잠·수면 보충 금지도 이용할 수 있어요.\n• 본가와 침실 연결, 침대 사용과 앉는 위치를 개선했어요. 침대에 누운 캐릭터도 조금 더 크게 보여요.\n• 대화하는 두 사람이 겹치지 않게 간격을 조정하고, 두 이름과 대화 내용을 하나로 표시해요.\n• 음악 듣기는 오디오에서, 음료 주문과 동행 방문은 카페에서, 공연 감상은 공연장에서 선택할 수 있어요.\n• 음식점에서 좋아하는 음식·매운 음식·취향에 맞는 음식을 주문할 수 있어요. 동행 선택도 ‘함께 갈 사람 고르기’로 다듬었어요.\n• 함께 있는 상대를 향한 시선에 따라 칭찬·허용된 포옹이나 혼자 있을 시간을 부탁하는 행동을 해요. 접촉 설정과 방별 금지 행동을 따릅니다.\n• 자아 만들기 대기시간을 캐릭터별로 나눴어요. 머리색·눈색 선택지를 늘리고 직접 색상과 이름을 정할 수 있게 했어요.\n• 함께 있지 않은 상대와 대화하거나 일정 중 집에 있는 것처럼 표시되던 생활 기록을 수정했어요.\n• 관계 변화 설정을 게임플레이 설정으로 모았고, 멀티에서는 관리자가 조정해요.\n• 캐릭터 설정 창과 일부 팝업의 화면 밖 잘림을 개선했어요.\n\n💾 저장과 편의\n• 큰 데이터의 계정 동기화와 오류 안내를 개선했어요. 사용하지 않는 과거 사진은 현재 동기화 이미지 한도 계산에서 제외하고, 같은 사진의 중복 등록을 줄였어요. 기존 사진을 임의로 삭제하지는 않아요.\n• 같은 사진의 다운로드 주소가 바뀌어도 중복 계산하지 않고, 다른 계정의 사진은 내 업로드 사용량에 합산하지 않도록 수정했어요.\n• 멀티 행동 제한 저장, 내 캐릭터 알림 목록, 관리 권한이 있는 빈 멀티방 정리를 개선했어요.\n• 동기화를 함께 사용하는 기기는 모두 최신 버전으로 업데이트해 주세요. 새 저장 형식을 이전 버전에서 읽지 못할 수 있어요.\n• 일반 터치, 책 넘기기·닫기, 서랍 열기·닫기 효과음을 연결하고 음량을 조정했어요. 걸음·구두·부츠 발소리도 더 잘 들리게 했어요.\n• 홈에서 캐릭터를 바꿀 때 책장 넘기는 소리가 나요. 캐릭터·행동 선택에는 새 효과음을 적용하고 강한 소리를 줄였어요. 버튼을 누를 때 생기던 지연도 줄였어요.\n• 사전 뒤로가기와 메뉴 닫기에는 서랍 닫는 소리가 나요. 선택창과 화면 조작을 다듬고 반복되는 처리도 줄였어요.\n\nGoogle Play 검토와 기기별 반영 시간에 따라 업데이트가 보이는 시점은 다를 수 있어요. 보내주신 의견 덕분에 차근차근 개선하고 있습니다. 감사합니다!\n"});

window.SEORAP_DATA.tasks.unshift({"subsection":"testing","completed":false,"id":"public439-discovery-surfaces","section":"release","title":"1.0.387 (439) 수정 빌드 준비 · 광고 ID 대기","summary":"dev 044b064. 카운터·협탁 소품 앞 레이어, 식탁 상판 배치, 이동·변형된 침대 취침 좌표, 마피아 가구 정렬 수정. 자아만들기 계정 공통10분 서버 제한·반복 생활질문 감소. Chrome/WebKit·동시요청/재시도·AAB서명 검증. 서버 배포 완료. Android439 빌드만 완료, Play 미제출·광장잠금. 보상형/상단 배너는 AdMob 앱ID와 광고단위ID 대기, 광고 비활성. iOS 준비만. 신규EN/JA100%,전체미측정.","project":"서랍마을"});
window.SEORAP_DATA.updates.unshift({"items":["가구 상판 소품·식탁 배치 및 취침 위치 수정","자아만들기 계정 공통10분·생활 질문 반복 감소","439 빌드 검증 완료, Play 미제출·광고 설정 대기","app-ads.txt 웹 수정 main38d3eec 배포, 공개 주소 HTTP200/text/plain·게시자ID 검증 완료"],"code":439,"version":"1.0.387 준비","date":"2026-09-17"});
window.SEORAP_DATA.documents.push({"subsection":"testing","content":"# Public439 /1.0.387 — prepared, not submitted\r\n\r\nUser authorized production fixes, then added account-wide discovery cooldown, optional reward ads and top banners in home/town/house. Advertising account was newly created; app/ad-unit IDs and the release decision while ads are unconfigured are pending. Do not claim439 uploaded/submitted or ads enabled.\r\n\r\n## Completed source\r\n- Surface attachment ordering is applied as a constraint in final home depth sorting, rather than a z-index later overwritten. Shared furniture-depth module also binds Mafia rooms, observing image load/resize and cleaning up on render; each Mafia room isolates its layers.\r\n- Dining tables now support surface snaps, grid and persisted prop attachments, using a10%/8%/80%/65% top area. Counter/nightstand behavior retained.\r\n- Bed occupant layout extracted from editor lifecycle and called by scene layout. Transformed viewport coordinates map into the occupant's parent, avoiding offset assumptions across nested/scaled containers. Clears stale explicit top/left. Basic one-bed report did not reproduce verbatim; moved/nested/scaled bed fixtures now verified. Real reporter save not accessed.\r\n- Discovery uses an authenticated server transaction for one question every600000ms across an account, shared among personal/multiplayer characters and devices. Guest fallback is device-local. Per-character old local timestamps migrate into account cache. Retry request IDs are idempotent. New diamondWalletApi /discovery/read and /discovery/use routes deployed, without enabling diamond shop or ads.\r\n- Story questions share the candidate pool with ordinary questions; recent topics are excluded. Answered home/cooking themes suppressed for seven days, rather than repeating with date-only IDs.\r\n- No ads are active. Reward intended: wait10min free or fully watch for immediate1use. Requested top banners home/town/house still pending AdMob app ID, reward unit and banner unit plus native setup.\r\n\r\n## Validation\r\nChromium/WebKit qa-layer439: counter/nightstand/table prop depths, Mafia fixture, moved bed X/Y and nested transformed frame. qa-bed418 existing single-bed front/side; Chromium/WebKit qa-discovery439 actual open/skip and second-character shared countdown in KO/EN/JA. check-discovery439: simultaneous account requests, retries, different accounts, expiry and repeated-question suppression. Android bundle and jarsigner pass; changed modules match bundled files. iOS preparation only, no Mac signing or device tests. New UI/notes EN/JA100%, whole-app coverage not measured.\r\n\r\nAAB: C:/Users/Public/drawer-release433/drawer-village-1.0.387-439-public.aab\r\nSHA256 ebfac6d6399edb2c931ee36ad7bc79d96aeb9ea204246e7aa4ce1359dcea76c6\r\nPublic plaza remains disabled. 437 was withdrawn from review back to editable pending changes so it can be replaced. 438 remains the last internal release.\r\n\r\n## AdMob website verification\r\nObserved live /app-ads.txt served game HTML instead of text. Public web source5ac4797 at421 received only app-ads.txt and build inclusion, committed/pushed main38d3eec. Live endpoint verified text/plain with google.com, pub-2970618408876751, DIRECT, f08c47fec0942fa0. AdMob recheck is external; no claim it is approved. Same file/build support included in dev. No account credentials/payment details were handled.\r\n","id":"release439-prepared","section":"release","title":"439 준비 현황 · AdMob 인증 파일","description":"출시 완료 아님 · dev044b064 / 웹main38d3eec","project":"서랍마을"});
window.SEORAP_DATA.tasks.push({id:"dv-adfree440",project:"서랍마을",section:"release",subsection:"testing",completed:false,title:"1.0.388 / 440 · 광고 제거 9,900원",summary:"사용자 최종 확정: 9,900원 일회성 구매, 배너·전면 광고 영구 제거, 자아만들기 계정 공통 대기시간 1분. 선택형 보상 광고 유지. dev 구현 중이며 상점 KO/EN/JA 혜택 문구 작성. Play ad_free 구매 옵션 permanent는 9,900원 초안, 활성화·실결제·iOS 상품 연결·440 제출은 미완료. 기존 12,500원 및 7,500원 제안은 대체됨."});
window.SEORAP_DATA.documents.push({id:"adfree440-price",project:"서랍마을",section:"release",subsection:"testing",title:"440 광고 제거 상품 · 가격 확정",description:"9,900원 · 개발/검증 진행 중, 출시 완료 아님",content:"최종 가격은 9,900원 일회성 구매입니다. 배너 및 마피아 전면 광고를 영구 제거하고 자아만들기 대기시간을 계정 공통 1분으로 줄입니다. 보상형 광고는 선택 사항으로 유지합니다. 앱 버전 1.0.388 / 440의 dev 작업이며, 상품 활성화와 실기기 결제 검증 및 프로덕션 제출은 남아 있습니다. 신규 상품 혜택 문구 영어·일본어 작성 완료. 전체 앱 번역률은 이번 가격 변경에서 재측정하지 않았습니다."});
window.SEORAP_DATA.tasks.push({id:"dv-internal440-release",project:"서랍마을",section:"release",subsection:"testing",completed:true,title:"내부 테스트 440 / 1.0.388 · 광고·가구 배치 개선",summary:"2026-09-17 18:14 KST Google Play 내부 테스터에게 제공됨 확인. dev1767be0/ae9d7c1. 광장 열림·테스트 광고 사용. Play 광고 제거 ad_free/permanent 활성, 한국9,900원·KOENJA 설명 확인. 배너·전면 영구 제거/자아만들기 계정 공통1분. SSV 한글 서명 검증 수정·Android 콜백 검증/저장 완료. Android 서명AAB·번들 소스·Chrome/WebKit 모의광고·서버 중복지급/쿨타임/환불 검사 통과. 연결된 기기 없어 실제 결제·복원·네이티브 광고 시청 검증은 미완료. AdMob 계정 인증 진행 중. 프로덕션 미변경."});
(()=>{const task=window.SEORAP_DATA.tasks.find(t=>t.id==='dv-adfree440');if(task){task.summary='최종9,900원 일회성 구매. Play상품 활성화 및 내부440 배포 완료. 배너·전면 영구제거/자아만들기 계정 공통1분, 보상형 선택 유지. 실제 휴대폰 구매·복원 확인과 Apple 상품 활성화·프로덕션 출시는 미완료.';task.completed=false;}})();
window.SEORAP_DATA.updates.unshift({version:"1.0.388-internal",code:440,date:"2026-09-17",items:["Google Play 내부 테스터에게 제공됨 · 광장 열림·테스트 광고", "광고 제거 상품9,900원 활성: 배너·전면 영구제거, 자아만들기 계정 공통1분", "홈·마을·집 배너와 자아만들기 선택형 보상 광고, 마피아 한 판 최대1회 전면 광고", "가구 위 소품 깊이·식탁 배치·침대 취침 위치 및 반복 질문 개선 포함", "실제 기기 결제·복원 검증 대기, AdMob 계정 승인 대기 · 프로덕션 변경 없음", "신규 상품·광고 문구 및 출시 노트 영어/일본어100%, 전체 앱 번역률 미재측정"]});
window.SEORAP_DATA.documents.push({id:"internal440-release",project:"서랍마을",section:"release",subsection:"testing",title:"내부440 배포 · 결제 검증 안내",description:"1.0.388 · 18:14 KST 배포 · 실결제 미검증",content:"테스트 참여: https://play.google.com/apps/internaltest/4701300702493397907\n버전440 /1.0.388. 내부 광장 열림. 샘플 광고 사용; 샘플 보상 광고는 프로덕션 이용권을 지급하지 않음.\nPlay상품 ad_free/permanent 활성, 한국9,900원. 실제 결제 후 재시작/복원, 배너·전면 제거, 계정 전체60초 쿨타임을 기기에서 확인해야 함. 라이선스 테스터가 아니면 내부 테스트에서도 실제 청구될 수 있음.\n서명AAB SHA256 ae36dc0f0bf14e62f975af078f7d4d5aa90a2a6a19995a6e60dce12aea83a650\n검증: 서명/소스일치, Chrome/WebKit 실제 탭 전환과 모의SDK 광고 레이아웃·팝업·중복 방지, 서버60/600초 경계·중복콜백·계정격리·환불회수. Google 서명 한글 보상 이름 테스트 통과. Android SSV 검증/저장 완료.\n게임dev1767be0/ae9d7c1. 운영main 소스 변경 없음. Apple상품·실기기 결제·광고승인·프로덕션 배포는 남아 있음. 신규EN/JA문구100%, 전체앱 번역률 미측정."});
(()=>{const task=window.SEORAP_DATA.tasks.find(t=>t.id==='dv-internal440-release');if(task)task.summary+=' Android/iOS 양쪽 보상 광고 SSV 콜백 검증·저장 및 저장값 재확인 완료.';const doc=window.SEORAP_DATA.documents.find(d=>d.id==='internal440-release');if(doc)doc.content+='\nAndroid/iOS 양쪽 자아만들기 광고 SSV 콜백을 AdMob에서 검증하고 저장했습니다. 계정/앱 승인은 별도 대기 중입니다.';})();

window.SEORAP_DATA.tasks.push({"id": "dv-internal441-ads", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "내부441 /1.0.389 · 배너 표시·광고 로딩", "summary": "dev801a999. 화면 폭에 맞춘 상단 배너·실패 안내/재시도·회전 대응, 전체 설정 진입 전면 광고, 가로 태블릿 자아만들기 아이콘 확대 및 배너 아래 배치 개선. AdMob 동의 메시지 Android/iOS 2개 앱 게시 확인(최대1시간 전파). Chrome/WebKit 모의SDK·동의 실패 재시도·서버 보상 회귀·서명 AAB 검사 통과. Play 내부326 · 2026-09-17 18:46 KST 내부 테스터에게 제공됨 확인. 실제 기기 광고·결제 미검증. 신규 EN/JA100%, 전체각75.5%. 운영 main 유지."});
window.SEORAP_DATA.documents.push({"id": "internal441-release", "project": "서랍마을", "section": "release", "subsection": "testing", "title": "내부441 /1.0.389 · 상단 배너·광고 로딩 개선", "description": "18:46 KST 내부 테스터 제공 · AdMob 메시지 게시", "content": "# Internal 441 / 1.0.389\n\n## Changes\n- Adaptive full-width top banner on home, town and house screens. Keep the reserved space and show a localized retry/status on failure; retry after 60 seconds and reload for width changes. Suspend ads behind dialogs, fullscreen ads and in background. Premium users have no banner space.\n- Report consent / initialization / load stages and SDK error codes for ad failures instead of one generic message. Consent remains mandatory where required.\n- Preload a non-rewarded interstitial at the character settings hub and show a ready ad when entering full settings. Share preparation with Mafia, enforce a one-minute interstitial interval and consume readiness once. No late ad if unavailable.\n- Enlarge discovery icon for landscape tablets. Scale landscape HUD to the remaining viewport below the banner so the activity card and buttons do not overlap.\n\n## AdMob configuration\n- Confirmed no European regulation message existed. Created and published one for Android com.drawervillage.app and iOS 6808600866. Console confirms Published, two apps, English plus Japanese. The provided language list had no Korean option.\n- Existing public privacy policy https://drawervillage.com/privacy.html confirmed HTTP200 and linked to both apps. Consent, reject and manage options available; default targeting EEA/UK/Switzerland retained. No tracking authorization prompt added.\n- Google says propagation may take up to one hour. Account approval is separate. Real device ad delivery remains unverified.\n\n## Validation\n- Chromium and WebKit with mocked native SDK: adaptive banner, retained failure slot, retry, landscape sizing, repeated binding, modal hide/restore, Mafia once/game, settings non-rewarded interstitial, premium banner removal.\n- Existing signed reward/cooldown/account-boundary regression tests pass.\n- New app copy EN/JA complete. Static whole-app translation: EN2258/2990 (75.5%), JA2257/2990 (75.5%).\n- Android release build/signature/source verification and distribution results recorded below when complete. iOS common source updated, no signed IPA/device verification in this Windows run. Web public deployment unchanged.\n\n## Play notes\n<ko-KR>\n홈·마을·집의 상단 배너를 화면 폭에 맞추고, 광고 로딩 실패 시 안내와 재시도를 추가했어요. 전체 설정 진입 시 전면 광고를 연결했어요. 태블릿 가로 화면의 자아만들기 아이콘과 배너 아래 화면 배치를 개선했어요. 광고 제거 구매자는 배너·전면 광고가 표시되지 않아요.\n</ko-KR>\n<en-US>\nTop banners now fit the screen width on Home, Town and House. Added ad loading status and retry. Added interstitials when entering full character settings. Improved the Self-discovery icon and layout below banners on landscape tablets. Ad-free owners see no banners or interstitials.\n</en-US>\n<ja-JP>\nホーム・村・家の上部バナーを画面幅に合わせ、広告読み込みの案内と再試行を追加しました。キャラクターの全体設定を開く際に全画面広告を表示します。横向きタブレットの自分づくりアイコンとバナー下の配置を改善しました。広告削除の購入者にはバナー・全画面広告を表示しません。\n</ja-JP>\n\n## Build artifact\nAAB: C:/Users/Public/drawer-release433/drawer-village-1.0.389-441-internal.aab\nSHA256: d353ca049944a2792f3125595e7ea7d70764bcdc9e7ea25aaeedd4e1c84c16b5\nAndroid Gradle bundleRelease succeeded; jarsigner reports jar verified (self-signed upload certificate). Modified prepared module bytes match the AAB, including bundled CSS; index contains internal441/plaza enabled. iOS project preparation check passed, not Mac/device execution. Consent failure retry and shared initialization check passed.\n\n## Distribution\nGoogle Play internal release326: 441 (1.0.389), available to internal testers, September17 18:46 KST. No supported devices removed. One nonblocking deobfuscation warning; minification disabled. Public release unchanged. Source commit801a999 on dev.\nTest link: https://play.google.com/apps/internaltest/4701300702493397907\n"});
window.SEORAP_DATA.updates.unshift({"version": "1.0.389-internal", "code": 441, "date": "2026-09-17", "items": ["Google Play 내부 테스터에게 제공됨 · 18:46 KST · dev801a999", "홈·마을·집의 화면 폭에 맞춘 상단 배너, 광고 실패 안내·재시도·회전 대응", "전체 설정 진입 시 준비된 전면 광고 표시 · 광고 제거 구매자 제외", "가로 태블릿 자아만들기 아이콘 확대 및 배너 아래 화면 배치 개선", "AdMob Android·iOS 광고 동의 메시지 게시, 전파 최대1시간 · 실제 기기 광고 검증은 미완료", "신규 EN/JA100%, 전체 영어2258/2990·일본어2257/2990 각75.5%"]});

window.SEORAP_DATA.tasks.unshift({"id": "internal442-canvas-banner-drag", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "내부442 · 광고 영역 분리·집 크기/스크롤·상판 물건 드래그", "summary": "1.0.390(442), dev82a5b33. Android 광고와 게임 영역 분리, 싱글·멀티 집 가로/세로 격자 설정과 스크롤, 방 크기 보존 및 공유 저장. 반복 탭 레이어 선택과 드래그 분리. 서버 승인 테스트 계정의 자아만들기 테스트 보상1회 연결. Chrome/WebKit·서버 권한/1회소비·서명 AAB 검증 완료. Firebase diamondWalletApi/sharedTownApi 배포 완료. Play release327 내부 테스터에게 제공9/17 19:25 확인. 실제 Android 광고 위치/보상 재확인 필요. iOS 준비만. 신규EN/JA100%, 전체 각75.5%. 운영main 유지."});

window.SEORAP_DATA.documents.push({"subsection": "testing", "content": "# Internal 442 / 1.0.390\n\n## Changes\n- Android native banner and WebView now occupy separate rectangles. Remove the transformed-app positioning on this native path; game viewport units and fixed bottom/editor controls use the remaining screen height. Align the AdMob top banner to immersive screen top. Native loading/error text retains retry.\n- Single and shared houses use a fixed 64px cell canvas, with width/height settings (12–64 columns, 16–64 rows), scrolling and per-home/floor scroll restoration. Rebase saved room percentages on resize to retain physical room/furniture geometry; prevent shrinking past occupied bounds. Shared layout saves include canvas dimensions.\n- Only completed taps cycle through overlapping furniture. Dragging begins on the top object rather than cycling to the supporting counter/nightstand. Moving a support still carries attached objects. Cancelled pointer gestures no longer commit a move.\n- Demo ads do not deliver SSV. Added one-use QA discovery redemption for verified operator or server-allowlisted test accounts. Normal accounts still require signed Google SSV; client-supplied QA flags cannot authorize credits. No currency or premium entitlement granted.\n\n## Verification\n- Chrome and WebKit home canvas/scroll tests; fixed geometry across expansion/shrink; shared save payload preserves furniture; repeated tap then drag selects top vase independently.\n- Chrome and WebKit mocked native viewport/SDK tests: adaptive banner, retry, modal hide/restore, premium removal, fullscreen advertisement gating, portrait/landscape render. These emulate native viewport resizing; they do not replace real Android ad/device testing.\n- Server QA reward authorization, rejection of client flags/unverified identity, one-use ticket/credit, account-wide cooldown regression and signed SSV service regression passed.\n- Android bundleRelease and jarsigner passed. AAB prepared source bytes verified; internal442 marker verified. iOS preparation check passed, not signed IPA or real iOS native banner verification.\n- diamondWalletApi and sharedTownApi deployed successfully to existing Firebase project.\n- New user copy has KO/EN/JA. Static overall coverage: EN2258/2990 (75.5%), JA2257/2990 (75.5%).\n\n## Artifact\nC:/Users/Public/drawer-release433/drawer-village-1.0.390-442-internal.aab\nSHA256: 2cd19bbdce74eba72ad8280fcd3b5d9942e2c1059df2010e8befb426741d61e5\n\n## Play notes\n<ko-KR>\n광고 때문에 상단과 하단 버튼·집 편집 도구가 가려지는 문제를 수정했어요. 집 설정에서 가로·세로 크기를 정하고 넓은 집을 스크롤해서 볼 수 있어요. 싱글·멀티 모두 기존 가구 배치를 유지해요. 카운터·협탁 위 물건을 드래그할 때 받침 가구까지 선택되던 문제를 수정했어요. 승인된 테스트 계정에서 자아만들기 테스트 광고 보상을 확인할 수 있어요.\n</ko-KR>\n<en-US>\nFixed banners obscuring top/bottom controls and house editing tools. Set house width and height and scroll around a larger house, in single and multiplayer, while retaining furniture layouts. Dragging items on counters or nightstands no longer selects the support beneath them. Authorized test accounts can redeem Self-discovery test-ad rewards.\n</en-US>\n<ja-JP>\n広告で上下のボタンや家の編集ツールが隠れる問題を修正しました。家の横幅・縦幅を設定し、広い家をスクロールできます。シングル・マルチとも家具の配置を維持します。カウンターやサイドテーブル上の物をドラッグすると台まで選ばれる問題を修正しました。承認済みテストアカウントで自分づくりのテスト広告報酬を確認できます。\n</ja-JP>\n\n## Distribution\nGoogle Play internal release327: 442 (1.0.390), available to internal testers September17 19:25 KST. Source82a5b33 on dev. No supported devices removed; one nonblocking deobfuscation warning (minification disabled). Production unchanged.\nTest link: https://play.google.com/apps/internaltest/4701300702493397907\nQA allowlist is read from server-protected entitlements.adTestAccess, not client-editable user profile fields.\n"});
window.SEORAP_DATA.updates.unshift({"version": "1.0.390-internal", "code": 442, "date": "2026-09-17", "items": ["Play 내부442 제공19:25 · dev82a5b33 · 운영main 유지", "Android 광고/게임 영역 분리로 상하단 버튼과 편집 도구 화면 이탈 수정", "싱글·멀티 집 가로/세로 크기 설정·스크롤 및 기존 배치 유지", "카운터·협탁 위 물건만 드래그, 짧은 탭만 아래 레이어 순환 선택", "서버 승인 테스트 계정의 자아만들기 보상1회 · 실제 기기 재확인 필요", "Chrome/WebKit·서버·서명 AAB 검증, iOS준비만 · 신규EN/JA100%, 전체 각75.5%"]});

window.SEORAP_DATA.tasks.unshift({"id": "internal443-house-log-performance", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "내부443 · 방 크기 유지·활동 3줄·광고 화면 갱신 최적화", "summary": "1.0.391(443), dev7bd29aa. 일반집 오른쪽에 기존 너비만큼 빈 배치 영역 추가, 높이·방·가구 표시 크기 유지. 싱글·멀티 좌표 보존. 활동 설명3줄/말줄임, 장소명과 행동 버튼 한 줄. 반복 네이티브 배치 갱신 제거. Chrome/WebKit·중복호출·서명 AAB 검증 통과, Play release328 내부 테스터에게 제공9/17 19:48 확인. 실기기 렉 개선 정도 확인 필요. iOS 준비만. 신규EN/JA100%, 전체 각75.5%. 운영main 유지."});

window.SEORAP_DATA.documents.push({"subsection": "testing", "content": "# Internal 443 / 1.0.391\n\n## Changes\n- Keep the pre442 viewport-sized room footprint. Default placement canvas extends one viewport to the right, with unchanged height. Width/height settings change placement extent, not room scale. Single/shared legacy manual room coordinates migrate once; furniture-local coordinates are preserved. Fixed the catalog drag grid using actual canvas dimensions.\n- Collapsed activity description has space for three complete lines with ellipsis. Location shares the bottom row with Choose activity and truncates horizontally.\n- Removed global native layout rescanning. Correct immersive banner insets in the AdMob SDK and only update margins when different. Identical native viewport reservations are deduplicated.\n\n## Verification\n- Chrome and WebKit: viewport384x832 gives canvas768x754 inside viewport384x754. Scroll restoration, room resize/rebase, shared layout save, attached-object drag tests pass.\n- Chrome/WebKit mocked SDK: portrait/landscape banner layout, failure/retry, modal hide/restore, premium removal, fullscreen gating, three full description lines and aligned location/action footer pass. Screenshots inspected.\n- 1000 identical reserve calls produce one native bridge call; changed height/message still propagate. Legacy migration is idempotent and retains furniture coordinates.\n- Android bundleRelease and jarsigner passed; changed bundled web assets match prepared sources; internal443 marker verified. Real Android device frame-time/ad layout improvement remains to be verified; no claim that all lag is eliminated.\n- iOS source/version preparation check passed. No signed IPA/TestFlight upload in this run. Public web and main unchanged. Backend unchanged.\n- New copy KO/EN/JA complete; static total EN2258/2990 (75.5%), JA2257/2990 (75.5%).\n\n## Artifact\nC:/Users/Public/drawer-release433/drawer-village-1.0.391-443-internal.aab\nSHA256: c55a1c31e524a910edf08e7be678c55bc58aea7947c22db2860c0b275bfbf879\n\n## Play notes\n<ko-KR>\n집의 방·가구 표시 크기를 유지하면서 오른쪽에 빈 배치 공간을 추가했어요. 싱글·멀티에서 배치 영역 크기를 조절하고 옆으로 넘겨볼 수 있어요. 홈 활동 설명은 세 줄까지 온전히 표시하고, 긴 글은 말줄임표로 처리해요. 장소명을 할 일 정하기 옆으로 옮겼어요. 광고 표시 중 불필요한 화면 갱신을 줄였어요.\n</ko-KR>\n<en-US>\nRooms and furniture keep their previous display size, with extra placement space to the right. Resize and scroll the placement area in single and multiplayer. Home activity descriptions show three complete lines and use ellipses for longer text. Location now sits beside Choose activity. Reduced unnecessary screen updates while showing ads.\n</en-US>\n<ja-JP>\n部屋と家具の表示サイズを保ち、右側に空き配置スペースを追加しました。シングル・マルチで配置エリアの広さを調整し、横にスクロールできます。ホームの行動説明を3行まで表示し、長い文章は省略記号で表示します。場所名を行動選択ボタンの横へ移動しました。広告表示中の不要な画面更新を減らしました。\n</ja-JP>\n\n## Distribution\nGoogle Play internal release328: 443 (1.0.391), available to internal testers September17 19:48 KST. Source7bd29aa on dev. No supported devices removed. One nonblocking deobfuscation warning; minification disabled. Production unchanged.\nTest link: https://play.google.com/apps/internaltest/4701300702493397907\n"});
window.SEORAP_DATA.updates.unshift({"version": "1.0.391-internal", "code": 443, "date": "2026-09-17", "items": ["Play 내부443 제공19:48 · dev7bd29aa · 운영main 유지", "방·가구 표시 크기 유지, 오른쪽 빈 배치 영역 추가 · 싱글/멀티", "활동 설명3줄과 말줄임표, 장소명과 할 일 정하기 같은 줄", "Android 광고 중 반복 배치 갱신 제거 · 동일 요청1000회에서 브리지 호출1회", "Chrome/WebKit·서명 AAB 검증, 실기기 렉 개선 정도 확인 필요 · iOS준비만", "신규EN/JA100%, 전체 영어·일본어 각75.5%"]});

window.SEORAP_DATA.tasks.unshift({"id": "internal444-banner-discovery-bed", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": true, "title": "내부444 · 카메라 안전영역·실제 광고·자아만들기 표시", "summary": "1.0.392(444), dev49fd1b1. 검은 카메라 영역→광고→게임 화면, 하단 고정. 광장/상점/멀티 목록/건물 정보/방 정보 배너. 내부 광장과 광고 테스트 플래그 분리, 실제광고 요청 전환. 자아만들기 동기화 중 유지/쿨다운 반투명. 침대 실제 이미지 선택범위. 멀티 안내 가독성 및 상점 로그인 문구 제거. Chrome/WebKit·서명 AAB 검증. 실기기 광고위치/실광고 공급 미검증. iOS 준비만. 신규EN/JA100%, 전체각75.5%. Play 내부 테스터 제공9/17 20:15(release329)."});

window.SEORAP_DATA.documents.push({"section":"release","content":"# Internal444 / 1.0.392\n\n## Changes\n- Android camera/status safe area is black, followed by banner then game viewport. Native reserved height includes safe top and ad height; status view shares banner offset. Devices with zero safe top have no added strip. AdMob safe-area callback also covers Android9–14 using AndroidX insets and only mutates changed margins. No global layout polling.\n- Banner placement policy includes plaza, shop, multiplayer directory, building details and room editor/info. Unrelated dialogs, payments and fullscreen ads still hide banners; premium entitlement remains respected.\n- Decouple plaza-enabled flag from ad testing. Bundled config testing:false now requests configured real Android/iOS IDs. Explicit QA config remains available for development. Actual ad fill/account approval and on-device native positioning remain unverified.\n- Render a Self-discovery placeholder with the home rail and retain the functional button during startup sync. Cooldown fades icon/caption to50% while leaving countdown readable and rewarded-ad choice usable.\n- Use contain image's painted rectangle for furniture outline and drag hit tests, excluding bed letterbox space.\n- Multiplayer directory help text is light on wood, paper text remains dark. Shop omits login status text.\n\n## Verification\n- Chrome and WebKit: banner screen allowlist, camera inset viewport simulation, existing banner retry/fullscreen/premium behavior; discovery cooldown across characters/languages and sync visibility; house/shared-save/attached-item regression; bed selection inset >40px on a180x300 fixture; directory computed contrast and screenshot; shop status absent.\n- Real ad mode test proves plaza flag no longer selects test ads; explicit QA switch retained. Consent initialization/retry regression passes.\n- Android bundleRelease and jarsigner pass; prepared modified assets match AAB and internal444/config testing:false verified. No native physical-device frame/layout or live ad fill test. iOS source preparation passes, no signed IPA/TestFlight upload. Public web/backend/main unchanged.\n- New visible copy remains KO/EN/JA; static coverage EN2258/2990 and JA2257/2990, both75.5%.\n- Google recommends accounting for display cutouts that obstruct banner visibility: https://developers.google.com/admob/unity/banner/anchored-adaptive\n\n## Artifact\nC:/Users/Public/drawer-release433/drawer-village-1.0.392-444-internal.aab\nSHA256:e28f3b641218f47ce666db67e7a79b700924998a72be394a570d41e5f6fc594e\n\n## Play notes\n<ko-KR>\n카메라 영역을 검게 처리하고 그 아래에 광고와 게임 화면을 배치해요. 광장·상점·멀티 목록·건물 정보·방 정보에 배너를 추가했어요. 실제 광고 요청으로 전환했어요. 자아만들기 버튼이 동기화 중 사라지지 않게 하고, 대기 중에는 반투명하게 표시해요. 침대 선택 영역을 그림에 맞추고 멀티 목록 글자 가독성을 개선했어요. 상점의 로그인 상태 문구를 제거했어요.\n</ko-KR>\n<en-US>\nCamera cutout space is black, with ads and game controls below it. Added banners to Plaza, Shop, multiplayer lists, building details and room info. Switched to real ad requests. Self-discovery stays visible during sync and fades during cooldown. Bed selection now fits the artwork. Improved multiplayer text contrast and removed login status from Shop.\n</en-US>\n<ja-JP>\nカメラ領域を黒くし、その下に広告とゲーム画面を配置します。広場・店・マルチ一覧・建物情報・部屋情報にバナーを追加し、実広告のリクエストに切り替えました。同期中も自分づくりボタンを表示し、待機中は半透明にします。ベッドの選択範囲を画像に合わせ、マルチ一覧の文字を読みやすくしました。店のログイン状態表示を削除しました。\n</ja-JP>\r\n\n## Distribution\nGoogle Play internal release329: 444 (1.0.392), available to internal testers September17 20:15 KST. Source49fd1b1 on dev. No supported devices removed. One nonblocking deobfuscation warning. Production unchanged.\nTest link: https://play.google.com/apps/internaltest/4701300702493397907\r\n","description":"Play 내부 제공9/17 20:15 · 실제 광고 요청과 카메라 안전영역","title":"1.0.392 (444) 내부 테스트","id":"release444-notes","project":"서랍마을","subsection":"testing"});
window.SEORAP_DATA.updates.unshift({"date":"2026-09-17","code":444,"items":["Play 내부444 제공20:15 · dev49fd1b1 · 운영main 유지","카메라 안전영역 검게 처리, 그 아래 광고와 게임 화면 · 하단 고정","광장·상점·멀티 목록·건물 정보·방 정보 배너, 실제 광고 요청 전환","자아만들기 동기화 중 표시 유지·대기 중 반투명","침대 그림에 맞는 선택 영역, 멀티 목록 대비 개선, 상점 로그인 문구 제거","Chrome/WebKit·서명 AAB 검증 · 실기기 광고위치와 실제 광고 공급 미검증 · iOS준비만","신규EN/JA100%, 전체 영어·일본어 각75.5%"],"version":"1.0.392-internal"});

window.SEORAP_DATA.tasks.unshift({"section":"release","subsection":"testing","summary":"dev f04f382 · 상점 연결된 로그인 제거, 선택창 연속 터치 방지, 침대 중첩 이미지 범위 수정, 광고 오류3 안내. 광고 제거 시 카메라/배너 여백까지0 복원 검증. Chrome/WebKit·서명 AAB·467자산 검증. Play 내부 제공9/17 20:31(release330). AdMob 계정 인증 진행중 및 앱 인증 실패는 외부 미완료.","project":"서랍마을","id":"internal445-input-bed-shop","title":"내부445 · 선택창 터치·침대 범위·상점 로그인 표시","completed":false});

window.SEORAP_DATA.tasks.find(t=>t.id==='internal445-input-bed-shop').completed=true;
window.SEORAP_DATA.documents.push({"project":"서랍마을","id":"release445-notes","subsection":"testing","description":"Play 내부 테스터 제공9/17 20:31","content":"# Internal 445 / 1.0.393\n\n## Changes\n- Remove the actual Linked sign-in provider row from Shop, preserving Settings identity and billing controls.\n- Prefer the painted image over its earlier wrapper when resolving furniture selection/hit bounds. Nested bed art now excludes contain letterboxing.\n- Open selection popups after pointer release and consume the compatibility click for that same gesture. Touch release cannot activate the new popup; parent dialogs remain open. Keyboard/mouse supported.\n- Explain Android banner no-fill code3 in KO/EN/JA and retain bounded automatic retry.\n- Confirm ad-free entitlement releases both banner and camera inset reservation; upper controls regain original viewport while bottom navigation stays fixed. No live purchase performed.\n\n## Verification\nChrome/WebKit qa-input445, qa-home445, qa-ads445 passed. Touch/mouse/keyboard and nested wrapper coverage; shared furniture drag/canvas regression; premium restores full832px viewport and zero ad height. Android bundleRelease passed, jarsigner verified, all467 web assets byte-identical. iOS preparation passed, no signed IPA/TestFlight upload. Physical phone validation remains pending.\nNew copy KO/EN/JA complete; existing static translation coverage EN2258/2990 and JA2257/2990 (75.5% each).\nAdMob account verification in progress; Android/iOS app verification required. Android app-ads recheck still fails although https://drawervillage.com/app-ads.txt returns the expected publisher row. Do not claim real ad fill fixed. Code3 means no fill per Google Android AdRequest reference.\n\n## Artifact\nC:/Users/Public/drawer-release433/drawer-village-1.0.393-445-internal.aab\nSHA256:F8C955896C937F305717A34B925297AAC5108C83411439478943B70192603E47\n\n## Play notes\n<ko-KR>\n상점의 연결된 로그인 표시를 제거했어요. 드롭다운을 누른 동작이 새 창의 항목까지 누르지 않도록 수정했어요. 침대 선택 영역을 실제 그림에 맞게 수정했어요. 제공할 광고가 없을 때 안내를 개선했어요.\n</ko-KR>\n<en-US>\nRemoved linked sign-in text from Shop. Fixed dropdown opening gestures activating items in the new popup. Bed selection now follows the painted artwork. Improved the message when no ad is available.\n</en-US>\n<ja-JP>\n店の連携ログイン表示を削除しました。ドロップダウンを開く操作で新しい画面の項目まで押される問題を修正しました。ベッドの選択範囲を画像に合わせました。配信できる広告がない場合の案内を改善しました。\n</ja-JP>\r\n\n## Distribution\nPlay internal release330: 445 (1.0.393), available to internal testers September17 20:31 KST. Source f04f382 on dev. No supported devices removed; one nonblocking deobfuscation warning. Public main unchanged.\nhttps://play.google.com/apps/internaltest/4701300702493397907\r\n","section":"release","title":"1.0.393 (445) 내부 테스트"});
window.SEORAP_DATA.updates.unshift({"version":"1.0.393-internal","date":"2026-09-17","code":445,"items":["내부445 제공20:31 · dev f04f382 · 운영main 유지","상점 연결된 로그인 표시 제거, 선택창 연속 입력 방지","침대 중첩 이미지 선택 범위 수정, 광고 없음 오류3 안내","광고 제거 시 검은 카메라영역+광고영역0 및 상단 복원 검증","Chrome/WebKit·서명 AAB467자산 검증; 실기기·실결제 미검증; iOS준비만","AdMob 계정 인증중·앱 인증 재확인 실패. 웹사이트 인증파일 값 일치, 실제광고 공급 미해결","신규EN/JA100%, 기존 전체 영어·일본어 각75.5%"]});

window.SEORAP_DATA.tasks.unshift({"id":"public446-compensation","project":"서랍마을","section":"release","subsection":"testing","completed":false,"title":"공개446 준비 · 마을 슬롯 보상 및 신규 기본3개","summary":"1.0.394(446) 서명 AAB 검증·Play 프로덕션 release31 저장. 9/18 신규 제보 확인 전 검토 제출 보류·공지 초안 미발송. 기존917계정 슬롯1개 지급 및917영수증 확인. 신규 계정 총3개 자동지급 서버 배포, 중복/구매보존/탈퇴제외 테스트 통과. dev301fb38, 게임main 유지. 광고 포함 선언 변경·데이터보안 보완 진행 중."},{"id":"internal447-feedback","project":"서랍마을","section":"release","subsection":"testing","completed":false,"title":"내부447 · 9/18 실행·사진·수면·편집·광고 제보 수정","summary":"사용자 전체범위 승인. 실행실패/LD교체/수면시간/사진집계/성능/광고권한, 집UI숨김/편집도구/캐릭터깊이/대표사진전체표시, 멀티순서, 태블릿설정·자아만들기, 관계조건표시, 역안·이레즈미. 친구창 별도 디자인 기준 미제공. dev에서 원인 확인 중,447 예정·미배포."});
window.SEORAP_DATA.documents.push({"section":"release","subsection":"testing","title":"1.0.394 (446) 보상 및 공개 배포 준비","content":"# Public446 / 1.0.394\n\nUser authorized production release if the current AdMob verification can be resolved without another binary update, plus an in-game announcement. Official AdMob docs confirm verification uses store/developer website and app-ads.txt, followed by app readiness. Existing actual ad IDs/SDK remain unchanged; approval can restore delivery without a binary update. No promise that time alone fixes verification.\n\nCurrent Play production baseline observed437 (1.0.385); last published notice notice-639d1546-4310-489f-9a84-e0173aab1643 is1.0.385. Cumulative notice covers439–445 user-facing changes, excluding Mafia and test-only reward bypass. Explicitly announces account-wide10min instead of prior per-character cooldown.\n\n446 packages445 code with DRAWER_RELEASE_CHANNEL=public: plaza disabled, real ads enabled/testingfalse. No new runtime behavior. Source remains dev; main web is not overwritten. iOS version preparation only, no iOS release requested or performed.\n\nValidation: Android release build, jarsigner verified,467 web assets byte-identical. public446/plazafalse/actual ads verified. Previous445 Chrome/WebKit input, nested bed, shop, ads/premium viewport tests pass. iOS project check passes, no signedIPA. Live real-ad fill and real purchase not tested. EN/JA new runtime copy complete; prior static total75.5% each.\n\nArtifact: C:/Users/Public/drawer-release433/drawer-village-1.0.394-446-public.aab\nSHA256:7B8E11753674DC15C49C8C02B5A04FD101101EBA46909335B58D978471D1F0C5\nNotes: release446-notes.txt\nAnnouncement: announcement446.json\n\nAdMob external blocker: account verification in progress and Android app verification fails despite expected text at public HTTPS developer endpoint. Recheck requested in previous turn, still failed. Approval not guaranteed by production submission.\nSources: https://support.google.com/admob/answer/14538460?hl=en and https://support.google.com/admob/answer/9363762?hl=en\r\n\n## Compensation and new registrations (server deployed)\n- initializeTownSlots auth creation trigger deployed successfully in asia-northeast3. Server-owned transaction grants one slot over the existing two-slot base; current apps read that entitlement, so new accounts total three. No extra AAB required for this grant.\n- Existing 917 registered, nondeleted accounts received one slot each. 917 receipts verified. Fixed campaign ID shared with signup trigger prevents overlap/retry duplicates; all purchased entitlements preserved. docs/compensation446-result.json contains counts only.\n- Tests: scripts/check-registration-slots446.cjs passed legacy fallback, purchased slot preservation, duplicate/concurrent overlap, deleted account exclusion, and new-account total3.\n- Production446 saved in Play release31 but NOT submitted. New September18 reports are being checked before proceeding. Notice446 remains a draft and has NOT been sent. Play advertising declaration changed to ads included; data safety draft updating SDK collection/sharing remains unfinished.\r\n"});

Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==='internal447-feedback'),{completed:true,title:'내부447 제공 · 멀티 직업·집 편집·광고 권한 수정',summary:'1.0.395(447), dev cc6db26. Play release331 내부 테스터 제공9/18 16:46 확인. 멀티 직업 복원·계정/마을별 순서, 방 사진 전체·집 화면 맞춤·UI숨김 유지·드롭다운 갱신·태블릿 메뉴·LD편집·수면시간·광고권한·사진중복집계·관계조건·역안/이레즈미. 친구창 베이지/금색 목록, 멀티 별도 진입. sharedTownApi 배포. Chrome/WebKit·재접속/사진/수면·468자산 AAB서명검증. iOS준비만. 실제 기기 실행불가/렉·162사진 정확 원인은 별도 미해결. EN75.5%,JA75.5%. 게임main유지, 프로덕션/공지 보류.'});
window.SEORAP_DATA.tasks.unshift({id:'feedback447-unreproduced',project:'서랍마을',section:'release',subsection:'testing',completed:false,title:'후속 진단 · S25FE 실행불가·실기기 렉·사진162 집계',summary:'447에서 관련 경로 수정 및 브라우저 검증 완료. 해당 실기기의 실행실패/지연은 재현하지 못했으며 완전 해결로 안내하지 않음. 사진162계정의 정확한 원인 미확인. 실제 광고/광고제거 구매복원 실기기 확인, 데이터보안 마무리 및 공개 제출 남음.'},{id:'multiplayer-secret-relationship-design',project:'서랍마을',section:'plan',subsection:'ideas',completed:false,title:'멀티 비밀관계 · 숨김 대상 설계 대기',summary:'기존 관계+공개범위+캐릭터별 인지/의심, 둘만 있을 때 애정행동, 당사자 합의 공개 제안. 캐릭터에게만 비밀인지 다른 플레이어에게도 비밀인지 답변 대기. 후자는 서버 응답/생활로그/알림 필터 필요.447 미포함.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.395 내부 테스트',code:447,date:'2026-09-18',items:['멀티 재접속 직업 유지와 마을별 캐릭터 순서 저장','집 화면 맞춤·방 전체 사진·편집 UI 숨김 유지·선택창·태블릿 설정 개선','멀티 메뉴 분리, 광고 제거 권한 확인, 사진 중복집계·수면·LD 표시 보완, 역안·이레즈미','Play 내부 release331 제공16:46, sharedTownApi 배포, dev cc6db26. 공개437/main 유지','실기기 실행불가·심한 렉·162사진 원인은 미해결 기록, 비밀관계 미구현']});
window.SEORAP_DATA.documents.push({section:'release',subsection:'testing',title:'1.0.395 (447) 내부 테스트 · 검증과 남은 제보',content:'내부 release331 / 9월18일16:46 제공 확인. dev cc6db26. 멀티 직업 표시용 직함이 저장된 실제 직업을 덮어쓰는 원인 수정; 서버 반영. 집 사진/화면맞춤/편집도구, 태블릿 메뉴, 광고권한, 사진중복 집계, 수면 우선순위, LD편집 표시 및 멀티순서 수정. Chrome/WebKit 브라우저 QA, 저장/재접속/사진/수면 단위 검사와 서명 AAB468개 파일 일치. 실기기 성능 수치는 측정하지 않음. iOS 프로젝트 준비만, IPA 없음.\n\nAAB SHA256 A4D1BF4083BA01823CAE7507DB3E66746B7466A5AC9CA1E3CA70DF7F7D03DB58. EN2260/2992(75.5%), JA2259/2992(75.5%). KO/EN/JA 출시노트 release447-notes.txt.\n\n프로덕션446 초안과 전체공지 보류. S25FE 실행불가·실기기 렉·162사진 정확 원인은 미해결이며 비밀관계는 설계 대기.'});

// Internal448 verification and conditional public449 follow-up.
window.SEORAP_DATA.tasks.unshift({id:'internal448-mail-floor-audio',project:'서랍마을',section:'release',subsection:'testing',completed:true,title:'내부448 제공 · 층 이동·이전 편지 형식·새 발소리',summary:'1.0.396(448), dev8a5decc/495b79e. Play release332 내부 테스터 제공9/18 17:38 확인. 층 선택이 총 층수를 바꾸던 원인 수정, 가구 회전 뒤 상판 깊이 갱신, 숫자ID/불완전한 선택지 편지 호환. 걷기·달리기 녹음 통일. Chrome/WebKit 터치·멀티 의자/상판·층 비저장 검증, 471자산 AAB일치·서명검증, iOS준비만. 최신 기기 편지 실패 자체는 미재현. EN75.5%,JA75.5%.'},{id:'public449-validation-gate',project:'서랍마을',section:'release',subsection:'testing',completed:false,title:'공개449 · 실기기 우편 확인 후 누적 공지·출시',summary:'사용자 조건부 승인: 모든 문제 해결 확인 후 공개449 및 1.0.385 이후 누적 공지. 내부448 제공 완료. 캐릭터 받은편지 실패는 최신기기에서 제보, 브라우저 재현 실패·호환 보완. 앱실행/실기기렉 등 기존 미해결, 데이터보안 마무리 남음. docs/announcement449-draft.md 준비·미발송, 공개446 초안 제출금지. 게임main 공개웹 유지.'},{id:'admob448-verified',project:'서랍마을',section:'release',subsection:'testing',completed:true,title:'Android·iOS app-ads.txt 인증 완료',summary:'9/18 AdMob 재확인으로 두 앱 인증 완료 화면 확인. 광고 게재 준비 검토 중이며 전체 승인/실광고 노출 보장 아님. 기존 보상 중복 지급 없이 슬롯 읽기 전용 점검:1089계정 추가1개=기본총3개, 3개 초과17개 모두 마을슬롯 구매기록, 나머지1문서 등록계정 없음. 캐릭터 기본5개 유지.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.396 내부 테스트',code:448,date:'2026-09-18',items:['층 선택은 보기만 변경하고 방 배치 보존','이전 캐릭터 편지 형식 보완·상판 가구 깊이 갱신·새 걷기/달리기 발소리','Play release332 내부 테스터 제공17:38; dev8a5decc/495b79e','Android·iOS app-ads.txt 인증 완료, 광고 준비 검토 중','무료 마을총3개·캐릭터5개, 구매슬롯 보존 점검; 공개449와 공지는 실기기 확인 대기']});
window.SEORAP_DATA.documents.push({id:'release448-notes',project:'서랍마을',section:'release',subsection:'testing',title:'1.0.396 (448) 내부 테스트 출시노트',content:'서랍마을 1.0.396 내부 테스트\n\n층 선택 시 방 배치가 바뀌지 않도록 수정했습니다. 이전 형식으로 저장된 캐릭터 편지 처리를 보완했습니다. 상판 가구를 회전한 뒤 소품의 표시 위치와 순서를 갱신합니다. 걷기와 달리기는 새 발소리로 통일했습니다.\n\n최신 기기의 우편 실패가 모두 해결됐다는 안내는 아직 하지 않습니다. 내부448에서 받은우편 확인 후 공개449 진행 여부를 판단합니다. 공개 누적 공지 초안은 게임저장소 docs/announcement449-draft.md이며 미발송 상태입니다.'});
window.SEORAP_DATA.copyTemplates.unshift({id:'dv-internal448',emoji:'✉️',title:'448 편지 확인용 내부 테스트',question:'최신 버전에서도 캐릭터 편지가 열리지 않아요.',replies:[{label:'한국어',code:'ko',content:'이전 형식으로 저장된 편지를 처리하는 부분을 보완한 1.0.396(448)을 내부 테스트에 올렸습니다. 현재 기기에서 발생한 증상은 아직 재현하지 못해 해결 완료로 안내하지 않고 있습니다. 업데이트 후 받은우편의 같은 편지가 열리는지 확인 부탁드립니다.'}]});
window.SEORAP_DATA.tasks.unshift({id:'internal450-daily-letter',project:'서랍마을',section:'release',subsection:'testing',completed:true,title:'내부450 제공 · 도착한 편지 무반응 수정',summary:'1.0.398(450), dev56a67af. 발신 캐릭터가 없는 임시 질문이 내 프로필 사진으로 표시되고 열리지 않는 상태 재현·수정. 유효한 질문 준비, 목록의 무효 질문 제외, 자정 후 열 때 질문 교체 방지. Chrome/WebKit 우편·멀티 회귀 통과, 서명AAB471자산 일치. Play release333 내부 제공9/18 17:54. iOS프로젝트 준비만. EN75.5%,JA75.5%. 공개/공지 미진행.'},{id:'ios411-character-scroll',project:'서랍마을',section:'release',subsection:'testing',completed:false,title:'iOS411 캐릭터 설정 스크롤 제보 조사',summary:'접수73098ee2, iPhone393x798, iOS18.7, 비로그인1캐릭터. 책 전체설정인지 생성 화면인지 제보에 설명 없음. 화면 특정·실기기 재현 미완료이며 내부450 우편 수정으로 해결됐다고 안내하지 않음.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.398 내부 테스트',code:450,date:'2026-09-18',items:['내 프로필 사진의 도착한 편지 무반응 원인 수정','자정 후 열어도 선택한 질문 유지','Play release333 내부 테스터 제공17:54, dev56a67af','iOS411 설정 스크롤 조사 대기; 프로덕션·전체공지 미진행']});
window.SEORAP_DATA.documents.push({id:'release450-notes',project:'서랍마을',section:'release',subsection:'testing',title:'1.0.398 (450) 우편 수정',content:'도착한 편지가 내 프로필 사진으로 표시되고 눌러도 열리지 않던 임시 질문 오류를 수정했습니다. 날짜가 바뀌어도 열려는 질문을 유지합니다. 내부450 제공 완료. iOS 설정 스크롤은 아직 미해결입니다.'});
window.SEORAP_DATA.tasks.unshift({id:'slot-gift-once451',project:'서랍마을',section:'release',subsection:'testing',completed:true,title:'451/452 마을 슬롯 선물 중복 방지 재검증',summary:'기존 사과 보상·신규 계정이 같은 지급 기록을 사용하며 서버 트랜잭션에서 슬롯과 영수증을 함께 저장. 재요청·중첩 호출은 1회, 신규 무료 총3개, 구매 슬롯 보존, 삭제 계정 제외 검사 통과. Apple 연결은 기존 UID 유지·추가 지급 없음 검사 통과. 실제 선물 재지급하지 않음. dev e5be7ef, 게임main 변경 없음.'},{id:'public451-internal452-apple',project:'서랍마을',section:'release',subsection:'testing',completed:false,title:'공개451·내부452 및 iOS Apple 로그인 배포 진행',summary:'사용자 우편 해결 확인 후 공개 Android/iOS 승인. 공개 광장·마피아 잠금/내부만 개방. Apple 로그인·기존 계정 연결 KO/EN/JA 구현, Firebase Apple 설정 활성 확인. Android451·452 서명AAB473자산 일치. iOS451 공개 가능 빌드·452 내부 빌드 Actions 진행. Apple 실기기 로그인·구매 연결 확인, 스토어 제출·개인정보 안내 마무리 남음. EN2260/2993 75.5%,JA2259/2993 75.5%.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.399 공개 후보 / 1.0.400 내부 준비',code:452,date:'2026-09-18',items:['공개451은 광장·마피아 잠금, 내부452는 개방','iOS Apple 로그인과 기존 계정 연결 추가·실기기 검증 대기','마을 슬롯 선물 계정당 1회·무료 총3개·구매 슬롯 보존 재검증','Android 빌드 검증 완료, 스토어 배포 진행 중; 게임 dev e5be7ef']});
window.SEORAP_DATA.tasks.unshift({id:'release451452-delivery',project:'서랍마을',section:'release',subsection:'play-store',completed:true,title:'공개451 심사 요청·내부452 제공·누적 공지 발송',summary:'Android1.0.399/451 공개 release32와 광고·데이터보안 선언 심사 요청 접수. 자동검사/심사 중이며 공개 제공 완료 아님. 내부1.0.400/452 release334 테스터 제공9/18 18:19. 1.0.385 이후 누적 업데이트·사과·무료총3개/중복지급없음 공지 발송, 마피아 내용 제외. 슬롯 지급 재실행 없음. 개인정보 안내만 main c8f4ecc 갱신, 앱 소스 dev 유지.'});
window.SEORAP_DATA.tasks.unshift({id:'ios451452-login-review-pending',project:'서랍마을',section:'release',subsection:'testing',completed:false,title:'iOS451·452 업로드 수락 · 관리자 로그인/실기기 확인 대기',summary:'451 공개 가능 빌드와452 내부전용 빌드 모두 서명·Apple 업로드 수락. 처리 완료·TestFlight 이용 가능은 미확인, App Store 심사 미제출. App Store Connect 로그인 세션 없음: 사용자 로그인 요청. Apple 계정 연결 후 기존 마을·구매 유지 실기기 확인 필요. 자동 검사에서는 UID 유지/중복보상없음/nonce·계정변경 차단 통과.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.399 심사 요청 / 1.0.400 내부 제공',code:452,date:'2026-09-18',items:['Android 공개451 심사 요청·내부452 제공 확인','iOS451·452 업로드 수락; 관리자 로그인과 실기기 Apple 연결 확인 대기','1.0.385 이후 누적 인게임 공지 발송 완료·슬롯 재지급 없음','영어75.5%,일본어75.5%; 개인정보 안내만 게임main, 앱코드는dev']});
window.SEORAP_DATA.tasks.unshift({id:'ad-apology-notice451-separate',project:'서랍마을',section:'release',subsection:'testing',completed:true,title:'광고 도입 사과·마을 슬롯 선물 별도 인앱 공지 발송',summary:'사용자 요청으로 업데이트 공지와 별개인 사과·보상 안내 발송 완료. 광고로 인한 화면/플레이 흐름 불편 사과, 기존 계정 선물1개·무료총3개·중복없음·구매보존 명시. 슬롯 지급 재실행·푸시·이메일 없음. Twitter는 사용자가 게시할 문안만 작성. 앱451/452 및 번역률 EN75.5%/JA75.5% 유지.'});
window.SEORAP_DATA.documents.push({id:'ad-apology-twitter451',project:'서랍마을',section:'release',subsection:'testing',title:'광고 도입 사과 Twitter 문안',content:'광고 도입과 최근 오류로 불편을 드려 죄송합니다.\n사과의 마음으로 기존 계정에 마을 슬롯 1개를 지급했습니다. 무료 슬롯은 선물 포함 총 3개이며, 구매 슬롯은 유지됩니다. 이미 받은 선물은 중복 지급되지 않습니다.\n자세한 내용은 인앱 공지를 확인해 주세요.\n\n별도 인앱 공지 발송 완료, 슬롯 지급 재실행 없음. iOS 공개451 심사 제출은 App Store Connect 관리자 로그인 대기. 앱 실행 코드 변경 없음.'});

window.SEORAP_DATA.tasks.unshift({"id":"internal453-title-group-sleep","project":"서랍마을","section":"release","subsection":"testing","completed":true,"title":"내부453 제공 · 새 타이틀·다인 활동·수면 시간·집/마을 확대","summary":"1.0.401/453, dev ecad177. Play release335 내부 테스터 제공9/19 18:31. 원본 타이틀 SVG·로그인/저장별 진입, 집/마을1~3배 두 손가락 확대, 최대8명 공통 활동·도착/재접속 유지, 시간표 수면·오프라인 회복·실제 침대선택, 긴 설정 스크롤. Chrome/WebKit 및 시간표2880분·8종4인활동·침대·소유권·중복선물 방지 검증. 서명AAB480자산일치, sharedTownApi 반영. iOS453 업로드 성공, App Store Connect 처리중(9/19 18:34), 테스터 제공 미확인. 공개심사 미제출. S25FE 실행실패·실기기Apple로그인·실기기성능 원인 미확인. EN75.5%/JA75.5%, 신규3언어완료. 앱main은 별도웹 보호로 유지."});
window.SEORAP_DATA.updates.unshift({"version":"1.0.401 내부 테스트","code":453,"date":"2026-09-19","items":["새 타이틀과 로그인/저장별 시작 화면","여러 명이 같은 대화·식사·놀이 등 함께 진행","설정 수면 시간·오프라인 수면 회복·자동 취침 침대 선택","집·마을 두 손가락 확대/축소와 설정 스크롤","Play 내부453 제공·멀티서버 반영·iOS453 업로드 성공/Apple 처리중"]});
window.SEORAP_DATA.tasks.unshift({"id":"internal454-loading-coffee-gestures","project":"서랍마을","section":"release","subsection":"testing","completed":false,"title":"내부454 · 로딩·확대/자아만들기 지연·커피 회복·부부 반응","summary":"1.0.402/454, dev58fe649. 실제 초기 이미지·계정 로딩 진행률, 확대 중 방 길게 누르기 취소·프레임 갱신, 질문 창/확대 중 전체 화면 재렌더 유예, 질문 답변 집합 재사용·계정 조회 캐시, 커피 수면 회복/시간표 밖 주방 커피 우선, 현재 부부의 사적 장면 놀람 예외. Chrome/WebKit·수면/다인활동·커피/관계 검사 통과, AAB483자산 일치. 가구 축소는 미재현·임의 크기 변경 없음. 실기기 렉 개선량 미측정. 전체이용자 메일 docs/update-mail454-draft.md 미발송. Play 내부454 release336 테스터 제공9/19 18:57·멀티서버 배포완료·iOS35436002705 진행중. 영어75.5%/일본어75.5%, 신규문구3언어 완료."});
window.SEORAP_DATA.updates.unshift({"version":"1.0.402 내부 테스트","code":454,"date":"2026-09-19","items":["타이틀 로딩 표시와 확대 중 방 편집 오동작 수정","확대/자아만들기 화면 갱신 부담 감소","커피 수면 욕구 회복과 설정 시간 밖 커피 우선","현재 부부 사이의 사적 장면 놀람 반응 조정","전체 이용자 안내 메일 초안 작성·미발송"]});
window.SEORAP_DATA.tasks.unshift({id:'reports454-sleep-iphone-mail',project:'서랍마을',section:'release',subsection:'testing',completed:true,title:'454 · 수면/아이폰 하단 설정 재검증·1.0.399 이후 누적 안내',summary:'dev556dd15. 기존454에서10캐릭터·두 기상/취침 시간표·8시각 생활 장면 검사 통과. WebKit402×820/393×798 도덕성·폭력성 터치 선택과 다시 렌더한 값 유지 통과. 스크롤 위치 이동은 자동화이며 실제 아이폰 손가락 검증은 아님.411의 책 바깥 overflow 숨김/목록 높이 제한 누락 가능성은453에서 처리됨. 신규 런타임 수정·455 빌드 없음. 안내문은1.0.399 이후453–454 누적, 부부 반응/마피아 제외·미발송. iOS454 업로드 workflow 성공, 테스터 제공/공개 심사는 미확인. EN/JA75.5%, 새 앱 문구 없음.'});
window.SEORAP_DATA.documents.unshift({id:'mail-after399-454',project:'서랍마을',section:'release',subsection:'testing',title:'1.0.399 이후 누적 업데이트 안내 초안',description:'타이틀·실제 로딩, 다인 활동, 집/마을 확대, 시간표/침대, 커피 회복, 설정 스크롤, 반응 속도 개선. 부부/마피아 제외.',content:'게임 docs/update-mail454-draft.md에 전체이용자 메일 초안 저장. 현재 내부454 반영 상태를 명시하고 공개 배포 완료로 표현하지 않음. 보상 재지급 및 메일 발송 없음. 수면·iPhone 하단 선택 제보 재검증 기록은 docs/release454.md. iOS454 업로드 workflow35436002705 성공; 실제 제공 상태와 공개 심사 완료는 별도 확인 필요.'});
window.SEORAP_DATA.tasks.unshift({id:'public455-android-ios',project:'서랍마을',section:'release',subsection:'production',completed:true,title:'공개455 · Android 프로덕션·iOS 심사 제출 완료',summary:'1.0.403/455. Android 프로덕션100%출시 검토 중·승인 후 자동 게시. iOS공개455와 광고 제거 비소모성 상품(9,900원)을 함께 심사 제출: 1b570c2d-1c7c-4076-b0f3-f4f08327beb0, 승인 후 자동 출시. iOS서명·Apple로그인권한·빌드선택·암호화답변·광고SDK개인정보·KO/EN/JA노트 및 상품설명 완료. 공개 광장/마피아 잠금·내부454 유지. 심사 제출은 스토어 공개 완료를 뜻하지 않음. game dev f564b2e/01f6a54, 별도 웹main 미반영. 보상 재지급·공지 발송 없음. 영어/일본어75.5%.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.403 공개 심사',code:455,date:'2026-09-19',items:['새 타이틀과 실제 로딩 표시','여러 캐릭터의 공동 활동','집·마을 확대/축소와 편집 오동작 수정','수면 시간·침대 선택·커피 회복 개선','캐릭터 설정 하단 스크롤과 반응 개선','Android·iOS 공개 심사 제출 완료, 승인 후 자동 출시']});


window.SEORAP_DATA.tasks.unshift({"id":"internal456-wallet-interiors","project":"서랍마을","section":"release","subsection":"testing","completed":false,"title":"내부456 · 캐릭터 지갑·직장·건물 꾸미기","summary":"1.0.404/456, dev d7f87f8. 재화 이름 자유 입력·평범한 밥 한 끼 가격 기준 환산(실제 재산 유지), 최초 재산 1회·퇴근 급여·유료 활동 지출·잔액 부족 차단·입금분만 공유하는 공동지갑. 관찰/마을 전환·싱글/멀티 건물 내부 꾸미기. 자아만들기 타이머·가구 표시 크기·방 크기 드래그 수정. Chrome/WebKit·거래 중복/권한·활동/급여·저장 검사 및 서명AAB492자산 일치. Play release337 내부 테스터 제공9/19 22:39, 멀티 서버 반영완료. iOS TestFlight456 서명·Apple업로드 성공35446347704, 암호화 답변 완료·테스트 준비 완료·나만 테스트1명 연결. 영어75.6%/일본어75.5%, 새 문구3언어 지원. 공개455·game main 유지."});
window.SEORAP_DATA.updates.unshift({"version":"1.0.404 내부 테스트","code":456,"date":"2026-09-19","items":["지갑·직장 메뉴와 캐릭터 잔액 표시","재화 이름과 평범한 밥 한 끼 가격을 직접 설정","기본재산·퇴근 급여·활동 지출과 동거인 공동지갑","홈 관찰/마을 전환 및 카페·병원 등 건물 내부 꾸미기","자아만들기 시간 갱신·가구 표시 크기·방 크기 드래그 수정","Android 내부456 제공·멀티 서버 반영·iOS456 TestFlight 테스트 준비 완료·기존 내부 그룹 연결"]});
window.SEORAP_DATA.documents.unshift({"id":"release456-notes","project":"서랍마을","section":"release","subsection":"testing","title":"1.0.404 (456) 내부 테스트 출시노트","description":"재화 단위·환율, 지갑·직장, 건물 내부 꾸미기와 오류 수정. KO/EN/JA 복사 블록.","content":"# Internal 1.0.404 / 456 — wallet and building interiors\r\n\r\nScope approved in the task. Development branch only; Android internal / iOS TestFlight internal preparation. Public455 and the public website are not replaced by this build. Public455 was observed available on Google Play on September19 at20:32KST. Internal454 is the preceding internal release; closed testing215 is not being promoted.\r\n\r\n## Player notes\r\n<ko-KR>\r\n지갑·직장 메뉴와 캐릭터 잔액을 추가했어요. 재화 이름과 평범한 밥 한 끼 가격을 직접 정할 수 있고, 단위를 바꿔도 재산 가치는 유지돼요. 퇴근 급여·유료 활동 지출과 동거인 공동지갑을 지원해요. 홈에서 관찰·마을을 전환하고 카페·병원 등 건물 내부도 꾸밀 수 있어요. 자아만들기 시간 갱신, 집 가구 표시 크기와 방 크기 조절을 개선했어요.\r\n</ko-KR>\r\n<en-US>\r\nAdded Wallet, Work and character balances. Name your currency and set the price of an ordinary meal without changing your wealth. Receive wages after work, pay for activities and share deposited money with housemates. Switch between observation and village views, and decorate cafe, hospital and other building interiors. Improved self-discovery countdown updates, furniture display size and room resizing.\r\n</en-US>\r\n<ja-JP>\r\n財布・仕事メニューとキャラクターの残高を追加しました。通貨名と普通の食事1回の価格を自由に設定でき、単位を変えても資産価値は変わりません。退勤時の給与、有料行動の支払い、同居人と入金分だけ共有する共同財布に対応しました。観察・村の画面を切り替え、カフェや病院などの内装も編集できます。自分づくりの残り時間、家具の表示サイズ、部屋のサイズ変更を改善しました。\r\n</ja-JP>\r\n\r\n## Validation\r\n- Currency conversions preserve base balances; wealth grants run once; insufficient funds block payment; shared deposits require resident opt-in.\r\n- Server owner/member boundaries, concurrent/replayed transfers, persistent transfer receipts and atomic failures pass against transaction fixtures.\r\n- Actual directed work completion credited once; zero-balance cafe order blocked; funded drink charged.\r\n- Building edit roles, room/furniture/floor persistence, revision conflicts and invalid image rejection pass.\r\n- Chrome and WebKit384x832: free-text gold conversion, balance below village picker, separated discovery button, observation/village switch, building room drag resize with fixed opposite corner, furniture addition and reopen persistence pass.\r\n- Countdown authoritative server time and entitlement-cache tests pass; guest live timer decreases10:00→9:57.\r\n- Prior navigation, shared-home ownership, coffee/sleep and multi-character activity checks pass.\r\n- check-shared-town-service.cjs has an existing line60 expectation that members cannot create their own homes; same failure reproduced using HEAD's unchanged service. Relevant ownership suite passes; no permission change was made to work around the stale expectation.\r\n- iOS project/module preparation and internal-only workflow checks pass. Browser WebKit is not a signed-device test. No claim of real-device frame-rate measurement.\r\n- Static translation inventory EN2258/2988(75.6%), JA2257/2988(75.5%); new player UI and release copy supplied in KO/EN/JA.\r\n\r\n## Artifact\r\nSigned Android AAB: C:/Users/Public/drawer-releases/drawervillage-1.0.404-456-internal.aab\r\nSHA256:042674E46668DA76D94B69454DADDC6F843D5EFF6232D9306426EF2FDD755621\r\nAll492 assets match the prepared Android bundle byte-for-byte. Store delivery pending.\r\n\r\n## Backend compatibility\r\nThe wallet handler checks group membership and resident ownership. Common-wallet changes and personal balances are transactional. Existing shared residents without wallet data are not charged by the new simulation; owned characters opt in when the new Wallet UI initializes. Ordinary display conversion makes no network call and does not use real exchange rates. No real-money purchases or compensation grants are changed.\r\n\n## Delivery\n- Source d7f87f8 pushed to dev.\n- sharedTownApi deployed successfully; other functions and real-money products unchanged. Initial discovery timeout resolved by allowing 60 seconds for CLI source analysis.\n- Google Play internal release337: 456 (1.0.404), available to internal testers September19 22:39KST. No supported devices removed. One nonblocking missing deobfuscation-file warning.\n- iOS internal TestFlight workflow35446347704 running; public submission not requested for456.\r\n"});

Object.assign(window.SEORAP_DATA.tasks.find(t=>t.id==='internal456-wallet-interiors'),{completed:true});
Object.assign(window.SEORAP_DATA.documents.find(d=>d.id==='release456-notes'),{content:"# Internal 1.0.404 / 456 — wallet and building interiors\r\n\r\nScope approved in the task. Development branch only; Android internal / iOS TestFlight internal preparation. Public455 and the public website are not replaced by this build. Public455 was observed available on Google Play on September19 at20:32KST. Internal454 is the preceding internal release; closed testing215 is not being promoted.\r\n\r\n## Player notes\r\n<ko-KR>\r\n지갑·직장 메뉴와 캐릭터 잔액을 추가했어요. 재화 이름과 평범한 밥 한 끼 가격을 직접 정할 수 있고, 단위를 바꿔도 재산 가치는 유지돼요. 퇴근 급여·유료 활동 지출과 동거인 공동지갑을 지원해요. 홈에서 관찰·마을을 전환하고 카페·병원 등 건물 내부도 꾸밀 수 있어요. 자아만들기 시간 갱신, 집 가구 표시 크기와 방 크기 조절을 개선했어요.\r\n</ko-KR>\r\n<en-US>\r\nAdded Wallet, Work and character balances. Name your currency and set the price of an ordinary meal without changing your wealth. Receive wages after work, pay for activities and share deposited money with housemates. Switch between observation and village views, and decorate cafe, hospital and other building interiors. Improved self-discovery countdown updates, furniture display size and room resizing.\r\n</en-US>\r\n<ja-JP>\r\n財布・仕事メニューとキャラクターの残高を追加しました。通貨名と普通の食事1回の価格を自由に設定でき、単位を変えても資産価値は変わりません。退勤時の給与、有料行動の支払い、同居人と入金分だけ共有する共同財布に対応しました。観察・村の画面を切り替え、カフェや病院などの内装も編集できます。自分づくりの残り時間、家具の表示サイズ、部屋のサイズ変更を改善しました。\r\n</ja-JP>\r\n\r\n## Validation\r\n- Currency conversions preserve base balances; wealth grants run once; insufficient funds block payment; shared deposits require resident opt-in.\r\n- Server owner/member boundaries, concurrent/replayed transfers, persistent transfer receipts and atomic failures pass against transaction fixtures.\r\n- Actual directed work completion credited once; zero-balance cafe order blocked; funded drink charged.\r\n- Building edit roles, room/furniture/floor persistence, revision conflicts and invalid image rejection pass.\r\n- Chrome and WebKit384x832: free-text gold conversion, balance below village picker, separated discovery button, observation/village switch, building room drag resize with fixed opposite corner, furniture addition and reopen persistence pass.\r\n- Countdown authoritative server time and entitlement-cache tests pass; guest live timer decreases10:00→9:57.\r\n- Prior navigation, shared-home ownership, coffee/sleep and multi-character activity checks pass.\r\n- check-shared-town-service.cjs has an existing line60 expectation that members cannot create their own homes; same failure reproduced using HEAD's unchanged service. Relevant ownership suite passes; no permission change was made to work around the stale expectation.\r\n- iOS project/module preparation and internal-only workflow checks pass. Browser WebKit is not a signed-device test. No claim of real-device frame-rate measurement.\r\n- Static translation inventory EN2258/2988(75.6%), JA2257/2988(75.5%); new player UI and release copy supplied in KO/EN/JA.\r\n\r\n## Artifact\r\nSigned Android AAB: C:/Users/Public/drawer-releases/drawervillage-1.0.404-456-internal.aab\r\nSHA256:042674E46668DA76D94B69454DADDC6F843D5EFF6232D9306426EF2FDD755621\r\nAll492 assets match the prepared Android bundle byte-for-byte. Google Play internal delivery verified; iOS status is recorded below.\r\n\r\n## Backend compatibility\r\nThe wallet handler checks group membership and resident ownership. Common-wallet changes and personal balances are transactional. Existing shared residents without wallet data are not charged by the new simulation; owned characters opt in when the new Wallet UI initializes. Ordinary display conversion makes no network call and does not use real exchange rates. No real-money purchases or compensation grants are changed.\r\n\n## Delivery\n- Source d7f87f8 pushed to dev.\n- sharedTownApi deployed successfully; other functions and real-money products unchanged. Initial discovery timeout resolved by allowing 60 seconds for CLI source analysis.\n- Google Play internal release337: 456 (1.0.404), available to internal testers September19 22:39KST. No supported devices removed. One nonblocking missing deobfuscation-file warning.\n- iOS internal TestFlight workflow35446347704 succeeded. Apple accepted signed1.0.404(456), internal-only, source d7f87f8. Signed Apple login entitlement verified. Apple build processing has not yet produced an installable record (bounded status check build:null); tester availability is not confirmed. No public review submitted for456. Public455 remains Waiting for Review in App Store Connect.\r\n"});
