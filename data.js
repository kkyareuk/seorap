...
const android218Followup=window.SEORAP_DATA.tasks.find(t=>t.id==="dv-android-214-device-play");
if(android218Followup){android218Followup.title="Android 218 실기기·Play 업로드 확인";android218Followup.summary="최신 개발 파일 drawer-village-v1.0.203-code218-dev-release.aab. 214 태블릿/가구, 215 수면, 216 소지품·우편, 218 관계 편집·마을 산책 개선을 포함해요. Play에 code 218을 올리기 전 기존 설치 위 업데이트로 관계 구성원 전체 순서, 부부 법적 등록 별도 저장, 많은 캐릭터의 편집 화면 스크롤, 분수 주변 간격과 마을 전체 산책 동선을 확인하세요. 아직 Play 업로드나 프로덕션 심사 제출은 하지 않았어요.";}
