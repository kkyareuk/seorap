window.SEORAP_DATA={
  ...
  tasks:[
    {"id": "public433-internal434-audio-talk", "project": "서랍마을", "section": "release", "subsection": "testing", "completed": false, "title": "공개437·내부438 준비 · 클릭 지연·소리·대화·음식점", "summary": "내부436(1.0.384)은16:11 제공 완료. 공개435는 저장만 하고 최종제출 보류. 클릭 시 전체 저장상태 두번복사 제거: CPU4x·UTF8 6.9MB 테스트 중앙값124.2→2.1ms, 복사0회. 선택팝업도 경량설정조회. 홈캐릭터 선택/좌우넘김 책장소리, 음식점 좋아하는/매운/취향 음식 식사·기록과 동행문구 개선. Chrome/WebKit·멀티식사/동행 검증 통과, sharedTownApi 배포 완료. 대화 두이름*한주제·간격, 서랍/발소리 이전수정 포함. 새 캐릭터/행동선택 효과음 파일 사용자 제공 대기; 최종437/438빌드·공개제출·공지 미완료. 공지로그인 완료, 발송대기. EN/JA변경100%, 전체미측정. 게임dev 1f19af0 반영, 게임main유지."},
