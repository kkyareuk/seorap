...
window.SEORAP_DATA.tasks.push({"id":"dv-full-multiplayer-creative-feedback-pending","project":"서랍마을","section":"release","subsection":"testing","completed":false,"title":"개발 중 · 멀티 전체 생활 기능·관계 제의·설정 공유와 추가 제보","summary":"멀티에서 개인 마을의 기분/로그/대화/공동 식사, 그룹별 관계와 타인 시선, 관계 제의/푸시/수락·거절·사유/선언 장면, 서버 참조형 캐릭터·인테리어·사전 공유와 항목당 80개, 전통 의상·신발·음료·무술·선택형 정신건강 설정·복합 가족관계는 별도 개발 중입니다. 침실 주인 편집 접근성, 유형 키워드 크기, 꽃·인형용 사전 기타란도 요청에 포함합니다. BGM은 사용자가 제작하므로 생성하지 않습니다. 259 긴급 배포 파일에는 미완성 신규 기능을 넣지 않았습니다. Galaxy 장시간 발열은 별도 실기기 검증 필요."});
