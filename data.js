...
window.SEORAP_DATA.tasks.unshift({id:'public455-android-ios',project:'서랍마을',section:'release',subsection:'production',completed:false,title:'공개455 · Android 프로덕션 심사 요청·iOS 심사 준비',summary:'사용자9/19 명시 요청. dev f564b2e,1.0.403/455 공개 채널로 광장/마피아 잠금. Android 서명AAB483자산일치·지원기기감소0·KO/EN/JA노트·100%출시 심사 요청 완료, 자동검사/검토 중. iOS35436888521 공개용 서명 빌드 중, ASC1.0.403 생성·자동출시·세 언어 노트 저장. 광고 SDK 개인정보 항목 보완 중; 앱 심사 제출/공개 제공은 아직 완료 아님. 보상 재지급·메일 발송 없음. 영어/일본어75.5%.'});
window.SEORAP_DATA.updates.unshift({version:'1.0.403 공개 심사',code:455,date:'2026-09-19',items:['새 타이틀과 실제 로딩 표시','여러 캐릭터의 공동 활동','집·마을 확대/축소와 편집 오동작 수정','수면 시간·침대 선택·커피 회복 개선','캐릭터 설정 하단 스크롤과 반응 개선','Android 프로덕션 심사 요청, iOS 제출 준비']});
