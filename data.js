...
window.SEORAP_DATA.tasks.push({"id":"dv-ios361-restore-input","project":"서랍마을","type":"검수","section":"release","subsection":"testing","completed":false,"title":"iOS361 · Android360 · 1.0.327 복원 재시도·입력 중 저장 지연","summary":"앱 dev 9c5c84b. 복원 실패가 후속 구매를 영구 차단하던 경로 수정. 미검증 미처리 거래의 새 결제 차단 유지. 연결 로그인 표시·삭제 단계/취소/오류 표시. Apple 네이티브 제공자 등록 추가(실기기 인증/서명 기능 검증 전). 질문 답변 저널 유지·입력 중 전체 자동저장 지연. 4상품·계정격리·취소/지연·답변복구 검사 통과. Android360 서명 APK/AAB 전달·331개 자산일치. CPU4x9캐릭터 질문43ms/전환85~435ms, 제보된356 수초멈춤 미재현·해결확정 아님. 구매서버 오류구분 배포 완료. iOS361 Actions34642416421 빌드 중. 새 EN/JA100%, 전체번역률 미산정. 공개심사·공지발송 없음."});
window.SEORAP_DATA.updates.unshift({"version":"iOS361 / Android360 · 1.0.327","code":360,"date":"2026-09-12","items":["구매 복원 재시도 및 연결 로그인 표시 개선","계정 삭제 진행·취소·오류 안내 개선","질문 답변 보존·조작 중 전체 저장 지연","Android 검증본 전달 / iOS 빌드 진행 중 / 실제 기기 검수 필요"]});
